...
import synthdrivers.RolandD10.RolandD10ToneDriver;
import synthdrivers.RolandD50.D50SingleDriver;
import synthdrivers.YamahaDX7.YamahaDX7VoiceBankDriver;
import synthdrivers.YamahaDX7.YamahaDX7VoiceSingleDriver;
import core.GuiHandler;
import core.PatchEdit;
import core.SysexWidgetFinder;
import core.TitleFinder;
import core.GuiHandler.ISearchHandler;
import core.GuiHandler.SearchFields;
        ...
        for (final SysexWidget sysexWidget : sysexWidgets) {
            if (sysexWidget instanceof CheckBoxWidget) {
                ...
                if (fixture.target.isEnabled()) {
                    new CheckBoxValueSetter(fixture, widget.getValueMin())
                ...
                if (fixture.target.isEnabled()) {
                    new ComboBoxValueSetter(fixture, widget.getValueMin())
                            .setValue(widget.getValueMax());
                    numEditedParams++;
                }
                ...
                if (widget.isEnabled()) {
                    new KnobValueSetter(widget).setValue(widget.getValueMax());
                    numEditedParams++;
                }
                ...
                if (fixture.target.isEnabled()) {
                    new SliderValueSetter(fixture).setValue(widget
                            .getValueMax());
                    numEditedParams++;
                }
            }
