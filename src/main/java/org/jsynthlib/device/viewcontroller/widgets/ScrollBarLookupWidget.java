 ...
 * @version $Id: ScrollBarLookupWidget.java 1009 2005-04-01 02:39:17Z billzwicky
 *          $
 * @see ScrollBarWidget
...
public class ScrollBarLookupWidget extends SysexWidget {
     ...
     *            be determined by the label strings.
     * @param pmodel
    ...
    public ScrollBarLookupWidget(String label, Patch patch, int min, int max,
            int labelWidth, IParamModel pmodel, ISender sender, String[] options) {
     ...
     * The minimum value is set to 0 and the maximum value to the length of the
     * options array.
     * @param label
     *            label for the Widget
     * @param patch
     ...
     *            array of label strings for each value.
     */
    public ScrollBarLookupWidget(String label, Patch patch,
            IParamModel pmodel, ISender sender, String[] options) {
