 ...
 * @version $Id: DirectoryConfigPanel.java 954 2005-03-07 00:26:40Z hayashi $
 */
...
public class DirectoryConfigPanel extends ConfigPanel {
        ...
        b.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                ExtensionFilter filter =
                        new ExtensionFilter("JSynthLib Library Files (*" + lext
                                + ")", new String[] {
                            lext });
    ...
    protected void init() {
        tFile.setText(getAppConfig().getDefaultLibrary());
        tLib.setText(getAppConfig().getLibPath());
        tSyx.setText(getAppConfig().getSysexPath());
    }

    protected void commitSettings() {
        getAppConfig().setDefaultLibrary(tFile.getText());
        getAppConfig().setLibPath(tLib.getText());
        getAppConfig().setSysexPath(tSyx.getText());
        setModified(false);
    }
}
