...
public class DesignerFrame extends JFrame implements ContainerListener {
    ...
    public DesignerFrame(boolean dummy) {
        ...
        sp =
                new JScrollPane(widget, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
        ...
        /*
         * Strut strut = new Strut(8,400); widget.addWidget(strut,
         * strut.getConstraints()); SpringLayout l = (SpringLayout)
         * c.getLayout(); l.putConstraint(SpringLayout.EAST, widget, 0,
         * SpringLayout.EAST, strut); l.putConstraint(SpringLayout.SOUTH,
         * widget, 0, SpringLayout.SOUTH, strut);
         * strut.getEWAnchor().setTarget(widget);
         * strut.getEWAnchor().setPadding(592);
         * strut.getNSAnchor().setTarget(widget); glass.addWidget(strut);
         */
    }
    ...
    public PanelWidget getRootWidget() {
        return widget;
    }
