...
public class ParameterFrame extends JFrame implements DragGestureListener,
        DragSourceListener, Serializable {
    ...
    public ParameterFrame() {
        ...
        DragSource.getDefaultDragSource().createDefaultDragGestureRecognizer(
                tree, DnDConstants.ACTION_LINK, this);
    ...
    public void dragGestureRecognized(DragGestureEvent e) {
        ...
        // Create ghost image
        Component renderer =
                tree.getCellRenderer().getTreeCellRendererComponent(tree, node,
                        true, false, true, 0, false);

        renderer.setSize((int) bounds.getWidth(), (int) bounds.getHeight());
        BufferedImage ghost =
                new BufferedImage((int) bounds.getWidth(),
    ...
    public DefaultMutableTreeNode getParameterNode() {
        return pnode;
    }
