...
public class GlassPane extends JPanel implements DropTargetListener,
    ...
    public GlassPane() {
        ...
        Object proxy =
                Proxy.newProxyInstance(MouseListener.class.getClassLoader(),
                        new Class[] {
                                MouseListener.class, KeyListener.class }, this);
    ...
    protected boolean addComponent(String id, Point p) {
        ...
        if (id.startsWith("Strut")) {
            ...
            /*
             * Strut s = new Strut(8, 100); addWidget(s);
             * cw.addWidget(s,s.getConstraints());
             * s.getNSAnchor().setTarget(cw); s.getEWAnchor().setTarget(cw);
    ...
    protected ContainerWidget getContainer(Point p) {
        ...
        while (new_container != null && new_container != c
            ...
            new_point =
                    SwingUtilities.convertPoint(c, new_point, new_container);
    ...
    public void paint(Graphics g) {
        try {
            AnchoredWidget selected =
                    (AnchoredWidget) designer.getSelectedWidget();
            if (selected != null) {
                ...
                Point origin =
                        SwingUtilities.convertPoint(selected.getParent(),
                                new Point(0, 0), this);
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
        ...
        if (args.length == 1 && args[0] instanceof MouseEvent) {
            ...
            if (!sp.getViewport().contains(
                ...
                Point p =
                        SwingUtilities.convertPoint(this, e.getPoint(),
                                designer.getLayeredPane());
                Component c =
                        SwingUtilities.getDeepestComponentAt(
                                designer.getLayeredPane(), p.x, p.y);
                if (c == null)
                    return null;
