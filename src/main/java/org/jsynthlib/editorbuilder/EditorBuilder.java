...
import org.jsynthlib.view.CompatibleFileDialog;
...
public class EditorBuilder {
    ...
    protected static Action[][] actions =
            {
                    {
                            new loadParams(), new saveParams(),
                            new emptyParams(), null, new openDesigner(),
                            new saveDesigner(), new export(), null,
                            new refreshLayout(), null, new exit(), },
                    {
                            new showpframe(), new showdframe(),
                            new showpropframe(), } };
    ...
    public static ParameterFrame getParameterFrame() {
        return pframe;
    }

    public static PropertiesFrame getPropertiesFrame() {
        return propframe;
    }
    ...
    protected static void save(File file) {
        JMenuBar pmb = pframe.getJMenuBar(), dmb = dframe.getJMenuBar(), propmb =
                propframe.getJMenuBar();

        pframe.setJMenuBar(null);
        dframe.setJMenuBar(null);
