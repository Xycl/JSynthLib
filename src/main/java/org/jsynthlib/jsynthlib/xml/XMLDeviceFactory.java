...
public abstract class XMLDeviceFactory {
    ...
    private static String[] searchpath = new String[] {
            "org/jsynthlib/jsynthlib/synthdrivers",
            "/org/jsynthlib/jsynthlib/synthdrivers" };
                ...
                while (!filelist.isEmpty()) {
                    ...
                    try {
                        ...
                        devices.addLast(new String[] {
                                ...
                                handler.getManufacturer(), });
                    } catch (SAXParseException ex) {
                        // Error generated by the parser
                        LOG.info("\n** Error parsing device "
                                + ", line " + ex.getLineNumber() + ", uri "
                                + ex.getSystemId());
    ...
    public static Device createDevice(String filename, Preferences prefs) {
        ...
        try {
            ...
            ErrorMsg.reportError("Can't load device", "Can't load " + filename
                    + ". It is not a device.");
        } catch (SAXException ex) {
            Exception x = ex;
            if (ex.getException() != null)
    ...
    private static void updateSearchPath() {
        /*
         * if (userpath.equals(PatchEdit.appConfig.getXMLpaths())) { return; }
         * userpath = PatchEdit.appConfig.getXMLpaths(); String[] userpaths =
         * userpath.split(File.pathSeparator); int l = userpaths.length;
         * searchpath = new String[l + 2]; System.arraycopy(userpaths, 0,
         * searchpath, 2, l); searchpath[1] = "xmldrivers"; searchpath[0] =
         * "/xmldrivers";
         */
    }
