...
public class DeviceLoadHandler extends AdvDefaultHandler {
    ...
    public static class DeviceBuilder {
        ...
        public XMLDevice getDevice() {
            XMLDevice d =
                    new XMLDevice(manufacturer, model, inquiryid, infotext,
                            authors);
            IDriver[] drivers =
                    (IDriver[]) this.drivers.toArray(new IDriver[0]);
    ...
    public class DriverBuilder {
        ...
        public void setClass(String f) throws SAXParseException {
            try {
                imp =
                        PluginRegistry.groovyLoader().parseClass(
                                new File(base_path, f));
            } catch (Exception e) {
                throw new SAXParseException("Error parsing driver class",
                        locator, e);
            }
        }
        ...
        private XMLDriverImplementation getImp() throws SAXParseException {
            try {
                ...
                throw new SAXParseException("Error instantiating driver class",
                        locator, e);
            }
