 ...
 */
public class BeforePanelLoadedMethodController extends LuaMethodControllerBase {
    ...
    public BeforePanelLoadedMethodController() {
        super("beforePanelCreated");
    }
