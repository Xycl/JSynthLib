 ...
 *
 */
public class WriteMenuGenerator extends MenuMethodGeneratorBase {

    /**
     * @param menuHeader
     */
    public WriteMenuGenerator() {
        super("Write Single Patch or Bank onto the synth");
    }
    ...
    protected List<StringPair> getList(DriverLuaBean values) {
        return values.getWriteMenuOptions();
    }
