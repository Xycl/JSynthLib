 ...
 *
 */
public class SaveMenuGenerator extends MenuMethodGeneratorBase {

    /**
     * @param menuHeader
     */
    public SaveMenuGenerator() {
        super("Save Single Patch or Bank(s)");
    }
    ...
    protected List<StringPair> getList(DriverLuaBean values) {
        return values.getSaveMenuOptions();
    }
