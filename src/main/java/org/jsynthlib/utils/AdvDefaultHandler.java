...
public class AdvDefaultHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if (o != null) {
            ...
            if (g == null)
                throw new SAXParseException("Error creating " + el + " object",
                        locator);
            startObject(g);
        }
    ...
    public Object parse(File f) throws ParserConfigurationException,
    ...
    private void applyDefaults() throws SAXException {
        ...
        while (it.hasNext()) {
            ...
            if (de.depth > curdepth && !de.used) {
                ...
                String msg =
                        "Unrecognized element " + el.toLowerCase()
                                + " closed at line " + de.line + ", column "
                                + de.col;
    ...
    private void storeObject(String element) throws SAXParseException {
        ...
        try {
            o =
                    o.getClass().getMethod("get" + element, (Class[]) null)
    ...
    private boolean store(Object o, String element, boolean setDefault)
        ...
        try {
            ...
            throw new SAXParseException("Error processing element " + element,
                    locator, e);
        }
        return true;
    }
