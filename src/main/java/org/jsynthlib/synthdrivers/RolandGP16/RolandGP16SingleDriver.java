 ...
 * @version $Id: RolandGP16SingleDriver.java 1096 2011-09-01 19:45:39Z frankster
 *          $
 */
public class RolandGP16SingleDriver extends AbstractPatchDriver {
    /** Header Size */
    ...
    private static final SysexHandler SYS_REQ = new SysexHandler(
            "F0 41 @@ 2A 11 09 *patchnumber* 00 00 00 75 *checksum* F7");
    ...
    public RolandGP16SingleDriver() {
        ...
        System.arraycopy(generateNumbers(1, 8, "Group A - Bank ##"),
                0, bankNumbers, 0, 8);
        System.arraycopy(generateNumbers(1, 8, "Group B - Bank ##"),
                0, bankNumbers, 8, 8);
        patchNumbers = new String[8 * 1];
        System.arraycopy(generateNumbers(1, 8, "Patch ##"), 0,
                patchNumbers, 0, 8);
    }
