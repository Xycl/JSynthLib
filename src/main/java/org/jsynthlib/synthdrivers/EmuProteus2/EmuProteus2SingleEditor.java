...
import org.jsynthlib.synthdrivers.EmuProteus2.EmuProteus2Sender.Factory;
...
public class EmuProteus2SingleEditor extends PatchEditorFrame {
    ...
    private final Factory senderFactory;
    ...
    final JPanel createGlobalPanel() {
        ...
        addWidget(
                global,
                new ScrollBarWidget("Pressure", patch, -128, 127, 0,
                        newEmuParamModel(EmuProteus2Constants.PRESSURE),
                        senderFactory.newSender(EmuProteus2Constants.PRESSURE)),
                GridBagConstraints.RELATIVE, 0, 1, 1, 0);

        addWidget(global,
                new ComboBoxWidget("Curve", patch,
                        newEmuParamModel(EmuProteus2Constants.CURVE),
                        senderFactory.newSender(EmuProteus2Constants.CURVE),
                        VELOCITY_CURVES), GridBagConstraints.RELATIVE, 1, 1, 1,
                0);

        addWidget(global,
                new ComboBoxWidget("Submix", patch,
                        newEmuParamModel(EmuProteus2Constants.SUBMIX),
                        senderFactory.newSender(EmuProteus2Constants.SUBMIX),
                        SUBMIX), GridBagConstraints.RELATIVE, 1, 1, 1, 0);
        return global;
    }
    ...
    final JPanel createInstrumentPanel(int instrIndex) {
        ...
        addWidget(
                ...
                new ComboBoxWidget("Instrument", patch,
                        newEmuInstrumentParamModel(base
        ...
        addWidget(instr, new ComboBoxWidget("High Key", patch,
                newEmuParamModel(base + EmuProteus2Constants.HIGH_KEY),
                senderFactory.newSender(base + EmuProteus2Constants.HIGH_KEY),
                OCTAVE_KEYS), 0, GridBagConstraints.RELATIVE, 3, 1, 0);

        Node[] nodes =
                new Node[] {
                        new Node(0, 99, newEmuParamModel(base
                                + EmuProteus2Constants.ENV_DELAY), 0, 0, null,
                                0, false, senderFactory.newSender(base
                                        + EmuProteus2Constants.ENV_DELAY),
                                null, "Delay", null),
                        new Node(0, 99, newEmuParamModel(base
                                + EmuProteus2Constants.ENV_ATTACK), 100, 100,
                                null, 0, false, senderFactory.newSender(base
                                        + EmuProteus2Constants.ENV_ATTACK),
                                null, "Attack", null),
                        new Node(0, 99, newEmuParamModel(base
                                + EmuProteus2Constants.ENV_HOLD), 100, 100,
                                null, 0, false, senderFactory.newSender(base
                                        + EmuProteus2Constants.ENV_HOLD), null,
                                "Hold", null),
                        new Node(0, 99, newEmuParamModel(base
                                + EmuProteus2Constants.ENV_DECAY), 100, 100,
                                null, 0, false, senderFactory.newSender(base
                                        + EmuProteus2Constants.ENV_DECAY),
                                null, "Decay", null),
                        new Node(0, 0, null, 0, 99, newEmuParamModel(base
                                + EmuProteus2Constants.ENV_SUSTAIN), 0, false,
                                null, senderFactory.newSender(base
                                        + EmuProteus2Constants.ENV_SUSTAIN),
                                null, "Sustain"),
                        new Node(0, 99, newEmuParamModel(base
                                + EmuProteus2Constants.ENV_RELEASE), 0, 0,
                                null, 0, false, senderFactory.newSender(base
                                        + EmuProteus2Constants.ENV_RELEASE),
                                null, "Release", null) };

        addWidget(instr, new CheckBoxWidget("Envelope", patch,
                newEmuParamModel(base + EmuProteus2Constants.ENV_ON),
                senderFactory.newSender(base + EmuProteus2Constants.ENV_ON)),
                0, GridBagConstraints.RELATIVE, 1, 1, 0);
        addWidget(instr, new CheckBoxWidget("Solo", patch,
                newEmuParamModel(base + EmuProteus2Constants.SOLO),
                senderFactory.newSender(base + EmuProteus2Constants.SOLO)), 1,
                GridBagConstraints.RELATIVE, 1, 1, 0);
        addWidget(instr, new CheckBoxWidget("Reverse", patch,
                newEmuParamModel(base + EmuProteus2Constants.REVERSE),
        ...
        addWidget(instr, new ScrollBarWidget("Chorus", patch, 0, 15, 0,
                newEmuParamModel(base + EmuProteus2Constants.CHORUS),
    ...
    final JPanel createLfoPanel(int lfoIndex) {
        ...
        addWidget(lfoPanel, new ComboBoxWidget("Shape", patch,
                newEmuParamModel(base + EmuProteus2Constants.LFO_SHAPE),
                senderFactory.newSender(base + EmuProteus2Constants.LFO_SHAPE),
        ...
        addWidget(
                ...
                new ScrollBarWidget(
                        ...
                        127,
                        0,
                        newEmuParamModel(base + EmuProteus2Constants.LFO_DELAY),
                        senderFactory.newSender(base
        ...
        addWidget(
                ...
                new ScrollBarWidget(
                        ...
                        127,
                        0,
                        newEmuParamModel(base + EmuProteus2Constants.LFO_AMOUNT),
                        senderFactory.newSender(base
    ...
    final JPanel createCrossfaderPanel() {
        ...
        addWidget(cfPanel,
                new ComboBoxWidget("Mode", patch,
                        newEmuParamModel(EmuProteus2Constants.CF_MODE),
                        senderFactory.newSender(EmuProteus2Constants.CF_MODE),
                        CF_MODES), 0, GridBagConstraints.RELATIVE, 1, 1, 0);
        addWidget(cfPanel, new ComboBoxWidget("Direction", patch,
                newEmuParamModel(EmuProteus2Constants.CF_DIRECTIONS),
        ...
        addWidget(cfPanel, new ScrollBarWidget("Balance", patch, 0, 127, 0,
                newEmuParamModel(EmuProteus2Constants.CF_BALANCE),
                senderFactory.newSender(EmuProteus2Constants.CF_BALANCE)), 0,
                GridBagConstraints.RELATIVE, 1, 1, 0);
        addWidget(
                cfPanel,
                new ScrollBarWidget("Amount", patch, 0, 255, 0,
                        newEmuParamModel(EmuProteus2Constants.CF_AMOUNT),
                        senderFactory.newSender(EmuProteus2Constants.CF_AMOUNT)),
                0, GridBagConstraints.RELATIVE, 1, 1, 0);
        addWidget(cfPanel, new ComboBoxWidget("Switch Point", patch,
                newEmuParamModel(EmuProteus2Constants.SWITCH_POINT),
    ...
    final JPanel createLinksPanel() {
        ...
        for (int i = 0; i < rows; i++) {
            ...
            if (i == 0) {
                ...
                ComboBoxWidget low =
                        new ComboBoxWidget(null, patch, newEmuParamModel(base
    ...
    final JPanel createAuxEnvPanel() {
        ...
        Node[] nodes =
                new Node[] {
                        new Node(
                                0,
                                99,
                                newEmuParamModel(EmuProteus2Constants.AUX_DELAY),
                                0,
                                0,
                                null,
                                0,
                        ...
                        new Node(
                                0,
                                99,
                                newEmuParamModel(EmuProteus2Constants.AUX_ATTACK),
                                100,
                                100,
                                null,
                                0,
                        ...
                        new Node(
                                0,
                                99,
                                newEmuParamModel(EmuProteus2Constants.AUX_HOLD),
                                100,
                                100,
                                null,
                                0,
                        ...
                        new Node(
                                0,
                                99,
                                newEmuParamModel(EmuProteus2Constants.AUX_DECAY),
                                100,
                                100,
                                null,
                                0,
                        ...
                        new Node(
                                ...
                                0,
                                99,
                                newEmuParamModel(EmuProteus2Constants.AUX_SUSTAIN),
                                0,
                                false,
                                null,
                                senderFactory
                        ...
                        new Node(
                                0,
                                99,
                                newEmuParamModel(EmuProteus2Constants.AUX_RELEASE),
                                0,
                                0,
                                null,
                                0,
        ...
        addWidget(envPanel, new ScrollBarWidget("Amount", patch, 0, 127, 0,
                newEmuParamModel(EmuProteus2Constants.AUX_AMOUNT),
    ...
    IParamModel newEmuParamModel(int ofs) {
        EmuParamModel model = new EmuParamModel();
        model.setOffset(ofs);
        model.setPatch(patch);
        return model;
    }

    private IParamModel newEmuInstrumentParamModel(int i) {
        EmuInstrumentParamModel model = new EmuInstrumentParamModel();
        model.setOffset(i);
        model.setPatch(patch);
        return model;
    }
