 ...
 */
public class YamahaUB99Driver extends AbstractPatchDriver {
    ...
    public void sendThisPatch(Patch p, int nr, int typ) {
        try {
            ...
            byte[] buf =
                    new byte[] {
                            (byte) 0xF0, (byte) 0x43, (byte) (0x7D),
                            (byte) 0x30, (byte) 0x55, (byte) 0x42, (byte) 0x39,
                            (byte) 0x39, (byte) 0x00, (byte) 0x00, (byte) 0x30,
                            (byte) typ, (byte) nr, (byte) 0x00, (byte) 0xF7 };
    ...
    public byte[] createNewPatchArray() {
        ...
        System.arraycopy(YamahaUB99Const.NEW_PATCH_NAME, 0, b,
    ...
    public Patch createNewPatch() {
        return getPatchFactory().createNewPatch(createNewPatchArray(), this);
    }

    @Override
    public JSLFrame editPatch(Patch p) {
        return new YamahaUB99Editor(p);
    }
    ...
    public Patch getDefaultValues(Patch p, int patchno) {
        ...
        try {
            ...
            if (fileIn != null) {
                fileIn.read(buffer);
                fileIn.close();
                System.arraycopy(buffer, patchno * size, p.sysex, 0,
