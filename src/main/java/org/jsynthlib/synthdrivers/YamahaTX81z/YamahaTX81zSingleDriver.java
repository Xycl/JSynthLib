/*
 * @version $Id: YamahaTX81zSingleDriver.java 1113 2011-09-04 18:47:39Z frankster $
 */
...
public class YamahaTX81zSingleDriver extends AbstractPatchDriver {
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        try {
            ...
            send(new byte[] {
                    ...
                    (byte) 0x13, (byte) 0x41, (byte) 0x7F, (byte) 0xF7 });
            Thread.sleep(100);
            send(new byte[] {
                    (byte) 0xF0, (byte) 0x43, (byte) (0x10 + getChannel() - 1),
            ...
            send(new byte[] {
                    (byte) 0xF0, (byte) 0x43, (byte) (0x10 + getChannel() - 1),
                    (byte) 0x13, (byte) 0x41, (byte) 0x00, (byte) 0xF7 });
            Thread.sleep(100);
            send(new byte[] {
                    (byte) 0xF0, (byte) 0x43, (byte) (0x10 + getChannel() - 1),
                    (byte) 0x13, (byte) 0x48, (byte) 0x7F, (byte) 0xF7 });
