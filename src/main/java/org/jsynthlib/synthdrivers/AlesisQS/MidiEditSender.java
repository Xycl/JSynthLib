...
/**
 * Sender for AlesisQS keyboards. Uses Midi function 0x10 - "MIDI Editing" - to
 * send changes for one parameter to the keyboard. Sends in the format F0 00 00
 * 0E 0E 10 <0mmfffff> <0ssppppp> <0ccccddv> <0vvvvvvvv> F7 (value is 8 bit 2's
 * complement)
 * @author Zellyn Hunter (zjh, zellyn@zellyn.com)
 * @version $Id: MidiEditSender.java 386 2004-03-19 14:50:22Z ttittmann $
 */
...
public class MidiEditSender extends SysexSender {
     ...
     * @param function
     *            0-16, depending on mode
     * @param sound
     *            Sound 1-4 (0-3) if mode=2, effect bus 1-4 (0-3) if mode=3
     * @param page
     *            0-23, depending on mode and function
     * @param channel
     *            1-16 (0-15). Ignored unless mode = 1 or 2
     * @param pot
     ...
     * @param value
     *            the value, in 8-bit 2's complement
     */
