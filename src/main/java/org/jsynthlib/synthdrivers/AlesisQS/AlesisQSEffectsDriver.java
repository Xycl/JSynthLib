 ...
 * @version $Id: AlesisQSEffectsDriver.java 1182 2011-12-04 22:07:24Z
 *          chriswareham $ GPL v2
 */

public class AlesisQSEffectsDriver extends AbstractPatchDriver {
    ...
    public Patch createNewPatch() {
        ...
        sysex[QSConstants.POSITION_OPCODE] =
                QSConstants.OPCODE_MIDI_USER_EFFECTS_DUMP;
     ...
     * number is 0..127, then use opcode 07 - MIDI User Effects Dump Request. If
     * the patch number is 128..129, use opcode 09 - MIDI Edit Effects Dump
     * Request. 128 corresponds to the Program mode effects edit buffer, and 129
     * to the Mix mode effects edit buffer
     * @param bankNum
     *            not used
     * @param patchNum
     *            the patch number
