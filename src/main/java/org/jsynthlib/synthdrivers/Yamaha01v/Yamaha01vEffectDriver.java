...
public class Yamaha01vEffectDriver extends AbstractPatchDriver {
    ...
    public Yamaha01vEffectDriver() {
        ...
        System.arraycopy(generateNumbers(1, 99, "Lib 00"), 0,
                patchNumbers, 0, 99);
    ...
    public Patch createNewPatch() {
        ...
        try {
            java.io.InputStream fileIn =
                    getClass().getResourceAsStream("01v_Effect.syx");
            fileIn.read(sysex);
            fileIn.close();
