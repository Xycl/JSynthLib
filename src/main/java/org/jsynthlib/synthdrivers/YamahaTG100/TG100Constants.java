 ...
 * @version $Id: TG100Constants.java 652 2004-08-02 08:01:47Z jbackhaus $
 */
public class TG100Constants {
    ...
    public static final String[] VOICE_MODE = {
            "1 element", "2 elements" };
    public static final String[] PITCH_RATE_SCALING = {
            "100%", "50%", "20%", "10%", "5%", "0%" };
    ...
    public static final String[] PANPOT = {
            "center", "right + 1", "right + 2", "right + 3", "right + 4",
            "right + 5", "right + 6", "right + 7", "left - 7", "left - 6",
            "left - 5", "left - 4", "left - 3", "left - 2", "left - 1" };

    public static final String[] PITCH_LFO_WAVE = {
            "triangle", "sample & hold" };

    public static final String[] P_EG_RANGE = {
            "1/2 oct", "1 oct", "2 oct" };

    public static final String[] SWITCH = {
            "on", "off" };

    public static final String[] VELOCITY_CURVE = {
