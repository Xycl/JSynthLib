 ...
 * @version $Id: YamahaTG100Device.java 898 2005-02-08 07:09:09Z jbackhaus $
 */
public class YamahaTG100Device extends Device {

    private static final String INFO_TEXT =
            "Librarian & editor for the Yamaha TG-100.";

    /**
     * Constructor for DeviceListWriter.
     */
    public YamahaTG100Device() {
        super("Yamaha", "TG100", "F07E..06020001050000040001002100F7",
    ...
    public void setup(Preferences prefs) {
        ...
        YamahaTG100SingleDriver singleDriver = new YamahaTG100SingleDriver();
        addDriver(singleDriver);
        addDriver(new YamahaTG100BankDriver(singleDriver));
    }
}
