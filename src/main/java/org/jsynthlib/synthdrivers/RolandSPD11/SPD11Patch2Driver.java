 ...
 * @author peter
 */
public class SPD11Patch2Driver extends AbstractPatchDriver {
    ...
    private String[] programNumbers;

    /**
     * @param padDriver
     * @param settingsDriver
     */
    public SPD11Patch2Driver(SPD11PadDriver padDriver,
        ...
        programNumbers = generateNumbers(1,
                128, "##");
    }
     ...
     * @TODO put method in SPD11_Constants because SPD11PatchDriver also uses
     *       this
     */
    ...
    public JSLFrame editPatch(Patch p) {
        return new SPD11Patch2Editor((Patch) p, programNumbers);
    }
}
