...
/**
 * RolandSPD11Device.java Device class for Roland SPD-11 Total Percussion Pad.
...
public class RolandSPD11Device extends Device {
     ...
     * Creates a new <code>RolandSPD11Device</code> instance.
     * <p>
     * @param prefs
     */
    public void setup(Preferences prefs) {
        ...
        // Channel is used as Device ID, using value -1 assures the program will
        // send to the right SPD11 in case there's more than one SPD11 in a
        // setup
        setDeviceID(-1);
        ...
        SPD11Patch2Driver patch2Driver =
                new SPD11Patch2Driver(padDriver, settingsDriver);
        ...
        // SPD11CompletePatchConverter completePatchConverter = new
        // SPD11CompletePatchConverter(pdDriver, sttngsDriver);
        // addDriver(completePatchConverter);
        // SPD11DumpAllConverter dumpAllConverter = new
        // SPD11DumpAllConverter(ptch2Driver, chnDriver, sstmDriver);
        ...
        // add bank drivers
        SPD11PatchDriver patchDriver =
                new SPD11PatchDriver(padDriver, settingsDriver);
        addDriver(patchDriver);
        SPD11DumpAllDriver dumpAllDriver =
                new SPD11DumpAllDriver(systemDriver, chainDriver, padDriver,
                        settingsDriver, patch2Driver);
