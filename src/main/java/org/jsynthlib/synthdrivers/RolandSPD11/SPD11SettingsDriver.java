...
public class SPD11SettingsDriver extends AbstractPatchDriver {
    ...
    /**
     * @see org.jsynthlib.device.model.AbstractPatchDriver#requestPatchDump(int, int)
     * @param patchNum
     *            is always 0 for settings so ignored
     * @param bankNum
     *            is the SPD-11 patch we request settings from
     */
    @Override
     ...
     *            is the SPD-11 patch
     * @param patchNum
     *            is ignored because it's always 0 for settings
     */
    @Override
    ...
    public String getPatchName(Patch p) {
         ...
         */
        return "FX&PedalSettings _ P"
                + SPD11_PATCHES1[p.sysex[6]]; // was return
                                                              // patchNumbers[p.sysex[7]-1];
    }
