 ...
 * @version $Id: RolandMT32PatchTempDriver.java 1031 2005-10-10 17:44:56Z
 *          billzwicky $
 */
public class RolandMT32PatchTempDriver extends AbstractPatchDriver {
    ...
    public Patch createNewPatch() {
        ...
        // setPatchName(p, "getPatchFactory().createNewPatchT");
        calculateChecksum(p);
        return p;
    }
