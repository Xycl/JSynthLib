 ...
 *
 * @version $Id: RolandMT32TimbreMemoryDriver.java 1057 2006-03-07 20:47:31Z jbackhaus $
 */
...
public class RolandMT32TimbreMemoryDriver extends AbstractPatchDriver {
    ...
    public RolandMT32TimbreMemoryDriver() {
        ...
        // patchSize = 0xFF; // For Timbre Memory the patch distance is greater
        // than the size.
        ...
        patchNumbers =
                new String[] {
                        ...
                        "TM-8", "TM-9", "TM-10", "TM-11", "TM-12", "TM-13",
                        "TM-14", "TM-15", "TM-16", "TM-17", "TM-18", "TM-19",
                        "TM-20", "TM-21", "TM-22", "TM-23", "TM-24", "TM-25",
                        "TM-26", "TM-27", "TM-28", "TM-29", "TM-30", "TM-31",
                        "TM-32", "TM-33", "TM-34", "TM-35", "TM-36", "TM-37",
                        "TM-38", "TM-39", "TM-40", "TM-41", "TM-42", "TM-43",
                        "TM-44", "TM-45", "TM-46", "TM-47", "TM-48", "TM-49",
                        "TM-50", "TM-51", "TM-52", "TM-53", "TM-54", "TM-55",
                        "TM-56", "TM-57", "TM-58", "TM-59", "TM-60", "TM-61",
                        "TM-62", "TM-63", "TM-64" };
    }

    /*
     * Send a patch (bulk dump system exclusive message) to MIDI device. The
     * message format here is Data set DT1
     */
    @Override
     ...
     * MIDI device. Target should be Timbre Temp Area 1 - 8. The message format
     * here is Data set DT1
     */
    @Override
    ...
    public void requestPatchDump(int bankNum, int timNum) {
        ...
        int timSizeL = 0x76;
        int checkSum =
                (0 - (timAddrH + timAddrM + timAddrL + timSizeH + timSizeM + timSizeL)) & 0x7F;
