 ...
 *
 * @version $Id: RolandMT32DisplayDriver.java 1031 2005-10-10 17:44:56Z billzwicky $
 */
 ...
 * @version $Id: RolandMT32DisplayDriver.java 1031 2005-10-10 17:44:56Z
 *          billzwicky $
 */
public class RolandMT32DisplayDriver extends AbstractPatchDriver {
    //
    ...
    /*
     * public void requestPatchDump(int bankNum, int patchNum) { // The message
     * format here is Request RQ1 // All but the checksum is already set up in
     * SYS_REQ // send(SYS_REQ.toSysexMessage(getChannel(), // new
     * SysexHandler.NameValue("checkSum", 0x69)
