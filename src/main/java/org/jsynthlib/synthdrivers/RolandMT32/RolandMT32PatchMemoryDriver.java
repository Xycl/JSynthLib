 ...
 *
 * @version $Id: RolandMT32PatchMemoryDriver.java 1031 2005-10-10 17:44:56Z billzwicky $
 */
...
public class RolandMT32PatchMemoryDriver extends AbstractPatchDriver {
    ...
    /*
     * Send a patch (bulk dump system exclusive message) to MIDI device. Target
     * should be Timbre Memory 1 - 64. TTA will do for now. The message format
    ...
    // getPatchFactory().createNewPatch has Data set format DT1
    @Override
    public Patch createNewPatch() {
        ...
        // setPatchName(p, "getPatchFactory().createNewPatchM");
        calculateChecksum(p);
        return p;
    }
    ...
    public void requestPatchDump(int bankNum, int patNum) {
        ...
        int patSizeL = 0x07;
        int checkSum =
                (0 - (patAddrH + patAddrM + patAddrL + patSizeH + patSizeM + patSizeL)) & 0x7F;
