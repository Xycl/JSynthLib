 ...
 * @version $Id: RolandMT32PatchMemoryBankDriver.java 1031 2005-10-10 17:44:56Z billzwicky $
 */
...
public class RolandMT32PatchMemoryBankDriver extends AbstractBankDriver {
    /** Header Size */
    ...
    public RolandMT32PatchMemoryBankDriver() {
        ...
        System.arraycopy(generateNumbers(1, 128, "##"), 0,
                patchNumbers, 0, 128);
