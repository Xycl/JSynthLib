 ...
 * @version $Id: RolandMT32TimbreTempBankDriver.java 1031 2005-10-10 17:44:56Z billzwicky $
 */
...
public class RolandMT32TimbreTempBankDriver extends AbstractBankDriver {
    /** Header Size */
    ...
    private static final SysexHandler SYS_REQ = new SysexHandler(
            "F0 41 10 16 11 04 *bankNum* *patchNum* 00 01 76 *checkSum* F7");
