...
public final class RolandVG88SysDatDriver extends AbstractPatchDriver {
    ...
    static final int[] DISPLAY_CONTRAST = {
            0x00, 0x00, 0x00, 0x00, 0x01 };
    static final int[] GK_FUNK = {
            0x01, 0x00, 0x00, 0x00, 0x02 };
    static final int[] GLOBAL = {
            0x02, 0x00, 0x00, 0x00, 0x08 };
    static final int[] TUNER = {
            0x03, 0x00, 0x00, 0x00, 0x02 };
    static final int[] OUTPUT_SELECT = {
            0x04, 0x00, 0x00, 0x00, 0x01 };
    static final int[] DRIVER = {
            0x05, 0x00, 0x00, 0x00, 0x90 };
    static final int[] PEDAL = {
            0x06, 0x00, 0x00, 0x00, 0x08 };
    static final int[] DIAL = {
            0x07, 0x00, 0x00, 0x00, 0x01 };
    static final int[] MIDI = {
            0x09, 0x00, 0x00, 0x01, 0x0f };
    static final int[] PRG_MAP_BANK0 = {
            0x09, 0x00, 0x02, 0x00, 0x100 };
    static final int[] PRG_MAP_BANK1 = {
            0x09, 0x00, 0x04, 0x00, 0x100 };
    static final int[] PRG_MAP_BANK2 = {
            0x09, 0x00, 0x06, 0x00, 0x100 };
    ...
    static final SysexHandler SYS_REQ =
            new SysexHandler(
