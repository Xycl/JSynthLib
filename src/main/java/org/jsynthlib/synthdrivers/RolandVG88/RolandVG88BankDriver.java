...
package org.jsynthlib.synthdrivers.RolandVG88;
...
public class RolandVG88BankDriver extends AbstractBankDriver {
    ...
    public RolandVG88BankDriver(RolandVG88SingleDriver singleDriver) {
        ...
        patchSize =
                RolandVG88SingleDriver.SINGLE_SIZE
                        * RolandVG88SingleDriver.NUM_PATCH;
    ...
    public void putPatch(Patch bank, Patch p, int patchNum) {
        ...
        System.arraycopy(p.sysex, 0, bank.sysex, singleSize * patchNum,
                singleSize);
    }
    ...
    public BankPatch createNewPatch() {
        BankPatch bank =
                getPatchFactory().newBankPatch(this, bankDefFileName,
                        patchSize);
        // byte[] sysex = new byte[patchSize];
        // Patch bank = getPatchFactory().createNewPatch(sysex, this);
    ...
    /**
     * Request all user Patchs BankNum nor patchNum are not used. Request all
     * user Patchs
     */
    @Override
    ...
    /**
     * Store all user Patchs BankNum nor patchNum are not used. Request all user
     * Patchs
     */
    @Override
    public void storePatch(Patch p, int bankNum, int patchNum) {
        int ofst = 0;
        for (int i = 0; i < RolandVG88SingleDriver.NUM_PATCH; i++, ofst +=
                singleSize) {
