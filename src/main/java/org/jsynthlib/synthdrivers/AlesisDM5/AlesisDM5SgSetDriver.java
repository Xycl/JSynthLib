...
public class AlesisDM5SgSetDriver extends AbstractPatchDriver {
    ...
    private static final SysexHandler SYS_REQ = new SysexHandler(
            Constants.SINGL_SET_DUMP_REQ_ID); // System Info Dump Request
    ...
    private static final byte NEW_SYSEX[] = {
            ...
            (byte) 0x00, (byte) 0x01, (byte) 0x54, (byte) 0x65, (byte) 0x73,
            (byte) 0x74, (byte) 0x20, (byte) 0x50, (byte) 0x61, (byte) 0x74,
            (byte) 0x63, (byte) 0x68, (byte) 0x20, (byte) 0x20, (byte) 0x20,
            (byte) 0x20, (byte) 0x24, (byte) 0x00, (byte) 0x00, (byte) 0x00,
            (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
            (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
            (byte) 0x00, (byte) 0x63, (byte) 0x30, (byte) 0x00, (byte) 0x00,
            (byte) 0x0C, (byte) 0x63, (byte) 0x30, (byte) 0x00, (byte) 0x00,
            (byte) 0x0C, (byte) 0x63, (byte) 0x30, (byte) 0x00, (byte) 0x00,
            (byte) 0x0C, (byte) 0x63, (byte) 0x30, (byte) 0x00, (byte) 0x00,
            (byte) 0x0C, (byte) 0x63, (byte) 0x30, (byte) 0x00, (byte) 0x00,
            (byte) 0x0C, (byte) 0x63, (byte) 0x30, (byte) 0x00, (byte) 0x00,
     ...
     * <p>
     * Overrides the Driver.storePatch method to embed the program number in the
     * patch. The input bankNum parameter is not used. The input patch number
     * specifies the location (0 thru 20). Location numbers in the DM5 are are
     * represented as binary 0010 0000 through 0011 0100 (32 plus patch number
     * 0-20).
     */
    @Override
    ...
    /**
     * Send Program Change MIDI message. The Alesis Single Set driver does not
     * utilize the program change the same way other devices do. Instead it
     * embeds the program number in the patch. This is done by the overridden
     ...
     * <p>
     * Overrides the Driver.sendPatch method to embed the program number in the
     * patch, in this case the value is 1.
     */
    @Override
    ...
    public void requestPatchDump(int bankNum, int patchNum) {
        ...
        send(SYS_REQ.toSysexMessage(getChannel(), new SysexHandler.NameValue(
                "channel", getChannel()), new SysexHandler.NameValue(
                "patchNum", patchNum)));
    }
    ...
    public JSLFrame editPatch(Patch p) {
        return new AlesisDM5SgSetEditor(p);
    }
}