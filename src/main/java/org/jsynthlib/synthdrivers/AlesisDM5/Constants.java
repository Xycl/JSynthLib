...
final class Constants {
    ...
    static final String INQUIRY_ID = "F07E..060200000E13..............F7";
    /** Text displayed in the synth driver device details window in preferences */
    static final String INFO_TEXT =
            "Device for Alesis DM5. The DM5 must be set to \"Omni On\" to work with JSynthLib. This must be done by setting the channel to 00 on the front panel of the device. See your DM5 manual for details";
    ...
    /**
     * System Info Sysex Match ID--Used to match a patch to an
     * AlesisDM5SysInfoDriver
     */
    // static final String SYS_INFO_SYSEX_MATCH_ID = "F000000E13**00"; Not used.
    // Sys Info patch sometimes has wrong opcode.
    ...
    static final String EDIT_BUFF_DUMP_REQ_ID =
            "F0 00 00 0E 13 *channel* 41 F7";
    /** Edit Buffer Patch Type String */
    static final String EDIT_BUFF_PATCH_TYP_STR = "Edit Buffer";
    /**
     * Edit Buffer Sysex Match ID--Used to match a patch to an
     * AlesisDM5EdBufDriver
     */
    ...
    /**
     * Program Change Dump Request ID--Sent to DM5 for Program change dump
     * request.
     */
    static final String PROG_CHNG_DUMP_REQ_ID =
            "F0 00 00 0E 13 *channel* 43 F7";
    /** Program Change Patch Type String */
    static final String PROG_CHNG_PATCH_TYP_STR = "Program Change Table";
    /**
     * Program Change Sysex Match ID--Used to match a patch to an
    ...
    static final byte[] PROG_CHNG_DUMP_HDR_BYTES = {
            (byte) 0xF0, (byte) 0x00, (byte) 0x00, (byte) 0x0E, (byte) 0x13,
            (byte) 0x01, (byte) 0x03, (byte) 0x00, (byte) 0x01 };

    /**
     * Trigger Setup Dump Request ID--Sent to DM5 for trigger setup dump
     * request.
     */
    static final String TRIG_SETP_DUMP_REQ_ID =
            "F0 00 00 0E 13 *channel* 45 F7";
    /** Trigger Setup Patch Type String */
    static final String TRIG_SETP_PATCH_TYP_STR = "Trigger Setup";
    /**
     * Trigger Setup Sysex Match ID--Used to match a patch to an
     * AlesisDM5TrSetDriver
     */
    ...
    static final byte[] TRIG_SETP_DUMP_HDR_BYTES = {
            (byte) 0xF0, (byte) 0x00, (byte) 0x00, (byte) 0x0E, (byte) 0x13,
            (byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x01 };

    /** Single Set Dump Request ID--Sent to DM5 for Single set dump request. */
    static final String SINGL_SET_DUMP_REQ_ID =
            "F0 00 00 0E 13 *channel* *patchNum* F7";
    /** Single Set Patch Type String */
    static final String SINGL_SET_PATCH_TYP_STR = "Single Set";
    /**
     * Single Set Sysex Match ID--Used to match a patch to an
    ...
    static final byte[] SINGL_SET_DUMP_HDR_BYTES = {
            (byte) 0xF0, (byte) 0x00, (byte) 0x00, (byte) 0x0E, (byte) 0x13,
            (byte) 0x01, (byte) 0x0A, (byte) 0x00, (byte) 0x01 };
}
