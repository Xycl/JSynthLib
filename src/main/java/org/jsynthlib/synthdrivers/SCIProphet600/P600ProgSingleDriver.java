...
// @version $Id: P600ProgSingleDriver.java 677 2004-08-21 14:39:35Z hayashi $
...
public class P600ProgSingleDriver extends AbstractPatchDriver {
    ...
    static final byte[] NEW_PATCH = {
            ...
            (byte) 0x04, (byte) 0x08, (byte) 0x0F, (byte) 0x07, (byte) 0x02,
            (byte) 0x0E, (byte) 0x07, (byte) 0x0F, (byte) 0x0D, (byte) 0x00,
    ...
    public void playPatch(Patch p) {
        ...
        try {
            Thread.sleep(50); // kludge: patch sent twice for Ctl-P from editor,
                              // so add
                              // delay between them (otherwise P600 may not
                              // process properly)
            sendPatch(p2); // kludge to send midi pgm change without modifying
                           // super.playPatch
            Thread.sleep(50);
