...
class P600ProgSingleEditor extends PatchEditorFrame {
    public P600ProgSingleEditor(Patch patch) {
        ...
        addWidget(osc1Pane, new CheckBoxWidget("Saw", patch,
                new P6001ByteModel(patch, 15, 0x01, 0), null), 0, 1, 1, 1, 0);
        addWidget(osc1Pane, new CheckBoxWidget("Tri", patch,
                new P6001ByteModel(patch, 15, 0x02, 1), null), 1, 1, 1, 1, 0);
        addWidget(osc1Pane, new CheckBoxWidget("Pulse", patch,
                new P6001ByteModel(patch, 14, 0x01, 0), null), 2, 1, 1, 1, 0);
        addWidget(osc1Pane, new CheckBoxWidget("Sync", patch,
                new P6001ByteModel(patch, 15, 0x04, 2), null), 3, 1, 1, 1, 0);
        ...
        osc1Pane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "Osc A", TitledBorder.CENTER,
                TitledBorder.CENTER));
        ...
        addWidget(osc2Pane, new ScrollBarWidget("Freq", patch, 0, 63, 0,
                new P6002ByteModel(patch, 3, 0xF8, 3, 0x01, 5), null), 0, 0, 4,
                1, 0);
        addWidget(osc2Pane, new ScrollBarWidget("Fine", patch, 0, 127, 0,
                new P6002ByteModel(patch, 4, 0x80, 7, 0x3F, 1), null), 0, 1, 4,
                1, 0);
        addWidget(osc2Pane, new CheckBoxWidget("Saw", patch,
                new P6001ByteModel(patch, 15, 0x08, 3), null), 0, 2, 1, 1, 0);
        addWidget(osc2Pane, new CheckBoxWidget("Tri", patch,
                new P6001ByteModel(patch, 15, 0x10, 4), null), 1, 2, 1, 1, 0);
        addWidget(osc2Pane, new CheckBoxWidget("Pulse", patch,
                new P6001ByteModel(patch, 14, 0x02, 1), null), 2, 2, 1, 1, 0);
        ...
        addWidget(osc2Pane, new ScrollBarWidget("Osc A-B Mix", patch, 0, 63, 0,
                new P6002ByteModel(patch, 5, 0xC0, 6, 0x0F, 2), null), 0, 4, 4,
                1, 0);
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.gridwidth = 1;
        ...
        osc2Pane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "Osc B", TitledBorder.CENTER,
                TitledBorder.CENTER));
        ...
        addWidget(pmodPane, new ScrollBarWidget("Filter", patch, 0, 15, 0,
                new P6002ByteModel(patch, 0, 0x80, 7, 0x07, 1), null), 0, 0, 4,
                1, 0);
        addWidget(pmodPane, new ScrollBarWidget("Osc B", patch, 0, 127, 0,
                new P6002ByteModel(patch, 1, 0x80, 7, 0x3F, 1), null), 0, 1, 4,
                1, 0);
        addWidget(pmodPane, new CheckBoxWidget("Freq A", patch,
                new P6001ByteModel(patch, 15, 0x20, 5), null), 1, 2, 1, 1, 0);
        addWidget(pmodPane, new CheckBoxWidget("Filter", patch,
                new P6001ByteModel(patch, 15, 0x40, 6), null), 2, 2, 1, 1, 0);
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        pmodPane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "Poly-Mod", TitledBorder.CENTER,
                TitledBorder.CENTER));
        ...
        addWidget(lfoPane, new ScrollBarWidget("Init Amt", patch, 0, 31, 0,
                new P6002ByteModel(patch, 2, 0xC0, 6, 0x07, 2), null), 0, 1, 4,
                1, 0);
        addWidget(lfoPane, new ComboBoxWidget("Shape", patch,
                new P6001ByteModel(patch, 14, 0x10, 4), null, new String[] {
                        "Square", "Triangle" }), 0, 2, 1, 1, 0);
        addWidget(lfoPane, new CheckBoxWidget("Freq A-B", patch,
                new P6001ByteModel(patch, 14, 0x20, 5), null), 1, 2, 1, 1, 0);
        addWidget(lfoPane, new CheckBoxWidget("PW A-B", patch,
                new P6001ByteModel(patch, 14, 0x40, 6), null), 2, 2, 1, 1, 0);
        addWidget(lfoPane, new CheckBoxWidget("Filter", patch,
                new P6001ByteModel(patch, 14, 0x80, 7), null), 3, 2, 1, 1, 0);
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        lfoPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED), "LFO-Mod",
        ...
        addWidget(envPane, new ScrollBarWidget("Cutoff Freq", patch, 0, 127, 0,
                new P6002ByteModel(patch, 6, 0xF0, 4, 0x07, 4), null), 0, 0, 3,
                1, 0);
        addWidget(envPane, new ScrollBarWidget("Resonance", patch, 0, 63, 0,
                new P6002ByteModel(patch, 7, 0xF8, 3, 0x01, 5), null), 0, 1, 3,
                1, 0);
        ...
        addWidget(envPane, new ComboBoxWidget("Kybd Track", patch,
                new P6002FieldModel(patch, 14, 0x08, 3, 0x04, 1), null,
                new String[] {
                        "Off", "1/2", "Full" }), 0, 3, 1, 1, 0);
        addWidget(envPane, new EnvelopeWidget(" ", patch,
                new Node[] {
                        new Node(0, 0, null, 0, 0, null, 0,
                                false, null, null, null, null),
                        new Node(0, 15, new P6001ByteModel(
                                patch, 10, 0x1E, 1), 15, 15, null, 0, false,
                                null, null, "Attack", null),
                        new Node(0, 15, new P6002ByteModel(
                                patch, 9, 0xE0, 5, 0x01, 3), 0, 15,
                                new P6001ByteModel(patch, 9, 0x1E, 1), 0,
                                false, null, null, "Decay", "Sustain"),
                        new Node(0, 15, new P6002ByteModel(
                                patch, 8, 0xE0, 5, 0x01, 3), 0, 0, null, 0,
                                false, null, null, "Release", null), }), 0, 4,
                3, 4, 0);
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        ...
        envPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED), "Filter",
                TitledBorder.CENTER, TitledBorder.CENTER));
        rightPane.add(envPane, gbc);

        JPanel ampPane = new JPanel();
        ampPane.setLayout(new GridBagLayout());
        addWidget(ampPane, new EnvelopeWidget(" ", patch,
                new Node[] {
                        new Node(0, 0, null, 0, 0, null, 0,
                                false, null, null, null, null),
                        new Node(0, 15, new P6001ByteModel(
                                patch, 12, 0x1E, 1), 15, 15, null, 0, false,
                                null, null, "Attack", null),
                        new Node(0, 15, new P6002ByteModel(
                                patch, 11, 0xE0, 5, 0x01, 3), 0, 15,
                                new P6001ByteModel(patch, 11, 0x1E, 1), 0,
                                false, null, null, "Decay", "Sustain"),
                        new Node(0, 15, new P6002ByteModel(
                                patch, 10, 0xE0, 5, 0x01, 3), 0, 0, null, 0,
                                false, null, null, "Release", null), }), 0, 0,
                3, 4, 0);
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.gridwidth = 1;
        ...
        ampPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED), "Amplifier",
                TitledBorder.CENTER, TitledBorder.CENTER));
        ...
        addWidget(cmnPane, new ScrollBarWidget("Glide", patch, 0, 15, 0,
                new P6002ByteModel(patch, 12, 0xE0, 5, 0x01, 3), null), 0, 1,
                3, 1, 0);
        addWidget(cmnPane, new CheckBoxWidget("Unison", patch,
                new P6001ByteModel(patch, 15, 0x80, 7), null), 2, 2, 1, 1, 0);
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
...
class P6001ByteModel extends ParamModel {
    ...
    public void set(int i) {
        int dat =
                patch.sysex[offset * 2 + HDRLEN]
                        | (patch.sysex[offset * 2 + HDRLEN + 1] << 4);
        dat = (dat & ~mask) | ((i << shft) & mask);
        patch.sysex[offset * 2 + HDRLEN] = (byte) (dat & 0x0F);
        patch.sysex[offset * 2 + HDRLEN + 1] = (byte) (dat >> 4);
    }
    ...
    public void set(int i) {
        int dat1 =
                patch.sysex[offset * 2 + HDRLEN]
                        | (patch.sysex[offset * 2 + HDRLEN + 1] << 4);
        int dat2 =
                patch.sysex[offset * 2 + HDRLEN + 2]
                        | (patch.sysex[offset * 2 + HDRLEN + 3] << 4);
        dat1 = (dat1 & ~mask1) | ((i << shft1) & mask1);
        dat2 = (dat2 & ~mask2) | ((i >> shft2) & mask2);
        patch.sysex[offset * 2 + HDRLEN] = (byte) (dat1 & 0x0F);
        patch.sysex[offset * 2 + HDRLEN + 1] = (byte) (dat1 >> 4);
        patch.sysex[offset * 2 + HDRLEN + 2] = (byte) (dat2 & 0x0F);
        patch.sysex[offset * 2 + HDRLEN + 3] = (byte) (dat2 >> 4);
    }
