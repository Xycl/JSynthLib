...
/**
 * @author Ryan Brown
 * @version $Id: YamahaMotifDevice.java 646 2004-07-30 16:57:44Z ribrdb $
 */
public class YamahaMotifDevice extends Device {
    ...
    public YamahaMotifDevice() {
        super(
                "Yamaha",
                "Motif",
                "F07E7F06024300417.040000007FF7",
                "This version has librarian support for single voices (drum "
                        ...
                        + "performances, masters, etc.", "Rib Rdb");
    }
    ...
    public void setup(Preferences prefs) {
        ...
        /*
         * addDriver(0,new YamahaMotifBulkConverter()); addDriver(new
         * YamahaMotifSingleDriver()); addDriver(new YamahaMotifBankDriver());
         * addDriver(new YamahaMotifMultiDriver()); addDriver(new
         * YamahaMotifMultiBankDriver()); addDriver(new
         * YamahaMotifEffectDriver()); addDriver(new
         * YamahaMotifEffectBankDriver()); addDriver(new
         * YamahaMotifDrumsetDriver());
         */
