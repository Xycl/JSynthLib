...
// @version $Id: MKS50PatchSingleDriver.java 677 2004-08-21 14:39:35Z hayashi $
...
public class MKS50PatchSingleDriver extends AbstractPatchDriver {
    ...
    public String getPatchName(Patch ip) {
        try {
            ...
            for (int i = 0; i < patchNameSize; i++)
                c[i] =
                        MKS50ToneSingleDriver.nameChars[((Patch) ip).sysex[i
                                + patchNameStart]];
            return new String(c);
        } catch (Exception ex) {
            return "-";
        ...
        byte sysex[] =
                {
                        ...
                        (byte) 0x23, (byte) 0x30, (byte) 0x01, (byte) 0x00,
                        (byte) 0x0C, (byte) 0x6D, (byte) 0x14, (byte) 0x00,
                        (byte) 0x20, (byte) 0x00, (byte) 0x7F, (byte) 0x00,
                        (byte) 0x00, (byte) 0x0C, (byte) 0x00, (byte) 0x00,
                        (byte) 0x08, (byte) 0x27, (byte) 0x22, (byte) 0x2D,
                        (byte) 0x3E, (byte) 0x3E, (byte) 0x3E, (byte) 0x3E,
                        (byte) 0x3E, (byte) 0x3E, (byte) 0xF7 };
