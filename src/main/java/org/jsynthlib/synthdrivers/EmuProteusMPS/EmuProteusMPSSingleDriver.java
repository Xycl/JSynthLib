/*
 * @version $Id: EmuProteusMPSSingleDriver.java 717 2004-09-15 04:34:19Z hayashi $
 */
...
public class EmuProteusMPSSingleDriver extends AbstractPatchDriver {
    final static SysexHandler SysexRequestDump = new SysexHandler(
            "F0 18 08 00 00 *bankNum* *patchNum* F7");
    ...
    /*
     * public void choosePatch (Patch p) { Integer patchNum; String
     * input=JOptionPane
    ...
    public void requestPatchDump(int bankNum, int patchNum) {
        send(SysexRequestDump.toSysexMessage(getChannel(),
                new SysexHandler.NameValue("bankNum",
                        (bankNum * 100 + patchNum) % 128),
                new SysexHandler.NameValue("patchNum",
                        (bankNum * 100 + patchNum) / 128)));
