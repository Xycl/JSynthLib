...
/**
 * This class holds an integer value which can be retrieved either as an integer
 * value or as a data value in the way the Roland D10 represents large numbers
 * in its transfer protocol. The data value is a representation where only the
 * seven least significant bits of a byte holds information. The class also
 * provides some arithmetic operations to be performed on the objects of this
 * class.
...
public class Entity {
     ...
     * @return An entity object for this int value.
     */
     ...
     * @param dataValue
     *            The value the created object should hold.
     * @return An entity object for this data value.
     */
     ...
     * @return The entity that is the sum of the two entities.
     */
     ...
     * @return The entity that is the difference of the two entities.
     */
     ...
     * @return The entity that is the product of the two entities.
     */
