...
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_KEY_MODE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LEVEL;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LOWER_ASSIGN_MODE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LOWER_BENDER_RANGE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LOWER_FINE_TUNE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LOWER_KEY_SHIFT;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LOWER_REVERB_SWITCH;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LOWER_TONE_GROUP;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_LOWER_TONE_NUMBER;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_REVERB_LEVEL;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_REVERB_MODE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_REVERB_TIME;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_SPLIT_POINT;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_UPPER_ASSIGN_MODE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_UPPER_BENDER_RANGE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_UPPER_FINE_TUNE;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_UPPER_KEY_SHIFT;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_UPPER_REVERB_SWITCH;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_UPPER_TONE_GROUP;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_UPPER_TONE_NUMBER;
import static org.jsynthlib.synthdrivers.RolandD10.D10Constants.PATCH_U_L_BALANCE;
...
public class RolandD10PatchEditor extends RolandD10EditorFrame {
    ...
    public RolandD10PatchEditor(Patch patch) {
        ...
        panel =
                createTimbrePanel("Upper Timbre", patch, new int[] {
        ...
        panel =
                createTimbrePanel("Lower Timbre", patch, new int[] {
    ...
    private JPanel createCommonPanel(String name, Patch patch) {
        ...
        addWidget(panel, new PatchNameWidget("Name", patch), 0,
        ...
        addWidget(panel, new ScrollBarWidget("U/L balance", patch, 0, 100, -50,
                ...
                EditSender.getPatchSender(PATCH_U_L_BALANCE.getIntValue())), 0,
                GridBagConstraints.RELATIVE, GridBagConstraints.REMAINDER, 1, 0);
        ...
        addWidget(panel, new ScrollBarWidget("Split point", patch, 0, 61, 0,
                ...
                EditSender.getPatchSender(PATCH_SPLIT_POINT.getIntValue())), 1,
                GridBagConstraints.RELATIVE, GridBagConstraints.REMAINDER, 1, 0);
        addWidget(panel, new ComboBoxWidget("Reverb mode", patch,
                ...
                new String[] {
                        ...
                        "Tap delay 1", "Tap delay 2", "Tap delay 3", "Off" }),
        ...
        addWidget(panel, new ScrollBarWidget("Reverb time", patch, 0, 7, 1,
                ...
                EditSender.getPatchSender(PATCH_REVERB_TIME.getIntValue())), 0,
                GridBagConstraints.RELATIVE, GridBagConstraints.REMAINDER, 1, 0);
