...
public class VAmp2BankDriver extends AbstractBankDriver {
    ...
    public VAmp2BankDriver() {
        ...
        patchSize =
                Constants.PATCHES_PER_BANK * Constants.SINGLE_PATCH_SIZE
     ...
     * @param p
     *            The target bank patch containing the single patch whose name
     *            is to be retrieved.
     * @param patchNum
     *            The location within the bank of the single patch whose name is
     *            to be retrieved.
     ...
     *            to be changed.
     * @param name
     *            A String containing the getPatchFactory().createNewPatch name.
     */
    @Override
     ...
     * @param bankNum
     *            Parameter provided to match the method in the superclass.
     *            Values pased in this parameter are ignored.
     * @param patchNum
     *            Parameter provided to match the method in the superclass.
     *            Values pased in this parameter are ignored.
     */
