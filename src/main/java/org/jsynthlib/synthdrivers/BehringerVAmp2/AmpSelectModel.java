...
/**
 * Behringer VAmp2 Amp Select Model This class encapsulates the "Based on:" and
 * "Suggested Cabinet:" JLabels so that they update appropriately whenever the
 * user changes the selection in the Amp Model ComboBoxWidget.
 * @author Jeff Weber
 */
public class AmpSelectModel extends JPanel implements ActionListener {
    ...
    static final String[] AMP_DESC_STRING = {
            "Fender 4x10 Bassman", "Matchless Chieftan", "Fender Tweed Deluxe",
            "Roland JC-120", "Marshall JTM 45", "Vox AC 30 Top-Boost",
            "'59 Marshal Plexi 100 Watt", "Marshal JCM 800",
            "'94 Mesa Boogie Dual Rect. Trem-O-Verb", "Soldano",
            "'60's Dallas Arbiter Fuzz Face", "V-Amp Souped-Up Rectifier",
            "Mesa Boogie Mk III", "Smooth Crunch",
            "Roland JC-120 + Marshall Plexi", "Tube Preamp",
            "'60 Blackface Deluxe + '50s Bassman", "Budda Twinmaster",
            "'60 Tweed Champ", "'65 Blackface Twin",
            "'65 JTM 45 + Budda Twinmaster", "Vox AC 30 Non-Top-Boost",
            "Marhall Plexi 50 w/wide range", "Vox AC 15 Channel 1",
            "Mesa Boogie Dual Rectifier Head", "Engl Savage 120",
    ...
    static final String[] SUGG_CAB_STRING = {
            "4 x 10'' Vintage Bass", "2 x 12'' US Class A",
            "1 x 8'' Vintage Tweed", "2 x 12'' Twin Combo",
            "4 x 12'' Vintage 30", "2 x 12'' Brit '67", "4 x 12'' Vintage 30",
            "4 x 12'' Vintage 30", "4 x 12'' V-AMP Custom",
            "4 x 12'' V-AMP Custom", "4 x 12'' Off Axis",
            "4 x 12'' V-AMP Custom", "4 x 12'' V-AMP Custom",
            "4 x 12'' V-AMP Custom", "4 x 12'' V-AMP Custom", "No Cabinet",
            "4 x 10'' Vintage Bass", "2 x 12'' US Class A",
            "1 x 8'' Vintage Tweed", "2 x 12'' Twin Combo",
            "4 x 12'' Vintage 30", "2 x 12'' Brit '67",
            "4 x 12'' Standard '78", "1 x 12'' Brit '60",
            "4 x 12'' V-AMP Custom", "4 x 12'' Standard '78",
            "4 x 12'' V-AMP Custom", "4 x 12'' V-AMP Custom",
            "1 x 12'' Mid Combo", "1 x 12'' Blackface", "1 x 12'' Mid Combo",
            "1 x 12'' Blackface" };

    /**
     * JLabel which displays "Based on:" and a description of the currently
     * selected amp model.
     */
    private JLabel ampDesc;

    /**
     * JLabel which displays the suggested cabinet model for the currently
     * selected amp model.
     */
    ...
    AmpSelectModel(ComboBoxWidget ampSelectCB, JPanel parentPanel) {
        ...
        suggestedCab =
                newJLabel(
                        "Suggested Cabinet: "
                                + SUGG_CAB_STRING[ampSelectCB.getValue()],
                        parentPanel);
    }
