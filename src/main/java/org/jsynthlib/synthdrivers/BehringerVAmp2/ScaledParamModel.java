...
class ScaledParamModel extends ParamModel {
     ...
     * maximum CC value that will be sent by the control. int maxSysex is the
     * maximum sysex value represented the control in the sysex record.
     * @param p
     *            The patch to be edited.
     * @param o
     *            The offset into the patch to be edited.
     ...
     * non-nibblized bytes, not including the header bytes. int maxCC is the
     * maximum CC value that will be sent by the control. int maxSysex is the
     * maximum sysex value represented the control in the sysex record. boolean
     * reverse reverses the range of values sent by the sysexWidget over the
     * range 127 to 0. A value of true causes the range to be reversed.
     * @param p
     *            The patch to be edited.
     * @param o
     *            The offset into the patch to be edited.
     ...
     *            across the range of the parameter (eg. 127 to 0. A value of
     *            true indicates the values will be reversed.
     */
    ...
    public void set(int i) {
        ...
        patch.sysex[offset] = (byte) (i * maxSysex / maxCC);
    }
     ...
     */
    public int get() {
        int returnValue = (int) patch.sysex[offset] * maxCC / maxSysex;
        return returnValue;
    }
}