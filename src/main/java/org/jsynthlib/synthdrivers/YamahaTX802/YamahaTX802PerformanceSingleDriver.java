 ...
 * ========================================================
 * @version $Id: YamahaTX802PerformanceSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
import org.jsynthlib.synthdrivers.YamahaDX7.common.DX7FamilyPerformanceIIISingleDriver;

public class YamahaTX802PerformanceSingleDriver extends
        DX7FamilyPerformanceIIISingleDriver {
    public YamahaTX802PerformanceSingleDriver() {
        super(
                YamahaTX802PerformanceConstants.INIT_PERFORMANCE,
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        if (((YamahaTX802Device) getDevice()).getTipsMsgFlag() == 1)
            ...
            YamahaTX802Strings.dxShowInformation(toString(),
                    YamahaTX802Strings.STORE_SINGLE_PERFORMANCE_STRING);
    }
}
