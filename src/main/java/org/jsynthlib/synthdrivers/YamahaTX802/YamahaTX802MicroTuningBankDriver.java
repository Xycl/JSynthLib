 ...
 * =======================================================
 * @version $Id: YamahaTX802MicroTuningBankDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaTX802MicroTuningBankDriver extends
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        if ((((DX7FamilyDevice) (getDevice())).getTipsMsgFlag() & 0x01) == 1) {
            ...
            YamahaTX802Strings.dxShowInformation(toString(),
                    YamahaTX802Strings.MICRO_TUNING_CARTRIDGE_STRING);
        }
