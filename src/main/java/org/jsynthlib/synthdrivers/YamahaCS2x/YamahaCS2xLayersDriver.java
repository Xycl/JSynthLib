 ...
 */
public class YamahaCS2xLayersDriver extends AbstractPatchDriver {
    ...
    public YamahaCS2xLayersDriver() {
        ...
        sysexID = "F0430*63002D****00"; // : The hex header that sysex files of
        ...
        deviceIDoffset = 2;// was 0: The location of the deviceID in the sysex
                           // byte array (@@ or ## in SYS_REQ)
        /*
         * String Array holding names/numbers for all banks. Used for comboBox
         * selection.
         */
        bankNumbers = new String[] {
                "Current Performance", "Bank1", "Bank2" };
        patchNumbers = generateNumbers(1, 128, "Layers ##"); // :
                                                             // String
                                                             // Array
                                                             // holding
                                                             // names/numbers
                                                             ...
                                                             // comboBox
                                                             // selection.
        patchSize = 56 * 4; // : The size of the patch this Driver supports (or
                            // 0 for variable).
        patchNameSize = 0; // : Number of characters in the patch name. (0 if no
                           // name)
    ...
    // when a patch depends on multiple sysexmessages, this should be
    // overridden.
    ...
    public void sendPatch(Patch p) {
        ...
        for (i = 0; i < 4; i++) {
            ...
            calculateChecksum(cpLayer, 4, 53, 54);
            send(cpLayer);
            CS2x.sleep(); // wait at least 120 milliseconds .
        }
    }
