 ...
 * @author peter
 */
public class YamahaCS2xSystemDriver extends AbstractPatchDriver {
    ...
    public YamahaCS2xSystemDriver() {
        ...
        sysexID = "F0430*63001A500000"; // all sysex for this driver starts with
                                        // this.
        deviceIDoffset = 0;
    ...
    public void sendPatch(Patch p) {
        int dvic = 0x00 + getDeviceID(); // getdeviceID() returns value 1~16 =
                                         // global channel of device
