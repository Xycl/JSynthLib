 ...
 */
public class YamahaCS2xLayerDriver extends AbstractPatchDriver {
    ...
    public YamahaCS2xLayerDriver() {
        ...
        sysexID = "F043**63002D****00"; // all sysex for this driver starts with
                                        // this.
        deviceIDoffset = 2;
        ...
        // voice banks
      voiceBanks = generateNumbers(0, 20, "Pre##");
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        calculateChecksum(sysex, 4, 53, 54);
        send(sysex);
    }
    ...
    public JSLFrame editPatch(Patch p) {
        return new YamahaCS2xLayerEditor((Patch) p, voiceBanks);
    }
    // */
}
