...
public class YamahaCS2xDevice extends Device {
    private static final String infoText =
            "Driver for Yamaha CS2x, see http://cs2x.wikispaces.com";

    /** Constructor for DeviceListWriter. */
    public YamahaCS2xDevice() {
        super("Yamaha", "CS2x", "F07E7F06024300414F0300000001F7", infoText,
                "Peter Geirnaert");
    }

    /**
     * Constructor for actual work to be done.<br>
     * Creates a new <code>YamahaCS2xDevice</code> instance.
     * <p>
     * Put here what to do : load the preferences, set deviceID and channel and
     * add the drivers
     **/
    public void setup(Preferences prefs) {
        ...
        YamahaCS2xPerformanceDriver CS2xPerformanceDriver =
                new YamahaCS2xPerformanceDriver(CS2xCommonDriver,
                        CS2xLayersDriver);
        addDriver(CS2xPerformanceDriver);
        addDriver(new YamahaCS2xSystemDriver()); // uncomment when you want to
                                                 // start testing the driver!
        // addDriver(new YamahaCS2xBankDriver(CS2xCommonDriver,
        // CS2xLayersDriver));
