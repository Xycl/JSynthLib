...
/* Made by Yves Lefebvre
 ...
 @version $Id: CasioCZ1000SingleDriver.java 1010 2005-04-01 02:41:15Z billzwicky $
 */
...
public class CasioCZ1000SingleDriver extends AbstractPatchDriver {
    ...
    private final String[] BANK_NAMES = {
            "Internal", "Cartridge", "Preset" };
    private final int[] BANK_NUMS = {
            0x20, 0x40, 0x00 };
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        newsysex[4] = (byte) (0x70 + getChannel() - 1); // must do it ourselve
                                                        // since sendPatchWorker
                                                        // didn't support
