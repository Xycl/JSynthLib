...
/* Made by Yves Lefebvre
 ...
 @version $Id: CasioCZ1000BankDriver.java 1001 2005-03-20 07:07:38Z billzwicky $
 */
...
public class CasioCZ1000BankDriver extends AbstractBankDriver {
    ...
    public void putPatch(Patch bank, Patch p, int patchNum) {
        ...
        System.arraycopy(p.sysex, 7, bank.sysex,
                getPatchStart(patchNum), 264 - 7);
    ...
    public void storePatch(Patch bank, int bankNum, int patchNum) {
        ...
        Patch p = getPatchFactory().createNewPatch(newsysex, getDevice());
        try {
            for (int i = 0; i < 16; i++) {
