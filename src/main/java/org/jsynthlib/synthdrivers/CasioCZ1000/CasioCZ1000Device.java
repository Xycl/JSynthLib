...
/**
 * Single patch driver for Casio CZ-101 and CZ-1000. Note : on the casio, if you
 * initiate a dump (from the PC or the Casio itself), you will get a patch of
 * 263 bytes. you CAN'T send that patch back to the Casio... The patch must be
 * 264 bytes long. supportsPatch and createPatch fix up short patches.
 * @author Brian Klock
 * @author Yves Lefebvre
 * @author Bill Zwicky
 * @version $Id: CasioCZ1000Device.java 1001 2005-03-20 07:07:38Z billzwicky $
 */
public class CasioCZ1000Device extends Device {
    ...
    public CasioCZ1000Device() {
        super("Casio", "CZ-101/1000", null, INFO_TEXT,
    ...
    public JPanel config() {
        ...
        final ComboBoxWidget guiMode =
                new ComboBoxWidget("GUI Style", null, null, null, GUI_OPTIONS);
        ...
        ComboBoxWidget paramMode =
                new ComboBoxWidget("Parameter Set", null, null, null,
                        PARAM_OPTIONS);
        paramMode.setValue("Extended".equals(prefs.get("paramMode", null)) ? 1
                : 0);
