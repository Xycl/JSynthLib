...
public class NovationNova1SinglePerformanceDriver extends AbstractBankDriver {
     ...
     * newsysex2 = new byte[406]; Patch perf = getPatchFactory().createNewPatch(newsysex2);
