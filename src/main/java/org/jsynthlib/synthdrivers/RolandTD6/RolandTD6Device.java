...
/**
 * RolandTD6Device.java Device class for Roland TD6 Percussion Module.
 * @author <a href="mailto:hiroo.hayashi@computer.org">Hiroo Hayashi</a>
 * @version $Id: RolandTD6Device.java 646 2004-07-30 16:57:44Z ribrdb $
 */
public final class RolandTD6Device extends Device {
    ...
    PadInfo[] activePadInfo() {
        ...
        for (int i = 0; i < padinfo.length; i++) {
            ...
            if (p.getBoolean("padActive", padinfo[i].padActive)) {
                ...
                d.padActive = true;
                d.dualTriggerActive =
                        p.getBoolean("dualTriggerActive",
                                padinfo[i].dualTriggerActive);
                activePad[n++] = d;
            }
        }
    ...
    /*
     * // config variable getter public String getPadName(int i) { return
     * this.padinfo[i].name; }; public boolean getPadEnableFlag(int i) { return
     * this.padinfo[i].enable; }; public boolean getDualTriggerFlag(int i) {
     * return this.padinfo[i].dualTrigger; }; // config variable setter public
     * void setPadEnableFlag(int i, boolean val) { this.padinfo[i].enable = val;
