 ...
 * @version $Id: TD6BankDriver.java 907 2005-02-09 06:32:08Z hayashi $
 */
public class TD6BankDriver extends AbstractBankDriver {
    ...
    public TD6BankDriver(TD6SingleDriver singleDriver) {
        super("Bank", "Hiroo Hayashi <hiroo.hayashi@computer.org>", NUM_PATCH,
                NUM_COLUMNS);
    ...
    /**
     * Return the offset address of SysEX message (packet) specified by
     * <code>pkt</code>.
     * @param patchNum
     *            patch number
     * @param pkt
     *            specifies the SysEX message
    ...
    public void putPatch(Patch bank, Patch p, int patchNum) {
        System.arraycopy(p.sysex, 0, bank.sysex, SINGLE_SIZE * patchNum,
                SINGLE_SIZE);
    ...
    public Patch getPatch(Patch bank, int patchNum) {
        ...
        System.arraycopy(bank.sysex, getPktOfst(patchNum, 0), sysex, 0,
                SINGLE_SIZE);
