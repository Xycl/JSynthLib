 ...
 * =============================================================
 * @version $Id: DX7FamilyDevice.java 646 2004-07-30 16:57:44Z ribrdb $
...
public abstract class DX7FamilyDevice extends Device {
    ...
    public DX7FamilyDevice(String manufacturerName, String modelName,
            String inquiryID, String infoText, String authors, int sPBPFlag,
            int swOffMemProtFlag, int tipsMsgFlag) {
        super(manufacturerName, modelName, inquiryID, infoText, authors);
    ...
    public JPanel config() {
        ...
        /*
         * c.gridx=0;c.gridy=1;c.gridwidth=3;c.gridheight=2; panel.add(new
         * JLabel("Synthesizer Name"),c); final JTextField sl = new
         * JTextField(getSynthName()); sl.addActionListener(new ActionListener()
         * { public void actionPerformed(ActionEvent e) {
         * setSynthName(sl.getText()); } });
         * c.gridx=3;c.gridy=1;c.gridwidth=3;c.gridheight=2; panel.add(sl,c);
         * c.gridx=4;c.gridy=1;c.gridwidth=3;c.gridheight=1; panel.add(new
         * JLabel(" ( free choosable )"),c);
         */
        ...
        sPBP.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (chb.isSelected()) {
                    setSPBPflag(getSPBPflag() | 0x01);
                } else {
                    setSPBPflag(getSPBPflag() & 0xfe);
                }
            }
        });
        c.gridx = 3;
        ...
        swOffMemProt.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JCheckBox chb = (JCheckBox) e.getSource();
                if (chb.isSelected()) {
                    setSwOffMemProtFlag(getSwOffMemProtFlag() | 0x01);
                } else {
                    setSwOffMemProtFlag(getSwOffMemProtFlag() & 0xfe);
                }
            }
        });
        c.gridx = 3;
        ...
        tipsMsg.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JCheckBox chb = (JCheckBox) e.getSource();
                if (chb.isSelected()) {
                    setTipsMsgFlag(getTipsMsgFlag() | 0x01);
                } else {
                    setTipsMsgFlag(getTipsMsgFlag() & 0xfe);
                }
            }
        });
        c.gridx = 3;
