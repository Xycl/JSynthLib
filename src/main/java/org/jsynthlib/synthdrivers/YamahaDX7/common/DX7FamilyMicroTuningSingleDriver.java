 ...
 * =======================================================================
 * @version $Id: DX7FamilyMicroTuningSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class DX7FamilyMicroTuningSingleDriver extends AbstractPatchDriver {
    byte[] initSysex;
    ...
    public DX7FamilyMicroTuningSingleDriver(byte[] initSysex,
    ...
    public JSLFrame editPatch(Patch p) {
        return new DX7FamilyMicroTuningEditor(getManufacturerName() + " "
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        // Is it necessary to switch off Memory Protection for edit buffer
        // and/or User 1,2?
