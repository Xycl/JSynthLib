 ...
 *		(used by DX7-II, DX7s)
 * ===================================================================
 * @version $Id: DX7FamilySystemSetupIIDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class DX7FamilySystemSetupIIDriver extends AbstractPatchDriver {
    byte[] initSysex;
    String[] dxPatchNumbers;
    String[] dxBankNumbers;

    public DX7FamilySystemSetupIIDriver(byte[] initSysex,
        ...
        numSysexMsgs = 1;
        sysexRequestDump =
                new SysexHandler("f0 43 @@ 7e 4c 4d 20 20 38 39 37 33 53 20 f7");
    }
    ...
    public JSLFrame editPatch(Patch p) {
        return new DX7FamilySystemSetupIIEditor(getManufacturerName() + " "
