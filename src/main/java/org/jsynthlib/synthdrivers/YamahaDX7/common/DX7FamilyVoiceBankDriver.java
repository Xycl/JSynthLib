...
public class DX7FamilyVoiceBankDriver extends AbstractBankDriver {
    byte[] initSysex;
                                                    ...
                                                    // needed
    {
        try {
            ...
            // ***** OPERATOR 6 *****
            sysex[6 + 0] =
                    ((bank.sysex[getPatchStart(patchNum) + 0])); // EG
                                                                                  // Rate
                                                                                  // 1
                                                                                  // .................(0-99)
            sysex[6 + 1] =
                    ((bank.sysex[getPatchStart(patchNum) + 1])); // EG
                                                                                  // Rate
                                                                                  // 2
                                                                                  // .................(0-99)
            sysex[6 + 2] =
                    ((bank.sysex[getPatchStart(patchNum) + 2])); // EG
                                                                                  // Rate
                                                                                  // 3
                                                                                  // .................(0-99)
            sysex[6 + 3] =
                    ((bank.sysex[getPatchStart(patchNum) + 3])); // EG
                                                                                  // Rate
                                                                                  // 4
                                                                                  // .................(0-99)
            sysex[6 + 4] =
                    ((bank.sysex[getPatchStart(patchNum) + 4])); // EG
                                                                                  // Level
                                                                                  // 1
                                                                                  // .................(0-99)
            sysex[6 + 5] =
                    ((bank.sysex[getPatchStart(patchNum) + 5])); // EG
                                                                                  // Level
                                                                                  // 2
                                                                                  // .................(0-99)
            sysex[6 + 6] =
                    ((bank.sysex[getPatchStart(patchNum) + 6])); // EG
                                                                                  // Level
                                                                                  // 3
                                                                                  // .................(0-99)
            sysex[6 + 7] =
                    ((bank.sysex[getPatchStart(patchNum) + 7])); // EG
                                                                                  // Level
                                                                                  // 4
                                                                                  // .................(0-99)
            sysex[6 + 8] =
                    ((bank.sysex[getPatchStart(patchNum) + 8])); // Kbd
                                                                                  // Level
                                                                                  // Scale
                                                                                  // Break
                                                                                  // Point
                                                                                  // (0-99)
            sysex[6 + 9] =
                    ((bank.sysex[getPatchStart(patchNum) + 9])); // Kbd
                                                                                  // Level
                                                                                  // Scale
                                                                                  // Left
                                                                                  // Depth
                                                                                  // .(0-99)
            sysex[6 + 10] =
                    ((bank.sysex[getPatchStart(patchNum) + 10])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Right
                                                                                   // Depth
            ...
            sysex[6 + 15] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 13] & 28) / 4); // Key
                                                                                            ...
                                                                                            // ....(0-7)
            sysex[6 + 16] =
                    ((bank.sysex[getPatchStart(patchNum) + 14])); // Operator
                                                                                   // Output
                                                                                   // Level
                                                                                   // ......(0-99)
            sysex[6 + 17] =
            ...
            sysex[6 + 18] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 15] & 62) / 2); // Osc
                                                                                            ...
                                                                                            // .......(0-31)
            sysex[6 + 19] =
                    ((bank.sysex[getPatchStart(patchNum) + 16])); // Osc
                                                                                   // Frequency
                                                                                   // Fine
                                                                                   // .........(0-99)
            sysex[6 + 20] =
            ...
            // ***** OPERATOR 5 *****
            sysex[6 + 21] =
                    ((bank.sysex[getPatchStart(patchNum) + 17])); // EG
                                                                                   // Rate
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 22] =
                    ((bank.sysex[getPatchStart(patchNum) + 18])); // EG
                                                                                   // Rate
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 23] =
                    ((bank.sysex[getPatchStart(patchNum) + 19])); // EG
                                                                                   // Rate
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 24] =
                    ((bank.sysex[getPatchStart(patchNum) + 20])); // EG
                                                                                   // Rate
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 25] =
                    ((bank.sysex[getPatchStart(patchNum) + 21])); // EG
                                                                                   // Level
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 26] =
                    ((bank.sysex[getPatchStart(patchNum) + 22])); // EG
                                                                                   // Level
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 27] =
                    ((bank.sysex[getPatchStart(patchNum) + 23])); // EG
                                                                                   // Level
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 28] =
                    ((bank.sysex[getPatchStart(patchNum) + 24])); // EG
                                                                                   // Level
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 29] =
                    ((bank.sysex[getPatchStart(patchNum) + 25])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Break
                                                                                   // Point
                                                                                   // (0-99)
            sysex[6 + 30] =
                    ((bank.sysex[getPatchStart(patchNum) + 26])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Left
                                                                                   // Depth
                                                                                   // .(0-99)
            sysex[6 + 31] =
                    ((bank.sysex[getPatchStart(patchNum) + 27])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Right
                                                                                   // Depth
            ...
            sysex[6 + 36] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 30] & 28) / 4); // Key
                                                                                            ...
                                                                                            // ....(0-7)
            sysex[6 + 37] =
                    ((bank.sysex[getPatchStart(patchNum) + 31])); // Operator
                                                                                   // Output
                                                                                   // Level
                                                                                   // ......(0-99)
            sysex[6 + 38] =
            ...
            sysex[6 + 39] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 32] & 62) / 2); // Osc
                                                                                            ...
                                                                                            // .......(0-31)
            sysex[6 + 40] =
                    ((bank.sysex[getPatchStart(patchNum) + 33])); // Osc
                                                                                   // Frequency
                                                                                   // Fine
                                                                                   // .........(0-99)
            sysex[6 + 41] =
            ...
            // ***** OPERATOR 4 *****
            sysex[6 + 42] =
                    ((bank.sysex[getPatchStart(patchNum) + 34])); // EG
                                                                                   // Rate
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 43] =
                    ((bank.sysex[getPatchStart(patchNum) + 35])); // EG
                                                                                   // Rate
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 44] =
                    ((bank.sysex[getPatchStart(patchNum) + 36])); // EG
                                                                                   // Rate
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 45] =
                    ((bank.sysex[getPatchStart(patchNum) + 37])); // EG
                                                                                   // Rate
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 46] =
                    ((bank.sysex[getPatchStart(patchNum) + 38])); // EG
                                                                                   // Level
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 47] =
                    ((bank.sysex[getPatchStart(patchNum) + 39])); // EG
                                                                                   // Level
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 48] =
                    ((bank.sysex[getPatchStart(patchNum) + 40])); // EG
                                                                                   // Level
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 49] =
                    ((bank.sysex[getPatchStart(patchNum) + 41])); // EG
                                                                                   // Level
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 50] =
                    ((bank.sysex[getPatchStart(patchNum) + 42])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Break
                                                                                   // Point
                                                                                   // (0-99)
            sysex[6 + 51] =
                    ((bank.sysex[getPatchStart(patchNum) + 43])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Left
                                                                                   // Depth
                                                                                   // .(0-99)
            sysex[6 + 52] =
                    ((bank.sysex[getPatchStart(patchNum) + 44])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Right
                                                                                   // Depth
            ...
            sysex[6 + 57] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 47] & 28) / 4); // Key
                                                                                            ...
                                                                                            // ....(0-7)
            sysex[6 + 58] =
                    ((bank.sysex[getPatchStart(patchNum) + 48])); // Operator
                                                                                   // Output
                                                                                   // Level
                                                                                   // ......(0-99)
            sysex[6 + 59] =
            ...
            sysex[6 + 60] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 49] & 62) / 2); // Osc
                                                                                            ...
                                                                                            // .......(0-31)
            sysex[6 + 61] =
                    ((bank.sysex[getPatchStart(patchNum) + 50])); // Osc
                                                                                   // Frequency
                                                                                   // Fine
                                                                                   // .........(0-99)
            sysex[6 + 62] =
            ...
            // ***** OPERATOR 3 *****
            sysex[6 + 63] =
                    ((bank.sysex[getPatchStart(patchNum) + 51])); // EG
                                                                                   // Rate
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 64] =
                    ((bank.sysex[getPatchStart(patchNum) + 52])); // EG
                                                                                   // Rate
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 65] =
                    ((bank.sysex[getPatchStart(patchNum) + 53])); // EG
                                                                                   // Rate
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 66] =
                    ((bank.sysex[getPatchStart(patchNum) + 54])); // EG
                                                                                   // Rate
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 67] =
                    ((bank.sysex[getPatchStart(patchNum) + 55])); // EG
                                                                                   // Level
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 68] =
                    ((bank.sysex[getPatchStart(patchNum) + 56])); // EG
                                                                                   // Level
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 69] =
                    ((bank.sysex[getPatchStart(patchNum) + 57])); // EG
                                                                                   // Level
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 70] =
                    ((bank.sysex[getPatchStart(patchNum) + 58])); // EG
                                                                                   // Level
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 71] =
                    ((bank.sysex[getPatchStart(patchNum) + 59])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Break
                                                                                   // Point
                                                                                   // (0-99)
            sysex[6 + 72] =
                    ((bank.sysex[getPatchStart(patchNum) + 60])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Left
                                                                                   // Depth
                                                                                   // .(0-99)
            sysex[6 + 73] =
                    ((bank.sysex[getPatchStart(patchNum) + 61])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Right
                                                                                   // Depth
            ...
            sysex[6 + 78] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 64] & 28) / 4); // Key
                                                                                            ...
                                                                                            // ....(0-7)
            sysex[6 + 79] =
                    ((bank.sysex[getPatchStart(patchNum) + 65])); // Operator
                                                                                   // Output
                                                                                   // Level
                                                                                   // ......(0-99)
            sysex[6 + 80] =
            ...
            sysex[6 + 81] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 66] & 62) / 2); // Osc
                                                                                            ...
                                                                                            // .......(0-31)
            sysex[6 + 82] =
                    ((bank.sysex[getPatchStart(patchNum) + 67])); // Osc
                                                                                   // Frequency
                                                                                   // Fine
                                                                                   // .........(0-99)
            sysex[6 + 83] =
            ...
            // ***** OPERATOR 2 *****
            sysex[6 + 84] =
                    ((bank.sysex[getPatchStart(patchNum) + 68])); // EG
                                                                                   // Rate
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 85] =
                    ((bank.sysex[getPatchStart(patchNum) + 69])); // EG
                                                                                   // Rate
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 86] =
                    ((bank.sysex[getPatchStart(patchNum) + 70])); // EG
                                                                                   // Rate
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 87] =
                    ((bank.sysex[getPatchStart(patchNum) + 71])); // EG
                                                                                   // Rate
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 88] =
                    ((bank.sysex[getPatchStart(patchNum) + 72])); // EG
                                                                                   // Level
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 89] =
                    ((bank.sysex[getPatchStart(patchNum) + 73])); // EG
                                                                                   // Level
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 90] =
                    ((bank.sysex[getPatchStart(patchNum) + 74])); // EG
                                                                                   // Level
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 91] =
                    ((bank.sysex[getPatchStart(patchNum) + 75])); // EG
                                                                                   // Level
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 92] =
                    ((bank.sysex[getPatchStart(patchNum) + 76])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Break
                                                                                   // Point
                                                                                   // (0-99)
            sysex[6 + 93] =
                    ((bank.sysex[getPatchStart(patchNum) + 77])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Left
                                                                                   // Depth
                                                                                   // .(0-99)
            sysex[6 + 94] =
                    ((bank.sysex[getPatchStart(patchNum) + 78])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Right
                                                                                   // Depth
            ...
            sysex[6 + 99] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 81] & 28) / 4); // Key
                                                                                            ...
                                                                                            // ....(0-7)
            sysex[6 + 100] =
                    ((bank.sysex[getPatchStart(patchNum) + 82])); // Operator
                                                                                   // Output
                                                                                   // Level
                                                                                   // ......(0-99)
            sysex[6 + 101] =
            ...
            sysex[6 + 102] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 83] & 62) / 2); // Osc
                                                                                            ...
                                                                                            // .......(0-31)
            sysex[6 + 103] =
                    ((bank.sysex[getPatchStart(patchNum) + 84])); // Osc
                                                                                   // Frequency
                                                                                   // Fine
                                                                                   // .........(0-99)
            sysex[6 + 104] =
            ...
            // ***** OPERATOR 1 *****
            sysex[6 + 105] =
                    ((bank.sysex[getPatchStart(patchNum) + 85])); // EG
                                                                                   // Rate
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 106] =
                    ((bank.sysex[getPatchStart(patchNum) + 86])); // EG
                                                                                   // Rate
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 107] =
                    ((bank.sysex[getPatchStart(patchNum) + 87])); // EG
                                                                                   // Rate
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 108] =
                    ((bank.sysex[getPatchStart(patchNum) + 88])); // EG
                                                                                   // Rate
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 109] =
                    ((bank.sysex[getPatchStart(patchNum) + 89])); // EG
                                                                                   // Level
                                                                                   // 1
                                                                                   // .................(0-99)
            sysex[6 + 110] =
                    ((bank.sysex[getPatchStart(patchNum) + 90])); // EG
                                                                                   // Level
                                                                                   // 2
                                                                                   // .................(0-99)
            sysex[6 + 111] =
                    ((bank.sysex[getPatchStart(patchNum) + 91])); // EG
                                                                                   // Level
                                                                                   // 3
                                                                                   // .................(0-99)
            sysex[6 + 112] =
                    ((bank.sysex[getPatchStart(patchNum) + 92])); // EG
                                                                                   // Level
                                                                                   // 4
                                                                                   // .................(0-99)
            sysex[6 + 113] =
                    ((bank.sysex[getPatchStart(patchNum) + 93])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Break
                                                                                   // Point
                                                                                   // (0-99)
            sysex[6 + 114] =
                    ((bank.sysex[getPatchStart(patchNum) + 94])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Left
                                                                                   // Depth
                                                                                   // .(0-99)
            sysex[6 + 115] =
                    ((bank.sysex[getPatchStart(patchNum) + 95])); // Kbd
                                                                                   // Level
                                                                                   // Scale
                                                                                   // Right
                                                                                   // Depth
            ...
            sysex[6 + 120] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 98] & 28) / 4); // Key
                                                                                            ...
                                                                                            // ....(0-7)
            sysex[6 + 121] =
                    ((bank.sysex[getPatchStart(patchNum) + 99])); // Operator
                                                                                   // Output
                                                                                   // Level
                                                                                   // ......(0-99)
            sysex[6 + 122] =
            ...
            sysex[6 + 123] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 100] & 62) / 2); // Osc
                                                                                             ...
                                                                                             // .......(0-31)
            sysex[6 + 124] =
                    ((bank.sysex[getPatchStart(patchNum) + 101])); // Osc
                                                                                    // Frequency
                                                                                    // Fine
                                                                                    // .........(0-99)
            sysex[6 + 125] =
            ...
            // ***** other Parameters *****
            sysex[6 + 126] =
                    ((bank.sysex[getPatchStart(patchNum) + 102])); // Pitch
                                                                                    // EG
                                                                                    // Rate
                                                                                    // 1
                                                                                    // ............(0-99)
            sysex[6 + 127] =
                    ((bank.sysex[getPatchStart(patchNum) + 103])); // Pitch
                                                                                    // EG
                                                                                    // Rate
                                                                                    // 2
                                                                                    // ............(0-99)
            sysex[6 + 128] =
                    ((bank.sysex[getPatchStart(patchNum) + 104])); // Pitch
                                                                                    // EG
                                                                                    // Rate
                                                                                    // 3
                                                                                    // ............(0-99)
            sysex[6 + 129] =
                    ((bank.sysex[getPatchStart(patchNum) + 105])); // Pitch
                                                                                    // EG
                                                                                    // Rate
                                                                                    // 4
                                                                                    // ............(0-99)
            sysex[6 + 130] =
                    ((bank.sysex[getPatchStart(patchNum) + 106])); // Pitch
                                                                                    // EG
                                                                                    // Level
                                                                                    // 1
                                                                                    // ...........(0-99)
            sysex[6 + 131] =
                    ((bank.sysex[getPatchStart(patchNum) + 107])); // Pitch
                                                                                    // EG
                                                                                    // Level
                                                                                    // 2
                                                                                    // ...........(0-99)
            sysex[6 + 132] =
                    ((bank.sysex[getPatchStart(patchNum) + 108])); // Pitch
                                                                                    // EG
                                                                                    // Level
                                                                                    // 3
                                                                                    // ...........(0-99)
            sysex[6 + 133] =
                    ((bank.sysex[getPatchStart(patchNum) + 109])); // Pitch
                                                                                    // EG
                                                                                    // Level
                                                                                    // 4
                                                                                    // ...........(0-99)
            ...
            sysex[6 + 136] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 111] & 8) / 8); // Oscillator
                                                                                            ...
                                                                                            // .............(0-1)
            sysex[6 + 137] =
                    ((bank.sysex[getPatchStart(patchNum) + 112])); // LFO
                                                                                    // Speed
                                                                                    // ..................(0-99)
            sysex[6 + 138] =
                    ((bank.sysex[getPatchStart(patchNum) + 113])); // LFO
                                                                                    // Delay
                                                                                    // ..................(0-99)
            sysex[6 + 139] =
                    ((bank.sysex[getPatchStart(patchNum) + 114])); // LFO
                                                                                    // PMD
                                                                                    // ....................(0-99)
            sysex[6 + 140] =
                    ((bank.sysex[getPatchStart(patchNum) + 115])); // LFO
                                                                                    // AMD
                                                                                    // ....................(0-99)
            sysex[6 + 141] =
            ...
            sysex[6 + 143] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 116] & 112) / 16); // LFO
                                                                                               ...
                                                                                               // ...(0-7)
            sysex[6 + 144] =
                    ((bank.sysex[getPatchStart(patchNum) + 117])); // Transpose
                                                                                    // .................
                                                                                    // (0-48)
            sysex[6 + 145] =
                    ((bank.sysex[getPatchStart(patchNum) + 118])); // Voice
                                                                                    // name
                                                                                    // 1
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 146] =
                    ((bank.sysex[getPatchStart(patchNum) + 119])); // Voice
                                                                                    // name
                                                                                    // 2
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 147] =
                    ((bank.sysex[getPatchStart(patchNum) + 120])); // Voice
                                                                                    // name
                                                                                    // 3
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 148] =
                    ((bank.sysex[getPatchStart(patchNum) + 121])); // Voice
                                                                                    // name
                                                                                    // 4
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 149] =
                    ((bank.sysex[getPatchStart(patchNum) + 122])); // Voice
                                                                                    // name
                                                                                    // 5
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 150] =
                    ((bank.sysex[getPatchStart(patchNum) + 123])); // Voice
                                                                                    // name
                                                                                    // 6
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 151] =
                    ((bank.sysex[getPatchStart(patchNum) + 124])); // Voice
                                                                                    // name
                                                                                    // 7
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 152] =
                    ((bank.sysex[getPatchStart(patchNum) + 125])); // Voice
                                                                                    // name
                                                                                    // 8
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 153] =
                    ((bank.sysex[getPatchStart(patchNum) + 126])); // Voice
                                                                                    // name
                                                                                    // 9
                                                                                    // ..............
                                                                                    // ASCII
            sysex[6 + 154] =
                    ((bank.sysex[getPatchStart(patchNum) + 127])); // Voice
                                                                                    // name
                                                                                    // 10
                                                                                    // ..............
                                                                                    // ASCII
    ...
    @Override
    public BankPatch createNewPatch() // create a bank with 32 "init voice"-patches
    {
