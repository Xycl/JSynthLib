 ...
 * ============================================================================
 * @version $Id: DX7FamilyAdditionalVoiceSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class DX7FamilyAdditionalVoiceSingleDriver extends AbstractPatchDriver {
    byte[] initSysex;
    String[] dxPatchNumbers;
    String[] dxBankNumbers;

    public DX7FamilyAdditionalVoiceSingleDriver(byte[] initSysex,
    ...
    public JSLFrame editPatch(Patch p) {
        return new DX7FamilyAdditionalVoiceEditor(getManufacturerName() + " "
