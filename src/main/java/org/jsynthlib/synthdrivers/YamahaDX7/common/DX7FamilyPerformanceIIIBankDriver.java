...
public class DX7FamilyPerformanceIIIBankDriver extends AbstractBankDriver {
    byte[] initSysex;
            ...
            for (int i = 0; i < b.length; i++) {
                b[i] =
                        (byte) (DX7FamilyByteEncoding
                                .AsciiHex2Value(p.sysex[patchNameStart
    ...
    public void setPatchName(Patch p, int patchNum, String name) {
        ...
        try {
            ...
            for (int i = 0; i < dxPatchNameSize; i++) {
                p.sysex[patchNameStart + (2 * i)] =
                        (byte) (DX7FamilyByteEncoding
                                .Value2AsciiHexHigh(namebytes[i]));
                p.sysex[patchNameStart + (2 * i) + 1] =
                        (byte) (DX7FamilyByteEncoding
                                                             ...
                                                             // needed
    {
        ...
        bank.sysex[getPatchStart(patchNum) + 0] = (byte) (0x01); // Byte
                                                                           // Count
                                                                           // MSB
        bank.sysex[getPatchStart(patchNum) + 1] = (byte) (0x28); // Byte
                                                                           // Count
                                                                           // LSB
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - Voice Channel Offset (0-7) |
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 0)
                    + (2 * i)] =
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - Voice Number (0-255)
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 8)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 8)
                    + (2 * i) + 1] =
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - Micro Tuning Table # (0-254)
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 16)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 16)
                    + (2 * i) + 1] =
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - Output Volume (0-99)
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 24)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 24)
                    + (2 * i) + 1] =
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - Detune (0-14) | Key Assign
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 32)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 32)
                    + (2 * i) + 1] =
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - Note Limit Low (0-127)
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 40)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 40)
                    + (2 * i) + 1] =
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - Note Limit High (0-127)
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 48)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 48)
                    + (2 * i) + 1] =
        ...
        for (int i = 0; i < 8; i++) { // TG1-8 - EG forced Damp (0-1) | Note
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 56)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 56)
                    + (2 * i) + 1] =
        ...
        for (int i = 0; i < 20; i++) { // Performance Name (ASCII)
            ...
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 64)
                    + (2 * i)] =
                    (byte) (DX7FamilyByteEncoding.Value2AsciiHexHigh(value));
            bank.sysex[getPatchStart(patchNum) + 12 + (2 * 64)
                    + (2 * i) + 1] =
    ...
    @Override
    public BankPatch createNewPatch() // create a bank with 64 performance patches
    {
