...
public class DX7FamilyPerformanceBankDriver extends AbstractBankDriver {
    byte[] initSysex;
                                                    ...
                                                    // needed
    {
        try {
            ...
            sysex[6 + 0] = (byte) (0); // UNDOCUMENTED! matching voice#
                                       // ...(0-63) - fixed to 0!
            sysex[6 + 1] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 3] & 120) / 8); // Source
                                                                                            // Select
                                                                                            // ...................(0-15)
            sysex[6 + 2] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 0] & 64) / 64); // Poly/Mono
                                                                                            // .......................(0-
                                                                                            // 1)
            sysex[6 + 3] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 1] & 15)); // Pitch
                                                                                       // Bend
                                                                                       // Range
                                                                                       // ................(0-12)
            sysex[6 + 4] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 1] & 112) / 16 // Pitch
                                                                                           // Bend
                                                                                           // Step
                                                                                           // (Low)
                                                                                           // ...........(0-12)
                    + (bank.sysex[getPatchStart(patchNum) + 15] & 64) / 8); // Pitch
                                                                                      // Bend
                                                                                      // Step
                                                                                      // (High)
                                                                                      // ..........(0-12)
            sysex[6 + 5] =
                    ((bank.sysex[getPatchStart(patchNum) + 2])); // Portamento
                                                                                  // Time
                                                                                  // .................(0-99)
            sysex[6 + 6] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 3] & 1)); // Portamento/Glissando
                                                                                      ...
                                                                                      // 1)
            sysex[6 + 7] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 3] & 2) / 2); // Portamento
                                                                                          // Mode
                                                                                          // .................(0-
                                                                                          // 1)
            sysex[6 + 8] =
            ...
            sysex[6 + 13] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 6] & 15)); // After
                                                                                       ...
                                                                                       // .........(0-15)
            sysex[6 + 14] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 6] & 112) / 16); // After
                                                                                             // Touch
                                                                                             // Assign
                                                                                             // ..............(0-
                                                                                             // 7)
            ...
            sysex[6 + 30] = (byte) (0); // UNDOCUMENTED! matching voice#
                                        // ...(0-63) - fixed to 0!
            sysex[6 + 31] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 19] & 120) / 8); // Source
                                                                                             // Select
                                                                                             // ...................(0-15)
            sysex[6 + 32] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 16] & 64) / 64); // Poly/Mono
                                                                                             // .......................(0-
                                                                                             // 1)
            sysex[6 + 33] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 17] & 15)); // Pitch
                                                                                        // Bend
                                                                                        // Range
                                                                                        // ................(0-12)
            sysex[6 + 34] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 17] & 112) / 16 // Pitch
                                                                                            // Bend
                                                                                            // Step
                                                                                            // (Low)
                                                                                            // ...........(0-12)
                    + (bank.sysex[getPatchStart(patchNum) + 31] & 64) / 8); // Pitch
                                                                                      // Bend
                                                                                      // Step
                                                                                      // (High)
                                                                                      // ..........(0-12)
            sysex[6 + 35] =
                    ((bank.sysex[getPatchStart(patchNum) + 18])); // Portamento
                                                                                   // Time
                                                                                   // .................(0-99)
            sysex[6 + 36] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 19] & 1)); // Portamento/Glissando
                                                                                       ...
                                                                                       // 1)
            sysex[6 + 37] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 19] & 2) / 2); // Portamento
                                                                                           // Mode
                                                                                           // .................(0-
                                                                                           // 1)
            sysex[6 + 38] =
            ...
            sysex[6 + 43] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 22] & 15)); // After
                                                                                        ...
                                                                                        // .........(0-15)
            sysex[6 + 44] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 22] & 112) / 16); // After
                                                                                              // Touch
                                                                                              // Assign
                                                                                              // ..............(0-
                                                                                              // 7)
            ...
            sysex[6 + 62] =
                    (byte) ((bank.sysex[getPatchStart(patchNum) + 32] & 120) / 8); // Dual
                                                                                             ...
                                                                                             // ................(0-15)
            sysex[6 + 63] =
                    ((bank.sysex[getPatchStart(patchNum) + 33])); // Split
                                                                                   // Point
                                                                                   // .....................(0-99)
            sysex[6 + 64] =
                    ((bank.sysex[getPatchStart(patchNum) + 34])); // Performance
                                                                                   // name
                                                                                   // 1
                                                                                   // ..............ASCII
            sysex[6 + 65] =
                    ((bank.sysex[getPatchStart(patchNum) + 35])); // Performance
                                                                                   // name
                                                                                   // 2
                                                                                   // ..............ASCII
            sysex[6 + 66] =
                    ((bank.sysex[getPatchStart(patchNum) + 36])); // Performance
                                                                                   // name
                                                                                   // 3
                                                                                   // ..............ASCII
            sysex[6 + 67] =
                    ((bank.sysex[getPatchStart(patchNum) + 37])); // Performance
                                                                                   // name
                                                                                   // 4
                                                                                   // ..............ASCII
            sysex[6 + 68] =
                    ((bank.sysex[getPatchStart(patchNum) + 38])); // Performance
                                                                                   // name
                                                                                   // 5
                                                                                   // ..............ASCII
            sysex[6 + 69] =
                    ((bank.sysex[getPatchStart(patchNum) + 39])); // Performance
                                                                                   // name
                                                                                   // 6
                                                                                   // ..............ASCII
            sysex[6 + 70] =
                    ((bank.sysex[getPatchStart(patchNum) + 40])); // Performance
                                                                                   // name
                                                                                   // 7
                                                                                   // ..............ASCII
            sysex[6 + 71] =
                    ((bank.sysex[getPatchStart(patchNum) + 41])); // Performance
                                                                                   // name
                                                                                   // 8
                                                                                   // ..............ASCII
            sysex[6 + 72] =
                    ((bank.sysex[getPatchStart(patchNum) + 42])); // Performance
                                                                                   // name
                                                                                   // 9
                                                                                   // ..............ASCII
            sysex[6 + 73] =
                    ((bank.sysex[getPatchStart(patchNum) + 43])); // Performance
                                                                                   // name
                                                                                   // 10
                                                                                   // ..............ASCII
            sysex[6 + 74] =
                    ((bank.sysex[getPatchStart(patchNum) + 44])); // Performance
                                                                                   // name
                                                                                   // 11
                                                                                   // ..............ASCII
            sysex[6 + 75] =
                    ((bank.sysex[getPatchStart(patchNum) + 45])); // Performance
                                                                                   // name
                                                                                   // 12
                                                                                   // ..............ASCII
            sysex[6 + 76] =
                    ((bank.sysex[getPatchStart(patchNum) + 46])); // Performance
                                                                                   // name
                                                                                   // 13
                                                                                   // ..............ASCII
            sysex[6 + 77] =
                    ((bank.sysex[getPatchStart(patchNum) + 47])); // Performance
                                                                                   // name
                                                                                   // 14
                                                                                   // ..............ASCII
            sysex[6 + 78] =
                    ((bank.sysex[getPatchStart(patchNum) + 48])); // Performance
                                                                                   // name
                                                                                   // 15
                                                                                   // ..............ASCII
            sysex[6 + 79] =
                    ((bank.sysex[getPatchStart(patchNum) + 49])); // Performance
                                                                                   // name
                                                                                   // 16
                                                                                   // ..............ASCII
            sysex[6 + 80] =
                    ((bank.sysex[getPatchStart(patchNum) + 50])); // Performance
                                                                                   // name
                                                                                   // 17
                                                                                   // ..............ASCII
            sysex[6 + 81] =
                    ((bank.sysex[getPatchStart(patchNum) + 51])); // Performance
                                                                                   // name
                                                                                   // 18
                                                                                   // ..............ASCII
            sysex[6 + 82] =
                    ((bank.sysex[getPatchStart(patchNum) + 52])); // Performance
                                                                                   // name
                                                                                   // 19
                                                                                   // ..............ASCII
            sysex[6 + 83] =
                    ((bank.sysex[getPatchStart(patchNum) + 53])); // Performance
                                                                                   // name
                                                                                   // 20
                                                                                   // ..............ASCII
            sysex[6 + 84] =
                    ((bank.sysex[getPatchStart(patchNum) + 54])); // Performance
                                                                                   // name
                                                                                   // 21
                                                                                   // ..............ASCII
            sysex[6 + 85] =
                    ((bank.sysex[getPatchStart(patchNum) + 55])); // Performance
                                                                                   // name
                                                                                   // 22
                                                                                   // ..............ASCII
            sysex[6 + 86] =
                    ((bank.sysex[getPatchStart(patchNum) + 56])); // Performance
                                                                                   // name
                                                                                   // 23
                                                                                   // ..............ASCII
            sysex[6 + 87] =
                    ((bank.sysex[getPatchStart(patchNum) + 57])); // Performance
                                                                                   // name
                                                                                   // 24
                                                                                   // ..............ASCII
            sysex[6 + 88] =
                    ((bank.sysex[getPatchStart(patchNum) + 58])); // Performance
                                                                                   // name
                                                                                   // 25
                                                                                   // ..............ASCII
            sysex[6 + 89] =
                    ((bank.sysex[getPatchStart(patchNum) + 59])); // Performance
                                                                                   // name
                                                                                   // 26
                                                                                   // ..............ASCII
            sysex[6 + 90] =
                    ((bank.sysex[getPatchStart(patchNum) + 60])); // Performance
                                                                                   // name
                                                                                   // 27
                                                                                   // ..............ASCII
            sysex[6 + 91] =
                    ((bank.sysex[getPatchStart(patchNum) + 61])); // Performance
                                                                                   // name
                                                                                   // 28
                                                                                   // ..............ASCII
            sysex[6 + 92] =
                    ((bank.sysex[getPatchStart(patchNum) + 62])); // Performance
                                                                                   // name
                                                                                   // 29
                                                                                   // ..............ASCII
            sysex[6 + 93] =
                    ((bank.sysex[getPatchStart(patchNum) + 63])); // Performance
                                                                                   // name
                                                                                   // 30
                                                                                   // ..............ASCII
    ...
    @Override
    public BankPatch createNewPatch() // create a bank with 64
