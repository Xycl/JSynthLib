...
public class DX7FamilyFractionalScalingBankDriver extends AbstractBankDriver {
    byte[] initSysex;
                                                            ...
                                                            // needed
    {
        ...
        bank.sysex[getPatchStart(patchNum) + 0] = (byte) (0x03); // Byte
                                                                           // Count
                                                                           // MSB
        bank.sysex[getPatchStart(patchNum) + 1] = (byte) (0x76); // Byte
                                                                           // Count
                                                                           // LSB
    ...
    @Override
    public BankPatch createNewPatch() // create a bank with 32 fractional scaling
                                  // patches
    {
