 ...
 * @version $Id: RolandJV80SystemSetupDriver.java 851 2005-01-27 07:36:36Z
 *          jbackhaus $
 */
public class RolandJV80SystemSetupDriver extends AbstractRolandJV80Driver {
    ...
    public void requestPatchDump(int bankNum, int patchNum) {
        ...
        setRequestLength(se, patchSize - SYSEX_OVERHEAD);
    ...
    public JSLFrame editPatch(Patch p) {
        return new RolandJV80SystemSetupEditor(p, this);
    }
}
