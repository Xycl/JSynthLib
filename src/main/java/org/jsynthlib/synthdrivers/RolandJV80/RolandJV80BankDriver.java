 ...
 */
public class RolandJV80BankDriver extends AbstractBankDriver {
    ...
    public RolandJV80BankDriver(RolandJV80PatchDriver patchDriver) {
        ...
        patchNumbers = generateNumbers(1, PATCHES_PER_BANK, "00");
    ...
    public BankPatch createNewPatch() {
        ...
        for (int i = 0; i < PATCHES_PER_BANK; i++) {
            ...
            System.arraycopy(patch.sysex, 0, bankSysex, i * singleSize,
                    patch.sysex.length);
        }

        BankPatch bankPatch = getPatchFactory().newBankPatch(bankSysex, this);
    ...
    public Patch getPatch(Patch bank, int patchNum) {
        ...
        System.arraycopy(bank.sysex, getStartOffset(patchNum), sysex, 0,
                sysex.length);
        return getPatchFactory().createNewPatch(sysex, patchDriver);
    }
