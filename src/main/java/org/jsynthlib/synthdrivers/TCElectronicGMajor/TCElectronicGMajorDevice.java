...
public class TCElectronicGMajorDevice extends Device {
    private static final String INFO_TEXT =
            "The librarian and editor are for the TC Electronic G-Major version 1.27 firmware.\n"
    ...
    public TCElectronicGMajorDevice() {
        super("TC Electronic", "G-Major", "F07E00060200201F480000000000010BF7",
                INFO_TEXT, "Ton Holsink");
    }
    ...
    public void setup(Preferences prefs) {
        ...
        TCElectronicGMajorSingleDriver singleDriver =
                new TCElectronicGMajorSingleDriver();
