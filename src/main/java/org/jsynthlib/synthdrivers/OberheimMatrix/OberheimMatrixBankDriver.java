...
public class OberheimMatrixBankDriver extends AbstractBankDriver {
    ...
    public String getPatchName(Patch p, int patchNum) {
        try {
            ...
            byte[] b = new byte[8];
            b[0] =
                    ((byte) (p.sysex[start + 5] + p.sysex[start + 6] * 16));
            b[1] =
                    ((byte) (p.sysex[start + 7] + p.sysex[start + 8] * 16));
            b[2] =
                    ((byte) (p.sysex[start + 9] + p.sysex[start + 10] * 16));
            b[3] =
                    ((byte) (p.sysex[start + 11] + p.sysex[start + 12] * 16));
            b[4] =
                    ((byte) (p.sysex[start + 13] + p.sysex[start + 14] * 16));
            b[5] =
                    ((byte) (p.sysex[start + 15] + p.sysex[start + 16] * 16));
            b[6] =
                    ((byte) (p.sysex[start + 17] + p.sysex[start + 18] * 16));
            b[7] =
                    ((byte) (p.sysex[start + 19] + p.sysex[start + 20] * 16));
