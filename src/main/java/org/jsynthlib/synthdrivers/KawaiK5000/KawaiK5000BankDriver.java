...
public class KawaiK5000BankDriver extends AbstractBankDriver {
    ...
    public void putPatch(Patch b, Patch p, int patchNum) {
        ...
        bank.sysex =
                Utility.byteArrayReplace(bank.sysex, patchIndex[nextPatchNum],
                        patchSize(bank, patchNum), p.sysex, 9,
                        p.sysex.length - 10);
    ...
    public Patch getPatch(Patch b, int patchNum) {
        ...
        try {
            ...
            System.arraycopy(bank.sysex, getPatchStart(patchNum), sysex, 9,
                    patchSize - 10);
    ...
    public void deletePatch(Patch b, int patchNum) {
        ...
        bank.sysex =
                Utility.byteArrayDelete(bank.sysex, patchIndex[patchNum],
