...
/**
 * @version $Id: KawaiK5000Device.java 654 2004-08-03 05:28:20Z jbackhaus $
 */
public class KawaiK5000Device extends Device {
    private static final String infoText =
            "These Drivers should work with the Kawai K5000s, K5000r, and K5000w, though note that the 'B' bank PCM "
    ...
    public KawaiK5000Device() {
        super("Kawai", "K5000", "F07E..06024000000A..........F7", infoText,
                "Brian Klock & Phil Shepherd");
    }
    ...
    public void setup(Preferences prefs) {
        ...
        KawaiK5000CombiDriver combiDriver = new KawaiK5000CombiDriver();
        addDriver(combiDriver);
        addDriver(new KawaiK5000CombiBankDriver(combiDriver));
