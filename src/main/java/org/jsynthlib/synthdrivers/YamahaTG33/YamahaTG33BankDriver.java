/*
 * @version $Id: YamahaTG33BankDriver.java 744 2004-10-03 17:44:17Z hayashi $
 */
package org.jsynthlib.synthdrivers.YamahaTG33;
...
public class YamahaTG33BankDriver extends AbstractBankDriver {
    ...
    public void calculateChecksum(Patch p) {
        ...
        calculateChecksum(p, 2367 + 2351 * 10, 4714 + 2351 * 10,
                4715 + 2351 * 10);
        calculateChecksum(p, 2367 + 2351 * 11, 4714 + 2351 * 11,
                4715 + 2351 * 11);
        calculateChecksum(p, 2367 + 2351 * 12, 4714 + 2351 * 12,
                4715 + 2351 * 12);
        calculateChecksum(p, 2367 + 2351 * 13, 4714 + 2351 * 13,
                4715 + 2351 * 13);
        calculateChecksum(p, 2367 + 2351 * 14, 4714 + 2351 * 14,
                4715 + 2351 * 14);
    }
    ...
    public void putPatch(Patch bank, Patch p, int patchNum) {
        ...
        System.arraycopy(p.sysex, 16, bank.sysex,
                getPatchStart(patchNum), 587);
