/*
 * @version $Id: YamahaTG33SingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
 */
...
public class YamahaTG33SingleDriver extends AbstractPatchDriver {
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        try {
            ...
            Thread.sleep(100);
            send(new byte[] {
                    (byte) 0xF0, (byte) 0x43, (byte) 0x16, (byte) 0x26,
                    (byte) 0x07, (byte) 0x09, (byte) 0xF7 });
            Thread.sleep(100);
            send(new byte[] {
                    (byte) 0xF0, (byte) 0x43, (byte) 0x16, (byte) 0x26,
                    (byte) 0x07, (byte) 0x03, (byte) 0xF7 });
            Thread.sleep(100);
            send(new byte[] {
                    (byte) 0xF0, (byte) 0x43, (byte) 0x16, (byte) 0x26,
                    (byte) 0x07, (byte) 0x04, (byte) 0xF7 });
        } catch (Exception e) {
