...
public final class D50Constants {
    ...
    public static final int COMMON_LFO_DEPTH = 22;
    public static final int COMMON_P_MOD_LEVER = 23;
    ...
    public static final int PATCH_SIZE = SYSEX_HEADER_SIZE + PARTIAL_SIZE
            * PARTIALS_PER_PATCH + SYSEX_FOOTER_SIZE;
    public static final int SYSEX_MESSAGE_SIZE = SYSEX_HEADER_SIZE
            + PARTIAL_SIZE * PARTIALS_PER_MESSAGE + SYSEX_FOOTER_SIZE;

    public static final int PARTIAL_NAME_SIZE = 10;

//    public static final int PATCH_NAME_START = SYSEX_HEADER_SIZE + PARTIAL_SIZE
//            * 6;
