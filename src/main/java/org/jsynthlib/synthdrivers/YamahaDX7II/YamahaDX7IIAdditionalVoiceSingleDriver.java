 ...
 * ==============================================================
 * @version $Id: YamahaDX7IIAdditionalVoiceSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaDX7IIAdditionalVoiceSingleDriver extends
        DX7FamilyAdditionalVoiceSingleDriver {
    public YamahaDX7IIAdditionalVoiceSingleDriver() {
        super(
                YamahaDX7IIAdditionalVoiceConstants.INIT_ADDITIONAL_VOICE,
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        if ((((DX7FamilyDevice) (getDevice())).getTipsMsgFlag() & 0x01) == 1)
            ...
            YamahaDX7IIStrings.dxShowInformation(toString(),
                    YamahaDX7IIStrings.STORE_SINGLE_ADDITIONAL_VOICE_STRING);
    }
