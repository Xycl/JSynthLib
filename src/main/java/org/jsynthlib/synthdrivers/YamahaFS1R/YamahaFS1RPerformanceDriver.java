 ...
 * @version $Id: YamahaFS1RPerformanceDriver.java 674 2004-08-18 13:29:47Z
 *          dqueffeulou $
 */
public class YamahaFS1RPerformanceDriver extends AbstractPatchDriver {
    ...
    private static final byte mInitPerf[] = new byte[] {
            ...
            (byte) , (byte) 0xF7 };

    private static final Logger LOG = Logger
            .getLogger(YamahaFS1RPerformanceDriver.class);
    ...
    private void updateSysexRequest() {
        if (mCurrentBankNum == 1) {
            ...
            // internal
            sysexRequestDump =
                    new SysexHandler("F0 43 20 5E 11 00 *patchNum* F7");
        }
    }
    ...
    String getPatchName(Patch p, int aPatchOffset) {
        ...
        try {
            String s =
                    new String(p.sysex, aPatchOffset + patchNameStart,
    ...
    public JSLFrame editPatch(Patch ip) {
        ...
        // the FS1R display show this "in edit" performance whenever it comes
        // from.
        p.sysex[6] = (byte) 0x10;
        p.sysex[7] = (byte) 0;
        p.sysex[8] = (byte) 0;
    ...
    static class Model extends ParamModel {
        ...
        Model(Patch p, int offset) {
            // l'offset indique dans la doc ne correspond pas a un offset
            // lineaire
            // dans le sysex, il faut recalculer la valeur sur 16bits lineaires
            super(p, (offset & 127) + ((offset >> 1) & 0x3F80) + DATA_START);
            LOG.debug("offset 0x" + Integer.toHexString(offset) + "  => "
                    + ((offset & 127) + ((offset >> 1) & 0x3F80) + DATA_START));
            // les parametres d'effets sont en 16 bits
            mIs16Bits =
                    (offset >= 0x50 && offset < 0x60)
                            || (offset >= 0x68 && offset < 0x0128);
            mOffset = offset;
        }
        ...
        Model(Patch p, int offset, int aPart) {
            ...
            if (aPart > 0) {
                this.offset =
                        COMMON_SIZE + PART_SIZE * (mPart - 1) + offset
                                + DATA_START;
            }
        }
        ...
        public void set(int i) {
            if (mIs16Bits) {
                patch.sysex[offset] = (byte) ((i >> 7) & 127);
                patch.sysex[offset + 1] = (byte) (i & 127);
            } else {
                patch.sysex[offset] = (byte) (i & 127);
            }
            LOG.debug("set part = " + mPart + " ofs = "
                    + Integer.toHexString(mOffset) + " valL = "
                    + Integer.toHexString(patch.sysex[offset]) + " valH = "
                    + Integer.toHexString(patch.sysex[offset + 1]));
        }

        @Override
        public int get() {
            int oRet = patch.sysex[offset];
            if (mIs16Bits) {
                oRet = patch.sysex[offset + 1] | (patch.sysex[offset] << 7);
            }
            LOG.debug("get part = " + mPart + " ofs = "
                    + Integer.toHexString(mOffset) + " = " + oRet);
            return oRet;
        }
    }
    ...
    static class BitModel extends Model {
        ...
        /**
         * Peut servir pour common ou part selon le decalage et le numero de
         * part (0 pour common).
         * @param aPart
         *            part number 0,1..4
         * @param offset
    ...
    static class BitSender extends Sender {
        ...
        public byte[] generate(int value) {
            ...
            if (mPart > 0) {
                oValue =
                        mPatch.sysex[COMMON_SIZE + PART_SIZE * (mPart - 1)
