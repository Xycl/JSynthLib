 ...
 * ============================================================
 * @version $Id: YamahaDX7sAdditionalVoiceSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaDX7sAdditionalVoiceSingleDriver extends
        DX7FamilyAdditionalVoiceSingleDriver {
    public YamahaDX7sAdditionalVoiceSingleDriver() {
        super(
                YamahaDX7sAdditionalVoiceConstants.INIT_ADDITIONAL_VOICE,
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        if ((((DX7FamilyDevice) (getDevice())).getTipsMsgFlag() & 0x01) == 1)
            ...
            YamahaDX7sStrings.dxShowInformation(toString(),
                    YamahaDX7sStrings.STORE_SINGLE_ADDITIONAL_VOICE_STRING);
    }
