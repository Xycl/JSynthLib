/*
 * JSynthlib - Strings for Yamaha DX7s
 * ===================================
 * @version $Id: YamahaDX7sStrings.java 469 2004-04-17 17:35:10Z ttittmann $
...
public class YamahaDX7sStrings extends DX7FamilyStrings {
    protected static final String INFO_TEXT =
            "This JSynthLib \"Yamaha DX7s\" device driver supports the following patch types"
                    ...
                    + "\n- Master Tune"
                    + "\n\n"
                    + "At this time only the direction JSynthLib->DX7s is working. If a parameter is changed on"
                    + " the DX7s itself, JSynthlib doesn't become aware of this."
                    + "\n\n"
                    + "- DEVICE EDITOR"
