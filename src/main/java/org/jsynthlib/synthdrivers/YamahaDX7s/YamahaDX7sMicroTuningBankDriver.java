 ...
 * =====================================================================
 * @version $Id: YamahaDX7sMicroTuningBankDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaDX7sMicroTuningBankDriver extends
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        if ((((DX7FamilyDevice) (getDevice())).getTipsMsgFlag() & 0x01) == 1) {
            ...
            YamahaDX7sStrings.dxShowInformation(toString(),
                    YamahaDX7sStrings.MICRO_TUNING_CARTRIDGE_STRING);
        }
