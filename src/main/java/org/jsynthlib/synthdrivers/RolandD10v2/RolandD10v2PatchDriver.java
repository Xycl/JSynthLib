...
public class RolandD10v2PatchDriver extends XMLSingleDriver {

    /**
     * @param driverSpec
     */
    public RolandD10v2PatchDriver(XmlSingleDriverDefinition driverSpec) {
        super(driverSpec);
    }

    // public RolandD10v2PatchDriver() {
