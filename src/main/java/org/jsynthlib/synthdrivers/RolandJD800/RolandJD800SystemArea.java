 ...
 * master tune, Mix out filter, Effect B master switch, Delay, Chorus and
 * Reverb. It uses standard methods defined in <code>core.Driver</code> package.
 * @see org.jsynthlib.device.model.AbstractPatchDriver
 */
public class RolandJD800SystemArea extends AbstractPatchDriver {

    private static final SysexHandler SYS_REQ = new SysexHandler(
            "F0 41 @@ 3D 11 02 00 00 00 00 19 00 F7");
        ...
        SysexHandler init =
                new SysexHandler(
                        "F0 41 10 3D 12 02 00 00  32 05 05 05 01 01 01 6E"
                                ...
                                + "28 48 F7");
        return getPatchFactory().createNewPatch(init.toByteArray(), this);
    };
