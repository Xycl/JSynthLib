 ...
 * @version $Id: MultiWidgetParams.java 872 2005-02-01 06:35:12Z jbackhaus $
 */
public class MultiWidgetParams {
     ...
     * @param label
     *            The text of the JCheckBox
     * @param startBit
     *            The starting bit (0 - 7)
     */
    public MultiWidgetParams(String label, int startBit) {
        if (startBit > 7 || startBit < 0)
            throw new IllegalArgumentException(
                    "startBit is greater than 7 or lower than 0: " + startBit);
