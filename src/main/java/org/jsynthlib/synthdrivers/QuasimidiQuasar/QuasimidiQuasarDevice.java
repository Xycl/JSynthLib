 ...
 * @version $Id: QuasimidiQuasarDevice.java 854 2005-01-27 07:43:13Z jbackhaus $
 */
public class QuasimidiQuasarDevice extends Device {
    ...
    public QuasimidiQuasarDevice() {
        super("Quasimidi", "Quasar", "F07E..06023F20..............F7",
                INFO_TEXT, "Joachim Backhaus");
    }
    ...
    public void setup(Preferences prefs) {
        ...
        QuasimidiQuasarSingleDriver singleDriver = new QuasimidiQuasarSingleDriver();
        addDriver(singleDriver);
        addDriver(new QuasimidiQuasarBankDriver(singleDriver));
    }
