 ...
 * @version $Id: QuasimidiQuasarTemporaryConverter.java 678 2004-08-21 17:08:55Z
 *          hayashi $
 */
public class QuasimidiQuasarTemporaryConverter extends Converter {
    ...
    public Patch[] extractPatch(Patch p) {
        ...
        System.arraycopy(sysex, 25, temporarySysex,
                QuasarConstants.ARRAY_NAME_OFFSET, 17);
        ...
        System.arraycopy(sysex, 512, temporarySysex,
                QuasarConstants.ARRAY_PART_1_OFFSET, 33);
        // starting at 221h (=545): Part 14: 33 Bytes
        System.arraycopy(sysex, 545, temporarySysex,
                QuasarConstants.ARRAY_PART_2_OFFSET, 33);
        // starting at 242h (=578): Part 15: 33 Bytes
        System.arraycopy(sysex, 578, temporarySysex,
                QuasarConstants.ARRAY_PART_3_OFFSET, 33);
        // starting at 263h (=611): Part 16: 33 Bytes
        System.arraycopy(sysex, 611, temporarySysex,
                QuasarConstants.ARRAY_PART_4_OFFSET, 33);
