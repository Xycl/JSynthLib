 ...
 * date:    2002-11-30
 * @version $Id: MIDIboxSIDSingleDriver.java 1035 2006-01-28 13:26:37Z tklose $
 *
...
public class MIDIboxSIDSingleDriver extends AbstractPatchDriver {

    public MIDIboxSIDSingleDriver() {
        super("Single", "Thorsten Klose");
        sysexID = "F000007E46**02";
        sysexRequestDump =
                new SysexHandler("F0 00 00 7E 46 @@ 01 *patchNum* F7");
