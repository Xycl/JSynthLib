...
public class NLPatchSingleDriver extends AbstractPatchDriver {
    static final String BANK_LIST[] = new String[] {
            "User", "PCMCIA 1", "PCMCIA 2", "PCMCIA 3" };
    ...
    static final byte NEW_PATCH[] = {
            (byte) 0xF0, (byte) 0x33, (byte) 0x00, (byte) 0x04, (byte) 0x00,
            (byte) 0x00, (byte) 0x0C, (byte) 0x03, (byte) 0x03, (byte) 0x04,
            (byte) 0x09, (byte) 0x03, (byte) 0x0D, (byte) 0x03, (byte) 0x00,
            (byte) 0x00, (byte) 0x0A, (byte) 0x03, (byte) 0x08, (byte) 0x00,
            (byte) 0x00, (byte) 0x00, (byte) 0x0C, (byte) 0x00, (byte) 0x0E,
            (byte) 0x04, (byte) 0x02, (byte) 0x01, (byte) 0x00, (byte) 0x07,
            (byte) 0x02, (byte) 0x01, (byte) 0x00, (byte) 0x01, (byte) 0x0E,
            (byte) 0x07, (byte) 0x08, (byte) 0x00, (byte) 0x00, (byte) 0x00,
            (byte) 0x0D, (byte) 0x03, (byte) 0x01, (byte) 0x01, (byte) 0x08,
            (byte) 0x04, (byte) 0x03, (byte) 0x04, (byte) 0x08, (byte) 0x01,
            ...
            (byte) 0x02, (byte) 0x00, (byte) 0x02, (byte) 0x00, (byte) 0x00,
            (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        setBankNum(bankNum); // must set bank - sysex patch dump always stored
                             // in current bank
        setPatchNum(patchNum); // must send program change to make bank change
                               // take effect
        sendPatch((Patch) p, bankNum + 1, patchNum);
        setPatchNum(patchNum); // send another program change to get new sound
                               // in edit buffer
    }
