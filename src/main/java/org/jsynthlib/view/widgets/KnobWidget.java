 ...
 * href="http://www.dreamfabric.com/">DreamFabric</a> which is responsible for
 * drawing the widget. This component should rather be used for parameters which
 * do not need fine adjustment. A tooltip is used to display the current value.
 * A prior version used a text field instead, but the resulting component was
 * inconsistent and diffucult to place.
 * @version $Id: KnobWidget.java 1182 2011-12-04 22:07:24Z chriswareham $
...
public class KnobWidget extends SysexWidget {
    ...
    protected void createWidgets() {
        ...
        mKnob.setValue(((float) getValue() - getValueMin())
    ...
    protected void eventListener(MouseWheelEvent e) {
        ...
        if (t.hasFocus()) // to make consistent with other operation.
            t.setValue(t.getValue()
                    - (e.getWheelRotation() / (float) (getValueMax() - getValueMin())));
    }
