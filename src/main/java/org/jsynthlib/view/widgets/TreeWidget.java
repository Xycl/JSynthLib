 ...
 * @version $Id: TreeWidget.java 687 2004-09-01 05:07:41Z hayashi $
 * @see Nodes
 */
public class TreeWidget extends SysexWidget {
     ...
     * @param treeNodes
     *            a <code>TreeWidget.Nodes</code> object specifying the tree
     *            data structure.
     * @param paramModel
     ...
     * arrays.
     * @param root
     *            a tree structure given via <code>treeNode</code> constructor
     *            parameter.
     ...
     * @return an <code>int[] </code> value. Each entry is the index of TreeNode
     *         in <code>path</code>.
     */
