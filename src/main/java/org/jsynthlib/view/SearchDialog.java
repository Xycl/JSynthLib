/*
 * $Id: SearchDialog.java 1182 2011-12-04 22:07:24Z chriswareham $
 */
...
import org.jsynthlib.view.AbstractLibraryFrame.PatchTableModel;
...
public class SearchDialog extends JDialog {
    ...
    public SearchDialog(JFrame parent) {
        ...
        try {
            ...
            if (JSLDesktop.Factory.getDesktop().getSelectedFrame() instanceof SceneFrame) {
    ...
    void findString(String text, String command, boolean restart) {
        JSLFrame frame = JSLDesktop.Factory.getDesktop().getSelectedFrame();
        if (frame == null || !(frame instanceof AbstractLibraryFrame)) {
            ErrorMsg.reportError("Error",
                    "Library to search in must be focused.");
            return;
        }
