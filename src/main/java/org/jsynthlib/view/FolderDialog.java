...
/**
 * A folder dialog is a modal file dialog to specically select a folder on disk.
 * This class takes advantage of a little know trick in Apple's VMs to show a
 * real folder dialog, with a Choose button and all. However, there is no such
 * thing on other platforms, where this class employs the usual kludge which is
 * to show a Save dialog. If you would rather use the Swing JFileChooser, go
 * right ahead.
 */
public class FolderDialog extends FileDialog {
    ...
    /**
     * Get the file of this file dialog, which in the case of this class, is
    ...
    /**
     * Set the mode of the dialog. This method is overriden because it doesn't
     * make sense in the context of an application dialog to allow selection of
     * the mode. It will throw an error if you try to call it.
     * @param mode
     *            the mode
     */
    ...
    /**
     * Make the dialog visible. Since the dialog is modal, this method will not
     * return until either the user dismisses the dialog or you make it
     * invisible yourself via <code>setVisible(false)</code> or
     * <code>dispose</code>.
     */
