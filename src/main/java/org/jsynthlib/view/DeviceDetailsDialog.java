...
public class DeviceDetailsDialog extends JDialog {
    ...
    public DeviceDetailsDialog(Frame owner, Device d) {
        ...
        infoPane.add(new JLabel("Device Name:  " + device.getManufacturerName()
                + " " + device.getModelName()), BorderLayout.NORTH);
        ...
        container.add(new JLabel(
                "This device contains the following installed drivers:"),
                BorderLayout.NORTH);
    ...
    private class DeviceDetailsTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int col) {
            ...
            if (col == DRIVER_NAME) {
                return (d.getManufacturerName() + " " + d.getModelName() + " " + myDriver
                        .getPatchType());
            } else if (col == TYPE) {
