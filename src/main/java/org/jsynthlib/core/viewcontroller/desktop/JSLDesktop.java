...
import org.jsynthlib.core.viewcontroller.desktop.mdi.MDIDesktop;
import org.jsynthlib.core.viewcontroller.desktop.sdi.SDIDesktop;
...
public abstract class JSLDesktop implements JSLFrameListener {
    ...
    private final boolean readyToExit = false;
    ...
    public void closingProc() { // wirski@op.pl
        ...
        appConfig.savePrefs();
        midiService.closeAllMidiConnections();
        System.exit(0);
    }
