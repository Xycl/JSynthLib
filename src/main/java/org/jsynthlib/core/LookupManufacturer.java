 ...
 * @version $Id: LookupManufacturer.java 1044 2006-02-06 23:52:11Z jemenake $
 */
public class LookupManufacturer {
    private static String normal[] = {
            ...
            "Clarity", // 0x1F
            "Passac", // 0x20
            "SIEL", "Synthaxe", "Stepp", "Hohner", "Twister", "Solton",
            "Jellinghaus", "Southworth", "PPG", "JEN", "Solid State Logic",
            "Audio Veritrieb", "Hinton Instruments", "Soundtracs", "Elka",
            "Dynacord",
            "UNASSIGNED!",
            "UNASSIGNED!",
            ...
            "Quasimidi", // 0x3F
            "Kawai", // 0x40
            "Roland", "Korg", "Yamaha", "Casio", "Moridaira", "Kamiya", "Akai",
            "Japan Victor", "Meisosha", "Hoshino Gakki", "Fujitsu Electric",
            "Sony",
            "Nishin Onpa",
            "TEAC",
            "UNASSIGNED!",
            "Matsushita Electric", // 0x50
            "Fostex", "Zoom", "Midori Electronics",
            "Matsushita Communication Industrial",
            "Suzuki Musical Instrument Mfg.", "Fuji Sound Corporation Ltd.",
    ...
    private static String extended00[] = {
            ...
            "eTek (formerly Forte) ", "Electrovoice", "Midisoft",
            "Q-Sound Labs", "Westrex", "NVidia", "ESS Technology",
            "MediaTrix Peripherals", "Brooktree", "Otari", "Key Electronics" // 0x7F
    };
    ...
    private static String extended10[] = {
            ...
            "Headspace (Igor's Labs)", "Van Koevering Company ",
            "Altech Systems ", "S & S Research", "VLSI Technology ",
            "Chromatic Research", "Sapphire ", "IDRC ", "Justonic Tuning ",
            "TorComp Researc, Inc ", "Newtek Inc ", "Sound Sculpture ",
            "Walker Technical ", "PAVO ",
            ...
            "Syndyne Corporation",
            "Bitheadz", // 0x20
            "Cakewalk Music Software", "Staccato Systems",
            "National Semiconductor",
            "Boom Theory / Adinolfi Alternative Percussion",
            "Virtual DSP Corporation", "Antares Systems", "Angel Software",
            "St Louis Music", "Lyrrus dba G-VOX" // 0x29
    };

    private static String extended20[] = {
            "Dream", // 0x00 !!!!
            "Strand Lighting", "AMEK Systems & Controls",
            "UNASSIGNED!",
            ...
            "Forefront Technology", "UNASSIGNED!", "Kenton Electronics",
            "UNASSIGNED!", "ADB", "Jim Marshall Products", "DDA",
            "BSS Audio",
            "UNASSIGNED!",
            "UNASSIGNED!",
            "UNASSIGNED!",
            ...
            "Charlie Lab SRL", "Blue Chip Music Technology", "BEE OH",
            "LG Semiconductor", "TESI", "Emagic", "Behringer", "Access",
            "Synoptic", "Hanmesoft", "Terratec Electronic", "Proel SpA",
            "IBK MIDI" // 0x38
    };
