    ...
    public P600ProgSingleEditor(Patch patch) {
        ...
        addWidget(envPane, new EnvelopeWidget(" ", patch,
                new EnvelopeWidget.Node[] {
                        ...
                        new EnvelopeWidget.Node(0, 15, new P6001ByteModel(
                                patch, 10, 0x1E, 1), 15, 15, null, 0, false,
                                null, null, "Attack", null),
                        new EnvelopeWidget.Node(0, 15, new P6002ByteModel(
...
class P6001ByteModel extends ParamModel {
    ...
    public void set(int i) {
        int dat =
                patch.sysex[ofs * 2 + HDRLEN]
                        | (patch.sysex[ofs * 2 + HDRLEN + 1] << 4);
    ...
    public void set(int i) {
        int dat1 =
                patch.sysex[ofs * 2 + HDRLEN]
                        | (patch.sysex[ofs * 2 + HDRLEN + 1] << 4);
        int dat2 =
                patch.sysex[ofs * 2 + HDRLEN + 2]
                        | (patch.sysex[ofs * 2 + HDRLEN + 3] << 4);
