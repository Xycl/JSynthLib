...
/**
 * PadInfo.java Pad Attribute Data Structure for Roland TD6 Percussion Module.
 * Created: Tue Jun 10 22:56:06 2003
 * @author <a href="mailto:hiroo.hayashi@computer.org">Hiroo Hayashi</a>
 * @version $Id: PadInfo.java 564 2004-06-24 02:46:04Z hayashi $
 */
...
public final class PadInfo implements Cloneable {
    ...
    final int offset;
    /**
     * dual trigger pad or not. (Snare, Tom1, Hi-Hat, Crash1, Crash2, Ride only)
     */
     ...
     * @param dualTriggerActive
     *            a <code>boolean</code> value.
     * @param padActive
     *            a <code>boolean</code> value
     */
    public PadInfo(String name, int offset, boolean dualTrigger,
            boolean dualTriggerActive, boolean padActive) {
        this.name = name;
        this.offset = offset;
    ...
    /**
     * @return a name field value. For dual trigger pad " [head]" or " [Rim]" is
     *         appended.
     */
    /*
     * public String toString() { return (this.dualTrigger ? (this.name +
     * (this.rim ? " [Rim]" : " [Head]")) : this.name); }
     */
    ...
    /*
     * // only for test public static void main(String[] args) { PadInfo p0 =
     * new PadInfo("P0", 0, true, true, true, true); PadInfo p1 = (PadInfo)
     * p0.clone(); PadInfo p2 = new PadInfo("P2", 1, true, true, true, true); p2
