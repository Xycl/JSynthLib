 ...
 * =====================================================
 * @version $Id: YamahaDX7IISysexHelpers.java 698 2004-09-11 04:39:44Z hayashi $
...
public class YamahaDX7IISysexHelpers {
    ...
    protected static void swOffMemProt(Driver d, byte ch, byte bn) // port,
                                                                   // channel,
    {
    ...
    protected static void chXmitBlock(Driver d, byte ch, byte bn) // port,
                                                                  // channel,
    {
        d.send(System.toSysexMessage(ch, new SysexHandler.NameValue("param",
    ...
    protected static void chRcvBlock(Driver d, byte ch, byte bn) // port,
                                                                 // channel,
    {
        d.send(System.toSysexMessage(ch, new SysexHandler.NameValue("param",
    ...
    protected static void chVoiceMode(Driver d, byte ch) // port, channel
    {
        d.send(Button.toSysexMessage(ch, new SysexHandler.NameValue("switch",
                0x24), new SysexHandler.NameValue("OnOff", 0x7f)));
    } // switch 36
}
