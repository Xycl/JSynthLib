 ...
 * =========================================================
 * @version $Id: YamahaDX7IIPerformanceSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaDX7IIPerformanceSingleDriver extends
        DX7FamilyPerformanceIISingleDriver {
    public YamahaDX7IIPerformanceSingleDriver() {
        super(
                YamahaDX7IIPerformanceConstants.INIT_PERFORMANCE,
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        ...
        if ((((DX7FamilyDevice) (getDevice())).getTipsMsgFlag() & 0x01) == 1)
            ...
            YamahaDX7IIStrings.dxShowInformation(toString(),
                    YamahaDX7IIStrings.STORE_SINGLE_PERFORMANCE_STRING);
    }
}
