 ...
 * ===============================================================
 * @version $Id: YamahaTX802FractionalScalingSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaTX802FractionalScalingSingleDriver extends
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        if ((((DX7FamilyDevice) (getDevice())).getTipsMsgFlag() & 0x01) == 1)
            ...
            YamahaTX802Strings.dxShowInformation(toString(),
                    YamahaTX802Strings.STORE_SINGLE_FRACTIONAL_SCALING_STRING);
