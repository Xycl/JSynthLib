 ...
 * @version $Id: MW2Constants.java 879 2005-02-02 06:47:29Z jbackhaus $
 */
public class MW2Constants {
    ...
    public static final int PURE_PATCH_SIZE = PATCH_SIZE - SYSEX_HEADER_OFFSET
            - SYSEX_FOOTER_SIZE;
    ...
    public static final String[] BANK_NAMES = new String[] {
            "A", "B" };

    public static final int ALL_SOUNDS_SIZE = (BANK_NAMES.length
            * PATCH_NUMBERS * PURE_PATCH_SIZE)
            + SYSEX_HEADER_OFFSET + SYSEX_FOOTER_SIZE;
