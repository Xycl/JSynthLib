...
final class SelectedPresetModel {
    ...
    /**
     * Internal index used to indicate the next unused occurrence of the widget
     * array.
     */
     ...
     * widget array to null. This is called by the FCB1010Editor each time it is
     * instantiated.
     */
    static void init() {
        widgetIx = 0;
    ...
    /**
     * Sets the values of all the widgets on the presets panel of the
     * FCB1010Editor to the current values of the preset given by bank and
     * preset.
     */
