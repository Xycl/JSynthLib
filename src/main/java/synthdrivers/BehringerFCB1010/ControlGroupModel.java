 ...
 * CheckBoxWidget and handles enabling/disabling the state of all of the
 * ComboBoxWidgets in the group based on the state of the associated
 * CheckBoxWidget.
 * @author Jeff Weber
 */
class ControlGroupModel implements ItemListener {
    ...
    /**
     * Detects the state of the CheckBoxWidget and calls the
     * ControlGroupModel.setEnabled method.
     */
