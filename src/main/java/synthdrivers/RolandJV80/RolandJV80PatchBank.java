...
public class RolandJV80PatchBank {
    ...
    public final static RolandJV80PatchBank INTERNAL = new RolandJV80PatchBank(
            "Internal", 0, DriverUtil.generateNumbers(1, 64, "I-00"));

    public final static RolandJV80PatchBank CARD = new RolandJV80PatchBank(
            "Card", 64, DriverUtil.generateNumbers(1, 64, "C-00"));

    public final static RolandJV80PatchBank PRESET_A = new RolandJV80PatchBank(
            "Preset A", 128, new String[] {
                    "A01: A.Piano 1", "A02: A.Piano 2", "A03: Mellow Piano",
                    "A04: Pop Piano 1", "A05: Pop Piano 2", "A06: Pop Piano 3",
    ...
    public final static RolandJV80PatchBank PRESET_B = new RolandJV80PatchBank(
            "Preset B", 192, new String[] {
                    "B01: Pizzicato", "B02: Real Pizz", "B03: Harp",
                    "B04: SoarinString", "B05: Warm Strings", "B06: Marcato",
                    "B07: St Strings", "B08: Orch Strings",
    ...
    public static String[] getBanks(Device dev) {
        if (Boolean.valueOf(
                ...
                .booleanValue()) {
            return new String[] {
                    INTERNAL.name, CARD.name, PRESET_A.name, PRESET_B.name };
        }

        return new String[] {
                INTERNAL.name, PRESET_A.name, PRESET_B.name };
    }
}
