 ...
 * @version $Id: RolandJV80Device.java 851 2005-01-27 07:36:36Z jbackhaus $
 */
public class RolandJV80Device extends Device {
    ...
    final static String[] MODELS = new String[] {
            MODEL_JV80, MODEL_JV880 };
    ...
    public JPanel config() {
        ...
        final JComboBox jexp =
                new JComboBox(
                        RolandJV80WaveBank
                                .getBanks(RolandJV80WaveBank.BANKTYPE_EXPANSION));
        ...
        final JComboBox jpcm =
                new JComboBox(
                        RolandJV80WaveBank
                                .getBanks(RolandJV80WaveBank.BANKTYPE_PCM));
