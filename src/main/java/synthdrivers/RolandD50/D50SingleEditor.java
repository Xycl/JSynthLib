...
public class D50SingleEditor extends PatchEditorFrame {
    ...
    final void fillCommonPanel(JPanel commonPanel, int index) {
        ...
        addWidget(column1, new PatchNameWidget("Name", patch) {
            protected void eventListener(FocusEvent e) {
                D50StringHandler.setName(patch, name.getText(), base,
        ...
        D50PartialMuteDataModel muteDataModel =
                new D50PartialMuteDataModel(patch, base
                        + D50Constants.COMMON_PART_MUTE);
        addWidget(
                column1,
                new CheckBoxWidget("Partial 1", patch,
                        new D50PartialMuteParamModel(muteDataModel, true),
                        senderFactory.newPartialMuteSender(base
                                + D50Constants.COMMON_PART_MUTE, muteDataModel)),
                0, GridBagConstraints.RELATIVE, 1, 1, 0);
        addWidget(
                column1,
                new CheckBoxWidget("Partial 2", patch,
                        new D50PartialMuteParamModel(muteDataModel, false),
                        senderFactory.newPartialMuteSender(base
                                + D50Constants.COMMON_PART_MUTE, muteDataModel)),
                0, GridBagConstraints.RELATIVE, 1, 1, 0);
                ...
                new EnvelopeWidget.Node[] {
                        new EnvelopeWidget.Node(0, 0, null, 0, 100,
                                ...
                                false, null, senderFactory.newSender(base
                                        + D50Constants.COMMON_ENV_LEVEL_0),
                                null, "Level 0"),
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.COMMON_ENV_TIME_1
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                        ...
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.COMMON_ENV_TIME_2
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                        ...
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.COMMON_ENV_TIME_4
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
    ...
    final JPanel createCommonPitchMod(int index) {
        ...
        addWidget(
                pitchModPanel,
                new ScrollBarWidget("LFO Select", patch, 0, 5, 0,
                        new ParamModel(patch, base
                                + D50Constants.COMMON_LFO_SELECT
                                + D50Constants.SYSEX_HEADER_SIZE),
                        senderFactory.newSender(base
                                + D50Constants.COMMON_LFO_SELECT)),
    ...
    final JPanel createTVFPanel(int part) {
        ...
        EnvelopeWidget.Node[] nodes =
                new EnvelopeWidget.Node[] {
                        ...
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVF_ENV_TIME_1
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                                ...
                                "Time 1", "Level 1"),
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVF_ENV_TIME_2
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                                ...
                                "Time 2", "Level 2"),
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVF_ENV_TIME_3
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                        ...
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVF_ENV_TIME_5
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                1, new ParamModel(patch, base
        ...
        EnvelopeWidget.Node[] nodes =
                new EnvelopeWidget.Node[] {
                        new EnvelopeWidget.Node(0, 0, null, 0, 0, null, 0,
                                false, null, null, null, null),
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVA_ENV_TIME_1
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                                ...
                                "Time 1", "Level 1"),
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVA_ENV_TIME_2
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                                ...
                                "Time 2", "Level 2"),
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVA_ENV_TIME_3
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                100, new ParamModel(patch, base
                        ...
                        new EnvelopeWidget.Node(
                                ...
                                "Time 4", "Sustain level"),
                        new EnvelopeWidget.Node(0, 100, new ParamModel(patch,
                                base + D50Constants.PART_TVA_ENV_TIME_5
                                        + D50Constants.SYSEX_HEADER_SIZE), 0,
                                1, new ParamModel(patch, base
