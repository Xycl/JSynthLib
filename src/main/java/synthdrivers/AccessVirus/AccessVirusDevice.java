 ...
 * @version $Id: AccessVirusDevice.java 541 2004-05-21 01:48:24Z hayashi $
...
public class AccessVirusDevice extends Device /* implements ItemListener */{
     ...
     * "11", "12", "13", "14", "15", "16", "Omni" }; JComboBox channelList;
     */
    ...
    /*
     * public JPanel config() { JPanel panel= new JPanel(); panel.add(new
     * JLabel("Select Virus MIDI Device Id")); channelList = new
     * JComboBox(channels); channelList.setMaximumSize(new Dimension(150, 25));
     * channelList.setSelectedIndex(deviceId - 1);
     * channelList.addItemListener(this); panel.add(channelList); return panel;
     * } public void itemStateChanged(ItemEvent e) { if (e.getStateChange() !=
     * ItemEvent.SELECTED) { return; } if (e.getItemSelectable() == channelList)
     ...
     * @param deviceId
     *            New value of property deviceId.
     */
    /*
     ...
     */
    /*
     * public Set storedProperties() { final String[] storedPropertyNames = {
     * "deviceId" }; Set set = super.storedProperties();
     * set.addAll(Arrays.asList(storedPropertyNames)); return set; }
     */
    /**
