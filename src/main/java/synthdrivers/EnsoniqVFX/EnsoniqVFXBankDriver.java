...
public class EnsoniqVFXBankDriver extends BankDriver {
    ...
    public String getPatchName(Patch p, int patchNum) {
        ...
        return EnsoniqVFXSingleDriver.getPatchName(((Patch) p).sysex,
                oPatchStart);
    }
    ...
    public void setPatchName(Patch p, int patchNum, String name) {
        int oPatchStart = getPatchStart(patchNum);
        EnsoniqVFXSingleDriver.setPatchName(((Patch) p).sysex, name,
                oPatchStart);
    }
    ...
    public void putPatch(Patch bank, Patch p, int patchNum) {
        ...
        System.arraycopy(((Patch) p).sysex, 6, ((Patch) bank).sysex,
    ...
    public Patch getPatch(Patch bank, int patchNum) {
        try {
            return EnsoniqVFXSingleDriver.newPatch(((Patch) bank).sysex,
