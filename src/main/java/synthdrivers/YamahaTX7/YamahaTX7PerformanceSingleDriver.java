 ...
 * ======================================================
 * @version $Id: YamahaTX7PerformanceSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaTX7PerformanceSingleDriver extends
    ...
    public void storePatch(Patch p, int bankNum, int patchNum) {
        if ((((DX7FamilyDevice) (getDevice())).getTipsMsgFlag() & 0x01) == 1)
            ...
            YamahaTX7Strings.dxShowInformation(toString(),
                    YamahaTX7Strings.STORE_SINGLE_PERFORMANCE_STRING);
