/*
 * JSynthlib - "Performance" Single Driver for Yamaha DX5
 * ======================================================
 * @version $Id: YamahaDX5PerformanceSingleDriver.java 662 2004-08-13 03:08:21Z hayashi $
...
public class YamahaDX5PerformanceSingleDriver extends
        DX7FamilyPerformanceSingleDriver {
    public YamahaDX5PerformanceSingleDriver() {
        super(YamahaDX5PerformanceConstants.INIT_PERFORMANCE,
                YamahaDX5PerformanceConstants.SINGLE_PERFORMANCE_PATCH_NUMBERS,
                YamahaDX5PerformanceConstants.SINGLE_PERFORMANCE_BANK_NUMBERS);
    }
