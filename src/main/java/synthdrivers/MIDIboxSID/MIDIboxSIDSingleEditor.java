 ...
 * date:    2002-11-30
 * @version $Id: MIDIboxSIDSingleEditor.java 1035 2006-01-28 13:26:37Z tklose $
 *
...
class MIDIboxSIDSingleEditor extends PatchEditorFrame {
    final String[] ccName = new String[] {
            "  0 | -", "  1 | Modulation Wheel", "  2 | Velocity Init Value",
            "  3 | Modulation Wheel Init Value", "  4 | Aftertouch Init Value",
            "  5 | Voice 123 Portamento", "  6 | -", "  7 | Volume (00h-7Fh)",
            "  8 | Voice 1/2/3 Note", "  9 | Voice 1 Note",
            " 10 | Voice 2 Note", " 11 | Voice 3 Note",
            " 12 | WT Patch number", " 13 | Velocity Depth",
            " 14 | Modulation Wheel", " 15 | Aftertouch Depth",
            " 16 | Voice 1/2/3 Transpose", " 17 | Voice 1 Single Transpose",
            " 18 | Voice 2 Single Tranpose", " 19 | Voice 3 Single Tranpose",
            " 20 | Voice 1/2/3 Finetune", " 21 | Voice 1 Single Finetune",
            " 24 | Voice 2 Single Finetune", " 23 | Voice 3 Single Finetune",
            " 24 | Voice 1/2/3 Pitch", " 25 | Voice 1 Single Pitch",
            " 26 | Voice 2 Single Pitch", " 27 | Voice 3 Single Pitch",
            " 28 | Voice 1/2/3 Portamento", " 29 | Voice 1 Portamento",
            " 30 | Voice 2 Portamento", " 31 | Voice 3 Portamento",
            " 32 | Voice 1/2/3 Waveform", " 33 | Voice 1 Waveform",
            " 34 | Voice 2 Waveform", " 35 | Voice 3 Waveform",
            " 36 | Voice 1/2/3 Pulse", " 37 | Voice 1 Pulsewidth",
            " 38 | Voice 2 Pulsewidth", " 39 | Voice 3 Pulsewidth",
            " 40 | Voice 1/2/3 Arpeggiator", " 41 | Voice 1 Arpeggiator",
            " 42 | Voice 2 Arpeggiator", " 43 | Voice 3 Arpeggiator",
            " 44 | Filter Channels", " 45 | Filter Mode",
            " 46 | Filter CutOff frequency", " 47 | Filter Resonance",
            " 48 | Voice 1/2/3 Attack", " 49 | Voice 1 Single Attack",
            " 50 | Voice 2 Single Attack", " 51 | Voice 3 Single Attack",
            " 52 | Voice 1/2/3 Decay", " 53 | Voice 1 Single Decay",
            " 54 | Voice 2 Single Decay", " 55 | Voice 3 Single Decay",
            " 56 | Voice 1/2/3 Sustain", " 57 | Voice 1 Single Sustain",
            " 58 | Voice 2 Single Sustain", " 59 | Voice 3 Single Sustain",
            " 60 | Voice 1/2/3 Release", " 61 | Voice 1 Release",
            " 62 | Voice 2 Release", " 63 | Voice 3 Release",
            " 64 | LFO1 Rate", " 65 | LFO2 Rate", " 66 | LFO3 Rate",
            " 67 | LFO4 Rate", " 68 | LFO5 Rate", " 69 | LFO6 Rate", " 70 | -",
            " 71 | -", " 72 | LFO1 Depth", " 73 | LFO2 Depth",
            " 74 | LFO3 Depth", " 75 | LFO4 Depth", " 76 | LFO5 Depth",
            " 77 | LFO6 Depth", " 78 | ENV1 Depth", " 79 | ENV2 Depth",
            " 80 | LFO1 Mode", " 81 | LFO2 Mode", " 82 | LFO3 Mode",
            " 83 | LFO4 Mode", " 84 | LFO5 Mode", " 85 | LFO6 Mode",
            " 86 | Envelope 1 Curve", " 87 | Envelope 2 Curve",
            " 88 | Envelope 1 Attack", " 89 | Envelope 1 Decay",
            " 90 | Envelope 1 Sustain", " 91 | Envelope 1 Release",
            " 92 | Envelope 2 Attack", " 93 | Envelope 2 Decay",
            " 94 | Envelope 2 Sustain", " 95 | Envelope 2 Release",
            ...
            "110 | Assigned Envelope Curves", "111 | Sound Engine Options",
            "112 | Voice 1/2/3 Note Delay", "113 | Voice 1 Single Note Delay",
            "114 | Voice 2 Single Note Delay",
            "115 | Voice 3 Single Note Delay", "116 | Sus-Key behaviour",
            "117 | Assign Velocity to Controller",
            "118 | Assign Modulation to Controller",
            "119 | Assign Aftertouch to Controller", "120 | Wavetable Rate",
            ...
            "125 | MIDI Clock Synchronization", "126 | Mono On",
            "127 | Poly On", };

    final String[] NoteName = new String[] {
            "---", "c#2", "d-2", "d#2", "e-2", "f-2", "f#2", "g-2", "g#2",
            "a-2", "a#2", "b-2", "c-1", "c#1", "d-1", "d#1", "e-1", "f-1",
            "f#1", "g-1", "g#1", "a-1", "a#1", "b-1", "C-0", "C#0", "D-0",
            "D#0", "E-0", "F-0", "F#0", "G-0", "G#0", "A-0", "A#0", "B-0",
            "C-1", "C#1", "D-1", "D#1", "E-1", "F-1", "F#1", "G-1", "G#1",
            "A-1", "A#1", "B-1", "C-2", "C#2", "D-2", "D#2", "E-2", "F-2",
            "F#2", "G-2", "G#2", "A-2", "A#2", "B-2", "C-3", "C#3", "D-3",
            "D#3", "E-3", "F-3", "F#3", "G-3", "G#3", "A-3", "A#3", "B-3",
            "C-4", "C#4", "D-4", "D#4", "E-4", "F-4", "F#4", "G-4", "G#4",
            "A-4", "A#4", "B-4", "C-5", "C#5", "D-5", "D#5", "E-5", "F-5",
            "F#5", "G-5", "G#5", "A-5", "A#5", "B-5", "C-6", "C#6", "D-6",
            "D#6", "E-6", "F-6", "F#6", "G-6", "G#6", "A-6", "A#6", "B-6",
    ...
    public MIDIboxSIDSingleEditor(Patch patch) {
        ...
        // the vertical size). The last number is the fader number
        ...
        gbc.gridwidth = 2;
        gbc.gridheight = 1;
        cmnPane.add(new JLabel("SE Options:"), gbc);
        JPanel cmnOptPane = new JPanel();
        cmnOptPane.setLayout(new GridBagLayout());
        addWidget(cmnOptPane, new CheckBoxWidget("6", patch, new SIDModel(
                patch, 0x16, 6), new SIDSender(patch, 0x16, 6)), 0, 0, 1, 1,
                -200);
        addWidget(cmnOptPane, new CheckBoxWidget("5", patch, new SIDModel(
                patch, 0x16, 5), new SIDSender(patch, 0x16, 5)), 1, 0, 1, 1,
                -200);
        addWidget(cmnOptPane, new CheckBoxWidget("4", patch, new SIDModel(
                patch, 0x16, 4), new SIDSender(patch, 0x16, 4)), 2, 0, 1, 1,
                -200);
        addWidget(cmnOptPane, new CheckBoxWidget("3", patch, new SIDModel(
                patch, 0x16, 3), new SIDSender(patch, 0x16, 3)), 3, 0, 1, 1,
                -200);
        addWidget(cmnOptPane, new CheckBoxWidget("2", patch, new SIDModel(
                patch, 0x16, 2), new SIDSender(patch, 0x16, 2)), 4, 0, 1, 1,
                -200);
        addWidget(cmnOptPane, new CheckBoxWidget("1", patch, new SIDModel(
                patch, 0x16, 1), new SIDSender(patch, 0x16, 1)), 5, 0, 1, 1,
                -200);
        addWidget(cmnOptPane, new CheckBoxWidget("0", patch, new SIDModel(
                patch, 0x16, 0), new SIDSender(patch, 0x16, 0)), 6, 0, 1, 1,
                -200);
        gbc.gridx = 2;
        gbc.gridy = 3;
        gbc.gridwidth = 3;
        ...
        for (int i = 0; i < 2; i++) {
            ...
            addWidget(panel, new EnvelopeWidget("SW Envelope", patch,
                    new EnvelopeWidget.Node[] {
                            ...
                            new EnvelopeWidget.Node(0, 127, new SIDModel(patch,
                            ...
                            new EnvelopeWidget.Node(0, 127, new SIDModel(patch,
                                    ...
                                    0x75 + i * 5), "D", "S"),
                            new EnvelopeWidget.Node(127, 127, null, 5000, 5000,
            ...
            addWidget(panel, new KnobWidget("Depth", patch, 0, 127, -64,
                    new SIDModel(patch, 0x72 + i * 5), new SIDSender(patch,
                            0x72 + i * 5)), 0, 5, 1, 3, 51);
            addWidget(panel, new KnobWidget("Curve", patch, 0, 127, -64,
                    new SIDModel(patch, 0x1e + i), new SIDSender(patch,
                            0x1e + i)), 1, 5, 1, 3, 52);
            gbc.gridx = 2;
            gbc.gridy = 5;
            gbc.gridwidth = 3;
        ...
        for (int i = 0; i < 6; i++) {
            ...
            addWidget(panel, new KnobWidget("Rate", patch, 0, 127, 0,
                    new SIDModel(patch, 0x61 + i * 3), new SIDSender(patch,
                            0x61 + i * 3)), 0, 0, 1, 3, 40);
            addWidget(panel, new KnobWidget("Depth", patch, 0, 127, -64,
                    new SIDModel(patch, 0x62 + i * 3), new SIDSender(patch,
                            0x62 + i * 3)), 1, 0, 1, 3, 41);
        ...
        gbc.weightx = 0;
        addWidget(LFOAPane, new ComboBoxWidget("Controller", patch,
                new SIDModel(patch, 0x50), new SIDSender(patch, 0x50), ccName),
                0, 0, 5, 1, 4);
        addWidget(LFOAPane, new ScrollBarWidget("Init Value", patch, 0, 127, 0,
                new SIDModel(patch, 0x51), new SIDSender(patch, 0x51)), 0, 1,
                5, 1, 5);
        addWidget(LFOAPane, new ScrollBarWidget("Depth", patch, 0, 127, -64,
                new SIDModel(patch, 0x52), new SIDSender(patch, 0x52)), 0, 2,
                5, 1, 6);
        ...
        gbc.weightx = 0;
        addWidget(MODAPane, new ComboBoxWidget("Controller", patch,
                new SIDModel(patch, 0x53), new SIDSender(patch, 0x53), ccName),
                0, 0, 5, 1, 7);
        addWidget(MODAPane, new ScrollBarWidget("Init Value", patch, 0, 127, 0,
                new SIDModel(patch, 0x54), new SIDSender(patch, 0x54)), 0, 1,
                5, 1, 8);
        addWidget(MODAPane, new ScrollBarWidget("Depth", patch, 0, 127, -64,
                new SIDModel(patch, 0x55), new SIDSender(patch, 0x55)), 0, 2,
                5, 1, 9);
        ...
        gbc.weightx = 0;
        addWidget(AFTAPane, new ComboBoxWidget("Controller", patch,
                new SIDModel(patch, 0x56), new SIDSender(patch, 0x56), ccName),
                0, 0, 5, 1, 10);
        addWidget(AFTAPane, new ScrollBarWidget("Init Value", patch, 0, 127, 0,
                new SIDModel(patch, 0x57), new SIDSender(patch, 0x57)), 0, 1,
                5, 1, 11);
        addWidget(AFTAPane, new ScrollBarWidget("Depth", patch, 0, 127, -64,
                new SIDModel(patch, 0x58), new SIDSender(patch, 0x58)), 0, 2,
                5, 1, 12);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            addWidget(panel, new KnobWidget(" FineTune ", patch, 0, 127, -64,
                    new SIDModel(patch, 0x21 + i * 16), new SIDSender(patch,
                            0x21 + i * 16)), 1, 6, 1, 3, 21);
            addWidget(panel, new KnobWidget(" PitchRange ", patch, 0, 127, 0,
                    new SIDModel(patch, 0x22 + i * 16), new SIDSender(patch,
                            0x22 + i * 16)), 2, 6, 1, 3, 22);
            addWidget(panel, new KnobWidget(" Arpeggiator ", patch, 0, 127, 0,
                    new SIDModel(patch, 0x26 + i * 16), new SIDSender(patch,
                            0x26 + i * 16)), 0, 9, 1, 3, 23);
            addWidget(panel, new KnobWidget(" Portamento ", patch, 0, 127, 0,
                    new SIDModel(patch, 0x23 + i * 16), new SIDSender(patch,
                            0x23 + i * 16)), 1, 9, 1, 3, 25);
            addWidget(panel, new KnobWidget(" PulseWidth ", patch, 0, 127, 0,
                    new SIDModel(patch, 0x25 + i * 16), new SIDSender(patch,
                            0x25 + i * 16)), 2, 9, 1, 3, 26);
            ...
            addWidget(panel, new CheckBoxWidget("Phase", patch, new SIDModel(
                    ...
                    1, -27);
            addWidget(panel, new ComboBoxWidget("Lower Limit", patch,
                    new SIDModel(patch, 0x2f + i * 16), new SIDSender(patch,
                            0x2f + i * 16), NoteName), 0, 12, 2, 1, 27);
            addWidget(panel, new ComboBoxWidget("Upper Limit", patch,
                    new SIDModel(patch, 0x5d + i), new SIDSender(patch,
                            0x5d + i), NoteName), 2, 12, 2, 1, 28);
        }
        gbc.gridx = 5;
        gbc.gridy = 0;
        gbc.gridwidth = 5;
        ...
        ScrollBarWidget WTRateBar =
                new ScrollBarWidget("Rate", patch, 0, 127, 0, new SIDModel(
                        patch, 0x59), new SIDSender(patch, 0x59));
        ...
        gbc.gridwidth = 5;
        gbc.gridheight = 3;
        WAVTPane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "Wavetable", TitledBorder.CENTER,
                TitledBorder.CENTER));
        ...
        addWidget(FILTPane, new KnobWidget("CutOff", patch, 0, 127, 0,
                new SIDModel(patch, 0x1a), new SIDSender(patch, 0x1a)), 0, 0,
                2, 3, 30);
        addWidget(FILTPane, new KnobWidget("Resonance", patch, 0, 127, 0,
                new SIDModel(patch, 0x1b), new SIDSender(patch, 0x1b)), 2, 0,
                2, 3, 31);
        ...
        gbc.gridwidth = 2;
        gbc.gridheight = 1;
        FILTPane.add(new JLabel("Channel"), gbc);
        addWidget(FILTPane, new CheckBoxWidget("O1", patch, new SIDModel(patch,
                0x18, 0), new SIDSender(patch, 0x18, 0)), 4, 1, 1, 1, -13);
        addWidget(FILTPane, new CheckBoxWidget("O2", patch, new SIDModel(patch,
                0x18, 1), new SIDSender(patch, 0x18, 1)), 5, 1, 1, 1, -14);
        addWidget(FILTPane, new CheckBoxWidget("O3", patch, new SIDModel(patch,
                0x18, 2), new SIDSender(patch, 0x18, 2)), 4, 2, 1, 1, -15);
        addWidget(FILTPane, new CheckBoxWidget("Ext", patch, new SIDModel(
                patch, 0x18, 3), new SIDSender(patch, 0x18, 3)), 5, 2, 1, 1,
                -16);

        addWidget(FILTPane, new CheckBoxWidget("LP", patch, new SIDModel(patch,
                0x19, 0), new SIDSender(patch, 0x19, 0)), 0, 4, 1, 1, -17);
        addWidget(FILTPane, new CheckBoxWidget("HP", patch, new SIDModel(patch,
                0x19, 1), new SIDSender(patch, 0x19, 1)), 1, 4, 1, 1, -18);
        addWidget(FILTPane, new CheckBoxWidget("BP", patch, new SIDModel(patch,
                0x19, 2), new SIDSender(patch, 0x19, 2)), 2, 4, 1, 1, -19);
        addWidget(FILTPane, new CheckBoxWidget("3O", patch, new SIDModel(patch,
                0x19, 3), new SIDSender(patch, 0x19, 3)), 3, 4, 1, 1, -20);

        gbc.gridx = 10;
        gbc.gridy = GridBagConstraints.RELATIVE;
        gbc.gridwidth = 5;
        gbc.gridheight = 1;
        FILTPane.setBorder(new TitledBorder(new EtchedBorder(
        ...
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("OSC1 Pitch"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("OSC2 Pitch"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("OSC3 Pitch"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 4;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("OSC1 PW"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 5;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("OSC2 PW"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 6;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("OSC3 PW"), gbc);
        gbc.gridx = 0;
        gbc.gridy = 7;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("Filter"), gbc);

        gbc.gridx = 1;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("E1"), gbc);
        gbc.gridx = 2;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("E2"), gbc);
        gbc.gridx = 3;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("L1"), gbc);
        gbc.gridx = 4;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("L2"), gbc);
        gbc.gridx = 5;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("L3"), gbc);
        gbc.gridx = 6;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("L4"), gbc);
        gbc.gridx = 7;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("L5"), gbc);
        gbc.gridx = 8;
        gbc.gridy = 0;
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        MODMPane.add(new JLabel("L6"), gbc);
        ...
        addWidget(MODMPane, new CheckBoxWidget("", patch, new SIDModel(patch,
                0x1d, 1), new SIDSender(patch, 0x1d, 1)), 2, 7, 1, 1, -57);
        addWidget(MODMPane, new CheckBoxWidget("", patch, new SIDModel(patch,
                0x1c, 0), new SIDSender(patch, 0x1c, 0)), 3, 7, 1, 1, -58);
        addWidget(MODMPane, new CheckBoxWidget("", patch, new SIDModel(patch,
                0x1c, 1), new SIDSender(patch, 0x1c, 1)), 4, 7, 1, 1, -59);
        addWidget(MODMPane, new CheckBoxWidget("", patch, new SIDModel(patch,
                0x1c, 2), new SIDSender(patch, 0x1c, 2)), 5, 7, 1, 1, -60);
        addWidget(MODMPane, new CheckBoxWidget("", patch, new SIDModel(patch,
                0x1c, 3), new SIDSender(patch, 0x1c, 3)), 6, 7, 1, 1, -61);
        addWidget(MODMPane, new CheckBoxWidget("", patch, new SIDModel(patch,
                0x1c, 4), new SIDSender(patch, 0x1c, 4)), 7, 7, 1, 1, -62);
        addWidget(MODMPane, new CheckBoxWidget("", patch, new SIDModel(patch,
                0x1c, 5), new SIDSender(patch, 0x1c, 5)), 8, 7, 1, 1, -63);

        gbc.gridx = 10;
        gbc.gridy = GridBagConstraints.RELATIVE;
        gbc.gridwidth = 5;
        gbc.gridheight = 3;
        MODMPane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "Modulation Matrix", TitledBorder.CENTER,
                TitledBorder.CENTER));
        ...
        gbc.gridwidth = 1;
        gbc.gridheight = 1;
        CLKPane.add(new JLabel("Targets   "), gbc);
        addWidget(CLKPane, new CheckBoxWidget("Wavetable Seq./Arp.", patch,
                new SIDModel(patch, 0x13, 0), new SIDSender(patch, 0x13, 0)),
                1, 1, 1, 1, -10);
        addWidget(CLKPane, new CheckBoxWidget("LFOs", patch, new SIDModel(
                patch, 0x13, 1), new SIDSender(patch, 0x13, 1)), 1, 2, 1, 1,
                -11);
        addWidget(CLKPane, new CheckBoxWidget("ENVs", patch, new SIDModel(
                patch, 0x13, 2), new SIDSender(patch, 0x13, 2)), 1, 3, 1, 1,
                -12);
        ...
        gbc.gridwidth = 5;
        gbc.gridheight = 1;
        CLKPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED),
                "MIDI Clock Synchronization", TitledBorder.CENTER,
                TitledBorder.CENTER));
