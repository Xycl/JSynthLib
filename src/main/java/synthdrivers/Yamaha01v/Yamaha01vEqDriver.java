...
public class Yamaha01vEqDriver extends Driver {
    ...
    public Yamaha01vEqDriver() {
        ...
        System.arraycopy(DriverUtil.generateNumbers(1, 80, "Lib 00"), 0,
                patchNumbers, 0, 80);
        System.arraycopy(DriverUtil.generateNumbers(1, 12, "Ch 0"), 0,
                patchNumbers, 80, 12);
        patchNumbers[92] = new String("Ch 13/14");
        patchNumbers[93] = new String("Ch 15/16");
        patchNumbers[94] = new String("RTN 1/2");
        System.arraycopy(DriverUtil.generateNumbers(1, 4, "AUX 0"), 0,
                patchNumbers, 95, 4);
        patchNumbers[99] = new String("ST MAS");
        System.arraycopy(DriverUtil.generateNumbers(17, 24, "Ch 0"), 0,
                patchNumbers, 100, 8);
    }
