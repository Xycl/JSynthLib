...
public class AlesisDM5PrChgEditor extends PatchEditorFrame {
     ...
     */
    private static final String[] setNums = new String[] {
     ...
     * Since the editor uses all ComboBoxWidgets (no sliders) this sender just
    ...
    private class DM5ProgChgSender extends SysexSender {
        ...
        public byte[] generate(int value) {
            ((AlesisDM5PrChgDriver) (patch.getDriver()))
