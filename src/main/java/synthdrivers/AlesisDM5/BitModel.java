...
/**
 * The BitModel class allows a control to set the individual bits in a byte of
 * the patch.sysex record. This is used when a single byte of the sysex record
 * contains more than one parameter. Masks are provided for each of the
