...
public class D10Constants {
    ...
    public static final int SIZE_HEADER_RQ1 = SIZE_HEADER + SIZE_ADDRESS
            + SIZE_SIZE;
    ...
    public static final Entity BASE_TONE_TEMP = Entity
            .createFromDataValue(0x020000);

    public static final Entity BASE_TIMBRE_TEMP_AREA = Entity
            .createFromDataValue(0x030000);
    public static final Entity BASE_RYTHM_SETUP_TEMP_AREA = Entity
            .createFromDataValue(0x030110);
    public static final Entity BASE_PATCH_TEMP_AREA = Entity
            .createFromDataValue(0x030400);
    public static final Entity BASE_TONE_TEMP_AREA = Entity
            .createFromDataValue(0x040000);

    public static final Entity BASE_TIMBRE_MEMORY = Entity
            .createFromDataValue(0x050000);
    public static final Entity BASE_PATCH_MEMORY = Entity
            .createFromDataValue(0x070000);
    public static final Entity BASE_TONE_MEMORY = Entity
            .createFromDataValue(0x080000);

    public static final Entity BASE_RYTHM_SETUP = Entity
            .createFromDataValue(0x090000);
    public static final Entity BASE_RYTHM_PATTERN = Entity
            .createFromDataValue(0x0a0000);
    public static final Entity BASE_RYTHM_TRACK = Entity
            .createFromDataValue(0x0c0000);

    public static final Entity BASE_SYSTEM_AREA = Entity
            .createFromDataValue(0x100000);
    public static final Entity BASE_DISPLAY = Entity
            .createFromDataValue(0x200000);
    public static final Entity BASE_WRITE_REQUEST = Entity
            .createFromDataValue(0x400000);
    ...
    public static final Entity TIMBRE_SIZE = Entity
            .createFromDataValue(0x000008);
    public static final Entity TIMBRE_TONE_GROUP = Entity.ZERO;
    public static final Entity TIMBRE_TONE_NUMBER = Entity
            .createFromDataValue(0x000001);
    public static final Entity TIMBRE_KEY_SHIFT = Entity
            .createFromDataValue(0x000002);
    public static final Entity TIMBRE_FINE_TUNE = Entity
            .createFromDataValue(0x000003);
    public static final Entity TIMBRE_BENDER_RANGE = Entity
            .createFromDataValue(0x000004);
    public static final Entity TIMBRE_ASSIGN_MODE = Entity
            .createFromDataValue(0x000005);
    public static final Entity TIMBRE_REVERB_SWITCH = Entity
            .createFromDataValue(0x000006);
    public static final Entity TIMBRE_DUMMY = Entity
            .createFromDataValue(0x000007);
    ...
    public static final Entity PATCH_SIZE = Entity
            .createFromDataValue(0x000026);
    public static final Entity PATCH_KEY_MODE = Entity.ZERO;
    public static final Entity PATCH_SPLIT_POINT = Entity
            .createFromDataValue(0x000001);
    public static final Entity PATCH_LOWER_TONE_GROUP = Entity
            .createFromDataValue(0x000002);
    public static final Entity PATCH_LOWER_TONE_NUMBER = Entity
            .createFromDataValue(0x000003);
    public static final Entity PATCH_UPPER_TONE_GROUP = Entity
            .createFromDataValue(0x000004);
    public static final Entity PATCH_UPPER_TONE_NUMBER = Entity
            .createFromDataValue(0x000005);
    public static final Entity PATCH_LOWER_KEY_SHIFT = Entity
            .createFromDataValue(0x000006);
    public static final Entity PATCH_UPPER_KEY_SHIFT = Entity
            .createFromDataValue(0x000007);
    public static final Entity PATCH_LOWER_FINE_TUNE = Entity
            .createFromDataValue(0x000008);
    public static final Entity PATCH_UPPER_FINE_TUNE = Entity
            .createFromDataValue(0x000009);
    public static final Entity PATCH_LOWER_BENDER_RANGE = Entity
            .createFromDataValue(0x00000a);
    public static final Entity PATCH_UPPER_BENDER_RANGE = Entity
            .createFromDataValue(0x00000b);
    public static final Entity PATCH_LOWER_ASSIGN_MODE = Entity
            .createFromDataValue(0x00000c);
    public static final Entity PATCH_UPPER_ASSIGN_MODE = Entity
            .createFromDataValue(0x00000d);
    public static final Entity PATCH_LOWER_REVERB_SWITCH = Entity
            .createFromDataValue(0x00000e);
    public static final Entity PATCH_UPPER_REVERB_SWITCH = Entity
            .createFromDataValue(0x00000f);
    public static final Entity PATCH_REVERB_MODE = Entity
            .createFromDataValue(0x000010);
    public static final Entity PATCH_REVERB_TIME = Entity
            .createFromDataValue(0x000011);
    public static final Entity PATCH_REVERB_LEVEL = Entity
            .createFromDataValue(0x000012);
    public static final Entity PATCH_U_L_BALANCE = Entity
            .createFromDataValue(0x000013);
    public static final Entity PATCH_LEVEL = Entity
            .createFromDataValue(0x000014);
    public static final Entity PATCH_NAME = Entity
            .createFromDataValue(0x000015);
    public static final Entity PATCH_NAME_SIZE = Entity
            .createFromDataValue(0x000010);
    public static final Entity PATCH_DUMMY = Entity
            .createFromDataValue(0x000025);
    ...
    public static final Entity TONE_RECORD_SIZE = Entity
            .createFromDataValue(0x000200);
    public static final Entity TONE_NAME_START = Entity.ZERO;
    public static final Entity TONE_NAME_SIZE = Entity
            .createFromDataValue(0x00000a);
    ...
    public static final Entity RYTHM_SETUP_SIZE = Entity
            .createFromIntValue(0x000004);
    public static final Entity RYTHM_SETUP_TONE = Entity.ZERO;
    public static final Entity RYTHM_SETUP_LEVEL = Entity
            .createFromDataValue(0x000001);
    public static final Entity RYTHM_SETUP_PANPOT = Entity
            .createFromDataValue(0x000002);
    public static final Entity RYTHM_SETUP_REVERB_SWITCH = Entity
            .createFromDataValue(0x000003);
    ...
    public static final Entity DISPLAY_ROW_SIZE = Entity
            .createFromDataValue(0x000010);
    public static final Entity DISPLAY_ROW_1 = Entity.ZERO;
    public static final Entity DISPLAY_ROW_2 = Entity
            .createFromDataValue(0x000010);
    ...
    public static final Entity TIMBRE_WRITE_REQUEST = Entity
            .createFromDataValue(0x000100);
    public static final Entity PATCH_WRITE_REQUEST = Entity
            .createFromDataValue(0x000300);
