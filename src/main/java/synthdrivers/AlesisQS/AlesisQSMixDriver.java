...
public class AlesisQSMixDriver extends Driver {
    ...
    public String getPatchName(Patch ip) {
        ...
        return SysexRoutines.getChars(((Patch) ip).sysex, QSConstants.HEADER,
    ...
    public void setPatchName(Patch p, String name) {
        ...
        SysexRoutines.setChars(name, ((Patch) p).sysex, QSConstants.HEADER,
                QSConstants.MIX_NAME_START, QSConstants.MIX_NAME_LENGTH);
    }
    ...
    public Patch createNewPatch() {
        ...
        sysex[QSConstants.POSITION_OPCODE] =
                QSConstants.OPCODE_MIDI_USER_MIX_DUMP;
    ...
    /**
     * Copied from Driver.java by zjh. Requests a patch dump. Use opcode 0F -
     * MIDI User Program Dump Request. 100 corresponds to the Mix mode edit
     * buffer
     * @param bankNum
     *            not used
     * @param patchNum
     ...
     * requestPatchDump for explanation of patch numbers. We save the old
