...
public class RolandGP16SingleDriver extends Driver {
    ...
    public RolandGP16SingleDriver() {
        ...
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Group A - Bank ##"),
                0, bankNumbers, 0, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Group B - Bank ##"),
                0, bankNumbers, 8, 8);
        patchNumbers = new String[8 * 1];
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch ##"), 0,
                patchNumbers, 0, 8);
    }
