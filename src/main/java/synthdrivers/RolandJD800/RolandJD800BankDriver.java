...
public class RolandJD800BankDriver extends BankDriver {
    ...
    public RolandJD800BankDriver() {
        ...
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-10"), 0,
                patchNumbers, 0, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-20"), 0,
                patchNumbers, 8, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-30"), 0,
                patchNumbers, 16, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-40"), 0,
                patchNumbers, 24, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-50"), 0,
                patchNumbers, 32, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-60"), 0,
                patchNumbers, 40, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-70"), 0,
                patchNumbers, 48, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "Patch I-80"), 0,
                patchNumbers, 56, 8);
        ...
        for (int i = 0; i < JD800.nrOfSyxForABank; i++) {
            ...
            System.arraycopy(p.sysex, JD800.SizeOfSyxHeader + i
                    * JD800.MaxSyxDataBlock, s, JD800.SizeOfSyxHeader,
                    JD800.MaxSyxDataBlock);
            DriverUtil.calculateChecksum(s, JD800.checksumStartSyx1,
