...
public class TCElectronicGMajorUtil {
    ...
    public static byte calcChecksum(byte[] b) {
        return calcChecksum(b, TCElectronicGMajorConst.CHECKSUMSTART,
    ...
    // Generate a string array of int values within a range and using a step
    // value
    ...
    public static String[] genString(double from, double to, double step,
            String fs) {
