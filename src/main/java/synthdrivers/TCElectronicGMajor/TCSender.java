...
class TCSender extends SysexSender {
    ...
    public byte[] generate(int value) {
        // TODO: EEN SEND METHODE BEDENKEN WAARBIJ DIT AUTOMATISCH WORDT
        // GEREGELD, ZONDER DE STORE FUNCTIE TE ONTREGELEN.
        ...
        patch.sysex[TCElectronicGMajorConst.CHECKSUMOFFSET] =
                TCElectronicGMajorUtil.calcChecksum(patch.sysex);
        return patch.sysex;
    }
}
