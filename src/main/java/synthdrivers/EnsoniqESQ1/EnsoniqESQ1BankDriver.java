...
public class EnsoniqESQ1BankDriver extends BankDriver {
    ...
    public String getPatchName(Patch p, int patchNum) {
        ...
        try {
            byte[] b = new byte[6];
            b[0] =
                    ((byte) (((Patch) p).sysex[nameStart] + ((Patch) p).sysex[nameStart + 1] * 16));
            b[1] =
                    ((byte) (((Patch) p).sysex[nameStart + 2] + ((Patch) p).sysex[nameStart + 3] * 16));
            b[2] =
                    ((byte) (((Patch) p).sysex[nameStart + 4] + ((Patch) p).sysex[nameStart + 5] * 16));
            b[3] =
                    ((byte) (((Patch) p).sysex[nameStart + 6] + ((Patch) p).sysex[nameStart + 7] * 16));
            b[4] =
                    ((byte) (((Patch) p).sysex[nameStart + 8] + ((Patch) p).sysex[nameStart + 9] * 16));
            b[5] =
                    ((byte) (((Patch) p).sysex[nameStart + 10] + ((Patch) p).sysex[nameStart + 11] * 16));
    ...
    public void putPatch(Patch bank, Patch p, int patchNum) {
        ...
        System.arraycopy(((Patch) p).sysex, 5, ((Patch) bank).sysex,
