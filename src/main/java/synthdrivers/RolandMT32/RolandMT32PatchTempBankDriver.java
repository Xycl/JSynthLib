 ...
 */
/**
 * Patch temp Bank driver for Roland MT32.
 * @version $Id: RolandMT32PatchTempBankDriver.java 1031 2005-10-10 17:44:56Z billzwicky $
 */
...
public class RolandMT32PatchTempBankDriver extends BankDriver {
    /** Header Size */
    ...
    public RolandMT32PatchTempBankDriver() {
        super("Patch Temp Bank", "Fred Jan Kraan", NS, 4);
        ...
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "##"), 0,
                patchNumbers, 0, 8);
