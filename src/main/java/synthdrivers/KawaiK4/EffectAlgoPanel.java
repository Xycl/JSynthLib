...
class EffectAlgoPanel extends javax.swing.JPanel {
    ...
    /**
     * Draw an arrow from x1,y1 to x2,y2. It has an arrowhead at the x1,y2
     * point.
     */
    void drawArrow(Graphics2D g2, float x1, float y1, float x2, float y2) {
        ...
        Point2D p1 =
                new Point2D.Float(x2 - ((x2 - x1) * 10 / dist), y2
                        - ((y2 - y1) * 10 / dist));
    ...
    /**
     * This method is called as result of the repaint() call. It does all the
     * drawing here.
     */
     ...
     * @param effectNumber
     *            New value of property effectNumber.
     */
