...
public class YamahaSY85SingleDriver extends Driver {
    ...
    public YamahaSY85SingleDriver() {
        ...
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "A-##"), 0,
                patchNumbers, 0, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "B-##"), 0,
                patchNumbers, 8, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "C-##"), 0,
                patchNumbers, 16, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "D-##"), 0,
                patchNumbers, 24, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "E-##"), 0,
                patchNumbers, 32, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "F-##"), 0,
                patchNumbers, 40, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 8, "G-##"), 0,
                patchNumbers, 48, 8);
        System.arraycopy(DriverUtil.generateNumbers(1, 7, "H-##"), 0,
                patchNumbers, 54, 7);
    ...
    public Patch createNewPatch() {
        return (Patch) DriverUtil
                .createNewPatch(this, patchFileName, patchSize);
    }
     ...
     * byte [] sysex = new byte[SY85Constants.PATCH_SIZE]; // Create new patch
