/*
 * @version $Id: EmuProteusMPSSingleEditor.java 897 2005-02-08 03:10:28Z hayashi $
 */
...
class EmuProteusMPSSingleEditor extends PatchEditorFrame {
    final String[] realtimeModSource = new String[] {
            "Pitch Weel", "Midi Controller A", "Midi Controller B",
            "Midi Controller C", "Midi Controller D", "Mono Pressure",
            "Polyphonic Pressure", "LFO 1", "LFO 2", "Auxilary Envelope" };
    final String[] realtimeModDest = new String[] {
    ...
    final String[] keyModDest = new String[] {
            ...
            "Secondary Sample Start", "Pan", "Primary Pan", "Secondary Pan",
            "Tone", "Primary Tone", "Secondary Tone" };

    final String[] noteName = new String[] {
            "C-2", "C#-2", "D-2", "D#-2", "E-2", "F-2", "F#-2", "G-2", "G#21",
    ...
    final String[] waveName = new String[] {
            ...
            "7    Slow Strings", "8    Dark Strings", "9    Voices",
            "10   Slow Voices", "11   Dark Choir", "12   Synth Flute",
            "13   Soft Flute", "14   Alto Sax", "15   Tenor Sax",
            "16   Baritone Sax", "17   Dark Sax", "18   Soft Trumpet",
            "19   Dark Soft Trumpet", "20   Hard Trumpet",
            "21   Dark Hard Trumpet", "22   Horn Falls", "23   Trombone 1",
            "24   Trombone 2", "25   French Horn", "26   Brass 1",
            "27   Brass 2", "28   Brass 3", "29   Trumbone / Sax",
            "30   Guitar Mute", "31   Electric Guitar", "32   Acoustic Guitar",
            "33   Rock Bass", "34   Stone Bass", "35   Flint Bass",
            "36   Funk Slap", "37   Funk Pop", "38   Harmonics",
            "39   Rock / Harmonics", "40   Stone / Harmonics",
            "41   Nose Bass", "42   Bass Synth 1", "43   Bass Synth 2",
            "44   Synth Pad", "45   Medium Envelope Pad",
            "46   Long Envelope Pad", "47   Dark Synth",
            "48   Percussive Organ", "49   Marimba", "50   Vibraphone",
            "51   All Percussion (Balanced)",
            "52   All Percussion (Unballanced)", "53   Standard Percussion 1",
            "54   Standard Percussion 2", "55   Standard Percussion 3",
            "56   Kicks", "57   Snares", "58   Toms", "59   Cymbals",
            "60   Latin Drums", "61   Latin Percussion", "62   Agogo Bell",
            "63   Wood Block", "64   Conga", "65   Timbale",
            "66   Ride Cymbal", "67   Percussion FX 1", "68   Percussion FX 2",
            "69   Metal", "70   Oct 1 (Sine)", "71   Oct 2 All",
            "72   Oct 3 All", "73   Oct 4 All", "74   Oct 5 All",
            "75   Oct 6 All", "76   Oct 7 All", "77   Oct 2 Odd 2",
            "78   Oct 3 Odd", "79   Oct 4 Odd", "80   Oct 5 Odd",
            "81   Oct 6 Odd", "82   Oct 7 Odd", "83   Oct 2 Even",
            "84   Oct 3 Even", "85   Oct 4 Even", "86   Oct 5 Even",
            "87   Oct 6 Even", "88   Oct 7 Even", "89   Low Odds",
            "90   Low Evens", "91   Four Octaves", "92   Synth Cycle 1",
            "93   Synth Cycle 2", "94   Synth Cycle 3", "95   Synth Cycle 4",
            "96   Fundamental Gone 1", "97   Fundamental Gone 2",
            "98   Bite Cycle", "99   Buzzy Cycle", "100  Metalphone 1",
            "101  Metalphone 2", "102  Metal Phone 3", "103  Metal Phone 4",
            "104  Duck Cycle 1", "105  Duck Cycle 2", "106  Duck Cycle 3",
            "107  Wind Cycle 1", "108  Wind Cycle 2", "109  Wind Cycle 3",
            "110  Wind Cycle 4", "111  Organ Cycle 1", "112  Organ Cycle 2",
            "113  Noise", "114  Stray Voice 1", "115  Stray Voice 2",
            "116  Stray Voice 3", "117  Stray Voice 4", "118  String Synth 1",
            "119  String Synth 2", "120  Animals", "121  Reed", "122  Pluck 1",
            "123  Pluck 2", "124  Mallet 1", "125  Mallet 2",
            /* Second Sound Set */
            "126  Solo Cello", "127  Solo Viola", "128  Solo Violin",
            "129  Gambambo", "130  Quartet 1", "131  Quartet 2",
            "132  Quartet 3", "133  Quartet 4", "134  Pizzicato Basses",
            "135  Pizzicato Celli", "136  Pizzicato Violas",
            "137  Pizzicato Violins", "138  Pizzicombo", "139  Bass Clarinet",
            "140  Clarinet", "141  Bass Clarinet / Clarinet",
            "142  Contrabasoon", "143  Basoon", "144  English Horn",
            "145  Oboe w/ Vib", "146  Woodwinds", "147  Harmon Mute",
            "148  Tubular Bell", "149  Timpani", "150  Timpani / Tubular Bell",
            "151  Tamborine", "152  Tam Tam", "153  Percussion 3",
            "154  Special FX", "155  Oboe w/ no Vib", "156  Upright Pizz",
            "157  Sine Wave", "158  Tiangle Wav", "159  Square Wave",
            "160  Buzz Wave 1", "161  Buzz Wave 2", "162  Buzz Wave 3",
            "163  Sawtooth", "164  Saw Odd Gone", "165  Ramp",
            "166  Ramp Even Only", "167  Vio Essence", "168  Buzzoon",
            "169  Brassy Wave", "170  Reedy Buzz", "171  Growl Wave",
            "172  Harpsiwave", "173  Fuzzy Gruzz", "174  Power 5ths",
            "175  Filt Saw", "176  Ice Bell", "177  Bronze Age",
            "178  Iron Plate", "179  Aluminum", "180  Lead Beam",
            "181  SteelXtract", "182  Winterglass", "183  TwinBellWash",
            "184  Orch Bells", "185  Tubular SE", "186  SoftBellWave",
            "187  Swirly", "188  Tack Attack", "189  Shimmer Wave",
            "190  Moog Lead", "191  B3 SE", "192  Mild Tone", "193  Piper",
            "194  Ah Wave", "195  Vocal Wave", "196  Fuzzy Clav",
            "197  Electrhode", "198  Whine 1", "199  Whine 2",
            "200  Metal Drone", "201  Silver Race", "202  Metal Attack",
            "203  Filter Bass", "204  Alt. Oboe", };
    ...
    public EmuProteusMPSSingleEditor(Patch patch) {
        ...
        tabPane.addTab("Main Parameters", wavePane);
        gbc.weightx = 0;
        tabPane.addTab("Modulation & Effects", modPane);
        gbc.weightx = 0;
        ...
        crxPane.setLayout(new GridBagLayout());
        gbc.weightx = 0;
        ...
        addWidget(crxPane, new ScrollBarWidget("Amount", patch, 0, 255, 0,
                new MPSModel(patch, 0X3E), new MPSSender(62)), 0, 4, 5, 1, 10);
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.anchor = GridBagConstraints.EAST;
        crxPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED), "Cross Fade",
                TitledBorder.CENTER, TitledBorder.CENTER));
        ...
        addWidget(lfo1Pane, new ScrollBarWidget("LFO Frequency", patch, 0, 127,
                ...
                12);
        addWidget(lfo1Pane, new ScrollBarWidget("Delay", patch, 0, 127, 0,
                new MPSModel(patch, 0x42), new MPSSender(66)), 0, 2, 5, 1, 13);
        addWidget(lfo1Pane, new ScrollBarWidget("Variation", patch, 0, 127, 0,
                new MPSModel(patch, 0x43), new MPSSender(67)), 0, 3, 5, 1, 14);
        addWidget(lfo1Pane, new ScrollBarWidget("Amount", patch, -128, 127, 0,
                new MPSModel(patch, 0x44), new MPSSender(68)), 0, 4, 5, 1, 15);
        ...
        lfo1Pane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "LFO1", TitledBorder.CENTER,
                TitledBorder.CENTER));
        ...
        addWidget(lfo2Pane, new ScrollBarWidget("LFO Frequency", patch, 0, 127,
                ...
                18);
        addWidget(lfo2Pane, new ScrollBarWidget("Delay", patch, 0, 127, 0,
                new MPSModel(patch, 0x47), new MPSSender(71)), 0, 2, 5, 1, 19);
        addWidget(lfo2Pane, new ScrollBarWidget("Variation", patch, 0, 127, 0,
                new MPSModel(patch, 0x48), new MPSSender(72)), 0, 3, 5, 1, 20);
        addWidget(lfo2Pane, new ScrollBarWidget("Amount", patch, -128, 127, 0,
                new MPSModel(patch, 0x49), new MPSSender(73)), 0, 4, 5, 1, 21);
        ...
        lfo2Pane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "LFO2", TitledBorder.CENTER,
                TitledBorder.CENTER));
        ...
        for (int i = 0; i < 2; i++) {
            ...
            addWidget(panel, new CheckBoxWidget("Alternate Envelope Enable",
                    patch, new MPSModel(patch, 0x25 + i * 18), new MPSSender(
                            37 + i * 18)), 0, 5, 2, 1, -33);
            addWidget(panel, new ComboBoxWidget("Instrument", patch,
                    new InstModel(patch, 0x17 + i * 18), new InstSender(
                            23 + i * 18), waveName), 0, 6, 2, 1, 39);
            addWidget(panel, new ScrollBarWidget("Volume", patch, 0, 127, 0,
                    new MPSModel(patch, 0x1B + i * 18), new MPSSender(
                            27 + i * 18)), 0, 7, 3, 1, 40);
            addWidget(panel, new ScrollBarWidget("Detune", patch, 0, 15, 0,
                    new MPSModel(patch, 0x27 + i * 18), new MPSSender(
                            39 + i * 18)), 0, 8, 3, 1, 41);
            addWidget(panel, new ScrollBarWidget("Sample Start", patch, 0, 127,
                    0, new MPSModel(patch, 0x18 + i * 18), new MPSSender(
                            24 + i * 18)), 0, 9, 3, 1, 42);
            addWidget(panel, new ScrollBarWidget("Course Tune", patch, -36, 36,
                    0, new MPSModel(patch, 0x19 + i * 18), new MPSSender(
                            25 + i * 18)), 0, 10, 3, 1, 43);
            addWidget(panel, new ScrollBarWidget("Fine Tune", patch, -64, 64,
                    0, new MPSModel(patch, 0x1A + i * 18), new MPSSender(
                            26 + i * 18)), 0, 11, 3, 1, 44);
            addWidget(panel, new ScrollBarWidget("Pan", patch, -7, 7, 0,
                    new MPSModel(patch, 0x1C + i * 18), new MPSSender(
                            28 + i * 18)), 0, 12, 3, 1, 45);
            addWidget(panel,
                    new ComboBoxWidget("Low Key", patch, new MPSModel(patch,
                            0x1E + i * 18), new MPSSender(30 + i * 18),
                            noteName), 0, 13, 1, 1, 46);
            addWidget(panel, new ComboBoxWidget("High Key", patch,
                    new MPSModel(patch, 0x1F + i * 18), new MPSSender(
                            31 + i * 18), noteName), 1, 13, 1, 1, 47);
            addWidget(panel, new CheckBoxWidget("Solo Mode", patch,
                    new MPSModel(patch, 0x26 + i * 18), new MPSSender(
                            38 + i * 18)), 0, 14, 1, 1, -34);
            addWidget(panel, new CheckBoxWidget("Reverse Sound", patch,
                    new MPSModel(patch, 0x28 + i * 18), new MPSSender(
                            40 + i * 18)), 1, 14, 1, 1, -35);
        ...
        addWidget(auxPane, new EnvelopeWidget(
                ...
                new EnvelopeWidget.Node[] {
                        ...
                        new EnvelopeWidget.Node(100, 100, null, 5000, 5000,
                                null, 0, false, null, null, null, null),
                        new EnvelopeWidget.Node(0, 100, new MPSModel(patch,
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.anchor = GridBagConstraints.EAST;
        auxPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED), "Auxilery",
                TitledBorder.CENTER, TitledBorder.CENTER));
        wavePane.add(auxPane, gbc);
        // Controller Amounts
        gbc.weightx = 5;
        JPanel cntPane = new JPanel();
        cntPane.setLayout(new GridBagLayout());
        gbc.weightx = 0;
        addWidget(cntPane, new ScrollBarWidget("Controller A", patch, -128,
                127, 0, new MPSModel(patch, 0x76), new MPSSender(118)), 0, 1,
                3, 1, 56);
        addWidget(cntPane, new ScrollBarWidget("Controller B", patch, -128,
                127, 0, new MPSModel(patch, 0x77), new MPSSender(119)), 0, 2,
                3, 1, 57);
        addWidget(cntPane, new ScrollBarWidget("Controller C", patch, -128,
                127, 0, new MPSModel(patch, 0x78), new MPSSender(120)), 0, 3,
                3, 1, 58);
        addWidget(cntPane, new ScrollBarWidget("Controller D", patch, -128,
                127, 0, new MPSModel(patch, 0x79), new MPSSender(121)), 0, 4,
                3, 1, 59);
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.anchor = GridBagConstraints.EAST;
        cntPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED), "Controller Amounts",
                TitledBorder.CENTER, TitledBorder.CENTER));
        wavePane.add(cntPane, gbc);
        // Footswitch Destinations
        gbc.weightx = 5;
        JPanel fswPane = new JPanel();
        fswPane.setLayout(new GridBagLayout());
        gbc.weightx = 0;
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.anchor = GridBagConstraints.EAST;
        fswPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED),
                "Footswitch Destinations", TitledBorder.CENTER,
                TitledBorder.CENTER));
        wavePane.add(fswPane, gbc);
        // Links
        gbc.weightx = 5;
        JPanel lnkPane = new JPanel();
        lnkPane.setLayout(new GridBagLayout());
        gbc.weightx = 0;
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.anchor = GridBagConstraints.NORTH;
        lnkPane.add(new JLabel("This Patch"), gbc);
        addWidget(lnkPane, new ComboBoxWidget("Low Key", patch, new MPSModel(
                patch, 0x0F), new MPSSender(15), noteName), 2, 0, 1, 2, 65);
        addWidget(lnkPane, new ComboBoxWidget("High Key", patch, new MPSModel(
                patch, 0x13), new MPSSender(19), noteName), 3, 0, 1, 2, 66);

        addWidget(lnkPane, new ScrollBarWidget("Patch Num.", patch, -1, 499, 0,
                new MPSModel(patch, 0x0C), new MPSSender(12)), 0, 2, 1, 1, 67);
        addWidget(lnkPane, new ComboBoxWidget("Low Key", patch, new MPSModel(
                patch, 0x10), new MPSSender(16), noteName), 2, 2, 1, 1, 68);
        addWidget(lnkPane, new ComboBoxWidget("High Key", patch, new MPSModel(
                patch, 0x14), new MPSSender(20), noteName), 3, 2, 1, 1, 69);

        addWidget(lnkPane, new ScrollBarWidget("Patch Num.", patch, -1, 499, 0,
                new MPSModel(patch, 0x0D), new MPSSender(13)), 0, 3, 1, 1, 70);
        addWidget(lnkPane, new ComboBoxWidget("Low Key", patch, new MPSModel(
                patch, 0x11), new MPSSender(17), noteName), 2, 3, 1, 1, 71);
        addWidget(lnkPane, new ComboBoxWidget("High Key", patch, new MPSModel(
                patch, 0x15), new MPSSender(21), noteName), 3, 3, 1, 1, 72);

        addWidget(lnkPane, new ScrollBarWidget("Patch Num.", patch, -1, 499, 0,
                new MPSModel(patch, 0x0E), new MPSSender(14)), 0, 4, 1, 1, 73);
        addWidget(lnkPane, new ComboBoxWidget("Low Key", patch, new MPSModel(
                patch, 0x12), new MPSSender(18), noteName), 2, 4, 1, 1, 74);
        addWidget(lnkPane, new ComboBoxWidget("High Key", patch, new MPSModel(
                patch, 0x16), new MPSSender(22), noteName), 3, 4, 1, 1, 75);
        ...
        gbc.fill = GridBagConstraints.BOTH;
        gbc.anchor = GridBagConstraints.EAST;
        lnkPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED),
                "                                        Interpatch Linking",
                TitledBorder.CENTER, TitledBorder.CENTER));
        ...
        modsPane.setLayout(new GridBagLayout());
        gbc.weightx = 0;
        // RealTime Modulations
        JPanel realPane = new JPanel();
        realPane.setLayout(new GridBagLayout());
        gbc.weightx = 0;
        for (int i = 0; i < 8; i++) {
            addWidget(realPane,
        ...
        realPane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "Realtime Controller Modulations",
                TitledBorder.CENTER, TitledBorder.CENTER));
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridwidth = 5;
        ...
        for (int i = 0; i < 6; i++) {
            ...
            addWidget(keyPane, new ComboBoxWidget(" to ", patch, new MPSModel(
                    ...
                    1, 1, 18 + i * 3);
            addWidget(keyPane, new ScrollBarWidget("Amount.", patch, -128, 127,
                    0, new MPSModel(patch, 0x5D + i), new MPSSender(93 + i)),
                    2, i, 1, 1, 19 + i * 3);
        }
        keyPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED),
                "Keyboard & Velocity Modulations", TitledBorder.CENTER,
                TitledBorder.CENTER));
        gbc.gridx = 5;
        gbc.gridy = 0;
        gbc.gridwidth = 5;
        ...
        modsPane.setBorder(new TitledBorder(new EtchedBorder(
                EtchedBorder.RAISED), "Modulation Patching",
                TitledBorder.CENTER, TitledBorder.CENTER));
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridwidth = 10;
        ...
        aPane.setLayout(new GridBagLayout());
        gbc.weightx = 0;
        aPane.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED),
                "Effect Bus A", TitledBorder.CENTER, TitledBorder.CENTER));
            ...
            public void actionPerformed(ActionEvent e) {
                for (int i = 0; i < 6; i++) {
                    try {
                        ...
                        effectASliders[i].setLabel("Unused");
                    }
                }
            }
        });
        addWidget(aPane, new ScrollBarWidget("Effect Amount (%)", patch, 0,
                100, 0, new MPSModel(patch, 0x83), new MPSSender(131)), 0, 1,
                1, 1, 50);
        int effectA = (new MPSModel(patch, 0x82)).get();
        for (int i = 0; i < 6; i++) {
            effectASliders[i] =
                    new ScrollBarWidget("Unused", patch, 0, 100, 0,
                            new MPSModel(patch, 0x84 + i), new MPSSender(
                                    132 + i));
        ...
        gbc.weightx = 0;
        bPane.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED),
                "Effect Bus B", TitledBorder.CENTER, TitledBorder.CENTER));
            ...
            public void actionPerformed(ActionEvent e) {
                for (int i = 0; i < 6; i++) {
                    try {
                        ...
                        effectBSliders[i].setLabel("Unused");
                    }
                }
            }
        });
        addWidget(bPane, new ScrollBarWidget("Effect Amount (%)", patch, 0,
                100, 0, new MPSModel(patch, 0x8B), new MPSSender(143)), 0, 1,
                1, 1, 58);
        int effectB = (new MPSModel(patch, 0x8E)).get();
        for (int i = 0; i < 6; i++) {
            effectBSliders[i] =
                    new ScrollBarWidget("Unused", patch, 0, 100, 0,
                            new MPSModel(patch, 0x90 + i), new MPSSender(
                                    144 + i));
        ...
        gbc.weightx = 0;
        cPane.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.RAISED),
                "Effects Common", TitledBorder.CENTER, TitledBorder.CENTER));
        ...
        fxPane.setBorder(new TitledBorder(
                new EtchedBorder(EtchedBorder.RAISED), "Effects Processing",
                TitledBorder.CENTER, TitledBorder.CENTER));
        gbc.gridx = 0;
        gbc.gridy = 5;
        gbc.gridwidth = 10;
