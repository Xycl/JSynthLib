 ...
 * @version $Id: KorgX3BankDriver.java 677 2004-08-21 14:39:35Z hayashi $
 */
public class KorgX3BankDriver extends BankDriver {
    ...
    public KorgX3BankDriver() {
        ...
        patchNumbers =
                new String[] {
                        ...
                        "A84-", "A85-", "A86-", "A87-", "A88-", "A89-", "A90-",
                        "A91-", "A92-", "A93-", "A94-", "A95-", "A96-", "A97-",
                        "A98-", "A99-", "B00-", "B01-", "B02-", "B03-", "B04-",
                        ...
                        "B68-", "B69-", "B70-", "B71-", "B72-", "B73-", "B74-",
                        "B75-", "B76-", "B77-", "B78-", "B79-", "B80-", "B81-",
                        "B82-", "B83-", "B84-", "B85-", "B86-", "B87-", "B88-",
                        "B89-", "B90-", "B91-", "B92-", "B93-", "B94-", "B95-",
                        "B96-", "B97-", "B98-", "B99-" };

        singleSysexID = "F042**35";
        // size after conversion:
        patchSize = 37600 + EXTRA_HEADER; // 164*200Byte = 7*4685+5 ->
                                          // 8*4685+(1+5) = 37486Byte
    }
    ...
    public void putPatch(Patch bank, Patch p, int patchNum) {
        ...
        System.arraycopy(((Patch) p).sysex, KorgX3SingleDriver.EXTRA_HEADER,
                ((Patch) bank).sysex, getPatchStart(patchNum), 164);
    }
    ...
    public Patch getPatch(Patch bank, int patchNum) {
        try {
            ...
            System.arraycopy(((Patch) bank).sysex, getPatchStart(patchNum),
                    sysex, KorgX3SingleDriver.EXTRA_HEADER, 164);
            return new Patch(sysex);
        } catch (Exception e) {
            ErrorMsg.reportError("Error", "Error in Korg X3 Bank Driver", e);
            return null;
        }
    }
    ...
    public Patch createNewPatch() {
        JOptionPane.showMessageDialog(null,
                "Creating a new Bank is not possible.", "Error",
