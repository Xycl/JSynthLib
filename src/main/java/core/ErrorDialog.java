...
public class ErrorDialog extends JDialog {
     ...
     *            the title
     * @param exception
     *            the exception to extract the message and details from
     */
     ...
     *            the exception to extract the message and details from
     */
    public static void showDialog(final Window parent, final String title,
     ...
     *            the exception to extract the message and details from
     */
    public ErrorDialog(final Window parent, final String title,
            final Exception exception) {
        this(parent, title, exception.getMessage(),
