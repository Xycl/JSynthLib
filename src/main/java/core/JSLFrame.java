...
public class JSLFrame {
     ...
     */
    public JSLFrame(JSLDesktop desktop, String title, boolean resizable,
            boolean closable, boolean maximizable, boolean iconifiable) {
        this.desktop = desktop;
        if (JSLDesktop.useMDI())
            proxy =
                    new JSLIFrame(this, title, resizable, closable,
    ...
    class JSLIFrame extends JInternalFrame implements JSLFrameProxy,
        ...
        public JSLIFrame(JSLFrame p, String title, boolean resizable,
                boolean closable, boolean maximizable, boolean iconifiable) {
