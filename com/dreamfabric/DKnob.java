...
public class DKnob extends JComponent {
    ...
    private static final float LENGTH_ANG = (LENGTH/360)*(float)Math.PI*2;
    ...
    private static final Dimension PREF_SIZE = new Dimension(DEFAULT_WIDTH, DEFAULT_HEIGHT);
    ...
    @Override public void paint(final Graphics g) {
        if (isEnabled()) {
            ...
            // Paint the "markers"
            for (float a2 = START_ANG; a2 >= START_ANG - LENGTH_ANG; a2 -= LENGTH_ANG_DIV10) {
     ...
     *
     * @param vl the value label (null to unset)
     */
