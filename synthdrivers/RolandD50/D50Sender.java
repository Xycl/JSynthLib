...
public class D50Sender extends SysexSender {
    ...
    public static final byte[]  BASE_MESSAGE   = new byte[]{
            (byte)0xF0, 0x41, 0x00, 0x14, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, (byte)0xF7
                                               };
    private static final int    CS_START       = D50Constants.SYSEX_HEADER_SIZE;
    private static final int    CS_END         = BASE_MESSAGE.length - D50Constants.SYSEX_FOOTER_SIZE;
    ...
    public static class Factory {
        ...
        public D50Sender newPartialMuteSender(int offset, final D50PartialMuteDataModel model) {
