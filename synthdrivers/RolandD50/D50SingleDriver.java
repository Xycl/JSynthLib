...
public class D50SingleDriver extends Driver {
    ...
    public Patch createNewPatch() {
        ...
        System.arraycopy(D50Constants.SYSEX_HEADER, 0, sysex, 0, D50Constants.SYSEX_HEADER_SIZE);
    ...
    protected void setPatchName(Patch p, String name) {
        D50StringHandler.setName(p, name, D50Constants.PATCH_NAME_START, D50Constants.PATCH_NAME_SIZE);
        calculateChecksum(p);
        sendPatch(p);
    }
    ...
    protected String getPatchName(Patch p) {
        return D50StringHandler.getName(p, D50Constants.PATCH_NAME_START, D50Constants.PATCH_NAME_SIZE);
    }
}
