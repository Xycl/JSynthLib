...
public class SPD11Patch2Editor extends PatchEditorFrame
{
    ...
    public SPD11Patch2Editor(Patch patch) {
        ...
        //fxParam.setLabel(SPD11_Constants.FX_PARAMS[patch.sysex[12]]); // change label according to the Fx Type.
        ...
        gbc.gridheight = 1;
        gbc.gridwidth = 1;
        //fxParam.setMinimumSize(new Dimension(0,mixer.WIDTH)); //doesn't seem to work
