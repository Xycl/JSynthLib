...
public class RocktronIntellifexPresetDriver extends Driver {
    ...
    private static final byte[] defaultPatchData = {   0x00,0x00,0x00,0x00,0x2E,0x00,0x2E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                  ...
                                  0x4E,0x00,0x45,0x00,0x57,0x00,0x20,0x00,0x50,0x00,0x41,0x00,0x54,0x00,0x43,0x00,
                                  0x48,0x00,0x20,0x00,0x20,0x00,0x20,0x00,0x79,0x00,0x00,0x00,0x3A,0x00,0x00,0x00,
                                  0x79,0x00,0x01,0x00,0x3A,0x00,0x00,0x00,0x79,0x00,0x02,0x00,0x3A,0x00,0x00,0x00,
                                  0x79,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x79,0x00,0x04,0x00,0x00,0x00,0x00,0x00,
                                  0x79,0x00,0x05,0x00,0x00,0x00,0x00,0x00,0x79,0x00,0x06,0x00,0x00,0x00,0x00,0x00,
    ...
    public RocktronIntellifexPresetDriver() {
        ...
        patchNumbers = new String[] { "Preset" };
    }
    ...
    protected String getPatchName(Patch p) {
        try {
            ...
            for (int i = 0; i < patchNameSize; i++) {    
                String s = new String(p.sysex, patchNameStart + 2*i, 1, "US-ASCII");
                name = name.concat(s);
            }
            return name;
    ...
    public Patch createNewPatch() {
        ...
        sysex[3] = (byte) 0x29; sysex[4] = (byte) 0x02; sysex[5] = (byte) 0x28;
